...
/// Animated timer icon from Google Material Icons
class MconTimer extends MconBase {
  const MconTimer({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconTimer> createState() => _MconTimerState();
}

class _MconTimerState extends MconBaseState<MconTimer> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTimerPainter(
      animation: animation,
...
class _MconTimerPainter extends MconPainter {
  _MconTimerPainter({
