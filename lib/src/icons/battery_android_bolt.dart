...
/// Animated battery_android_bolt icon from Google Material Icons
class MconBatteryAndroidBolt extends MconBase {
  const MconBatteryAndroidBolt({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryAndroidBolt> createState() => _MconBatteryAndroidBoltState();
}

class _MconBatteryAndroidBoltState extends MconBaseState<MconBatteryAndroidBolt> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryAndroidBoltPainter(
      animation: animation,
...
class _MconBatteryAndroidBoltPainter extends MconPainter {
  _MconBatteryAndroidBoltPainter({
