...
/// Animated label icon from Google Material Icons
class MconLabel extends MconBase {
  const MconLabel({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconLabel> createState() => _MconLabelState();
}

class _MconLabelState extends MconBaseState<MconLabel> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLabelPainter(
      animation: animation,
...
class _MconLabelPainter extends MconPainter {
  _MconLabelPainter({
