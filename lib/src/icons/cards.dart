...
/// Animated cards icon from Google Material Icons
class MconCards extends MconBase {
  const MconCards({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCards> createState() => _MconCardsState();
}

class _MconCardsState extends MconBaseState<MconCards> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCardsPainter(
      animation: animation,
...
class _MconCardsPainter extends MconPainter {
  _MconCardsPainter({
