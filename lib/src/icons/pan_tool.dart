...
/// Animated pan_tool icon from Google Material Icons
class MconPanTool extends MconBase {
  const MconPanTool({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconPanTool> createState() => _MconPanToolState();
}

class _MconPanToolState extends MconBaseState<MconPanTool> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPanToolPainter(
      animation: animation,
...
class _MconPanToolPainter extends MconPainter {
  _MconPanToolPainter({
