...
/// Animated timelapse icon from Google Material Icons
class MconTimelapse extends MconBase {
  const MconTimelapse({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconTimelapse> createState() => _MconTimelapseState();
}

class _MconTimelapseState extends MconBaseState<MconTimelapse> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTimelapsePainter(
      animation: animation,
...
class _MconTimelapsePainter extends MconPainter {
  _MconTimelapsePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(345.0), y(-277.0), x(388.5), y(-258.5));
