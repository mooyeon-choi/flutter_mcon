...
/// Animated text_select_move_back_character icon from Google Material Icons
class MconTextSelectMoveBackCharacter extends MconBase {
  const MconTextSelectMoveBackCharacter({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconTextSelectMoveBackCharacter> createState() =>
      _MconTextSelectMoveBackCharacterState();
}

class _MconTextSelectMoveBackCharacterState
    extends MconBaseState<MconTextSelectMoveBackCharacter> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTextSelectMoveBackCharacterPainter(
      animation: animation,
...
class _MconTextSelectMoveBackCharacterPainter extends MconPainter {
  _MconTextSelectMoveBackCharacterPainter({
