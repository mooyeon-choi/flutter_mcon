...
/// Animated dashboard icon from Google Material Icons
class MconDashboard extends MconBase {
  const MconDashboard({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconDashboard> createState() => _MconDashboardState();
}

class _MconDashboardState extends MconBaseState<MconDashboard> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDashboardPainter(
      animation: animation,
...
class _MconDashboardPainter extends MconPainter {
  _MconDashboardPainter({
