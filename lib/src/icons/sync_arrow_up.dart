...
/// Animated sync_arrow_up icon from Google Material Icons
class MconSyncArrowUp extends MconBase {
  const MconSyncArrowUp({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSyncArrowUp> createState() => _MconSyncArrowUpState();
}

class _MconSyncArrowUpState extends MconBaseState<MconSyncArrowUp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSyncArrowUpPainter(
      animation: animation,
...
class _MconSyncArrowUpPainter extends MconPainter {
  _MconSyncArrowUpPainter({
