...
/// Animated crop_3_2 icon from Google Material Icons
class MconCrop32 extends MconBase {
  const MconCrop32({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCrop32> createState() => _MconCrop32State();
}

class _MconCrop32State extends MconBaseState<MconCrop32> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCrop32Painter(
      animation: animation,
...
class _MconCrop32Painter extends MconPainter {
  _MconCrop32Painter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(167.0), y(-240.0), x(143.5), y(-263.5));
    path.quadraticBezierTo(x(120.0), y(-287.0), x(120.0), y(-320.0));
