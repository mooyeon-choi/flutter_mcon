...
/// Animated drive_export icon from Google Material Icons
class MconDriveExport extends MconBase {
  const MconDriveExport({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDriveExport> createState() => _MconDriveExportState();
}

class _MconDriveExportState extends MconBaseState<MconDriveExport> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDriveExportPainter(
      animation: animation,
...
class _MconDriveExportPainter extends MconPainter {
  _MconDriveExportPainter({
