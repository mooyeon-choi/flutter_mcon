...
/// Animated 14mp icon from Google Material Icons
class Mcon14mp extends MconBase {
  const Mcon14mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon14mp> createState() => _Mcon14mpState();
}

class _Mcon14mpState extends MconBaseState<Mcon14mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon14mpPainter(
      animation: animation,
...
class _Mcon14mpPainter extends MconPainter {
  _Mcon14mpPainter({
