...
/// Animated sd_card icon from Google Material Icons
class MconSdCard extends MconBase {
  const MconSdCard({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconSdCard> createState() => _MconSdCardState();
}

class _MconSdCardState extends MconBaseState<MconSdCard> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSdCardPainter(
      animation: animation,
...
class _MconSdCardPainter extends MconPainter {
  _MconSdCardPainter({
