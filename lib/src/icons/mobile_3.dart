...
/// Animated mobile_3 icon from Google Material Icons
class MconMobile3 extends MconBase {
  const MconMobile3({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconMobile3> createState() => _MconMobile3State();
}

class _MconMobile3State extends MconBaseState<MconMobile3> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMobile3Painter(
      animation: animation,
...
class _MconMobile3Painter extends MconPainter {
  _MconMobile3Painter({
