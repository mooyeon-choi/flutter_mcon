...
/// Animated splitscreen_portrait icon from Google Material Icons
class MconSplitscreenPortrait extends MconBase {
  const MconSplitscreenPortrait({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSplitscreenPortrait> createState() =>
      _MconSplitscreenPortraitState();
}

class _MconSplitscreenPortraitState
    extends MconBaseState<MconSplitscreenPortrait> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSplitscreenPortraitPainter(
      animation: animation,
...
class _MconSplitscreenPortraitPainter extends MconPainter {
  _MconSplitscreenPortraitPainter({
