...
/// Animated screenshot_region icon from Google Material Icons
class MconScreenshotRegion extends MconBase {
  const MconScreenshotRegion({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconScreenshotRegion> createState() =>
      _MconScreenshotRegionState();
}

class _MconScreenshotRegionState extends MconBaseState<MconScreenshotRegion> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconScreenshotRegionPainter(
      animation: animation,
...
class _MconScreenshotRegionPainter extends MconPainter {
  _MconScreenshotRegionPainter({
