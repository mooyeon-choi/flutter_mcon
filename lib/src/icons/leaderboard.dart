...
/// Animated leaderboard icon from Google Material Icons
class MconLeaderboard extends MconBase {
  const MconLeaderboard({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconLeaderboard> createState() => _MconLeaderboardState();
}

class _MconLeaderboardState extends MconBaseState<MconLeaderboard> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLeaderboardPainter(
      animation: animation,
...
class _MconLeaderboardPainter extends MconPainter {
  _MconLeaderboardPainter({
