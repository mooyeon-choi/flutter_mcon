...
/// Animated stack_group icon from Google Material Icons
class MconStackGroup extends MconBase {
  const MconStackGroup({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconStackGroup> createState() => _MconStackGroupState();
}

class _MconStackGroupState extends MconBaseState<MconStackGroup> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconStackGroupPainter(
      animation: animation,
...
class _MconStackGroupPainter extends MconPainter {
  _MconStackGroupPainter({
