...
/// Animated thread_unread icon from Google Material Icons
class MconThreadUnread extends MconBase {
  const MconThreadUnread({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconThreadUnread> createState() => _MconThreadUnreadState();
}

class _MconThreadUnreadState extends MconBaseState<MconThreadUnread> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconThreadUnreadPainter(
      animation: animation,
...
class _MconThreadUnreadPainter extends MconPainter {
  _MconThreadUnreadPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(750.0), y(-680.0), x(715.0), y(-715.0));
    path.quadraticBezierTo(x(680.0), y(-750.0), x(680.0), y(-800.0));
    path.quadraticBezierTo(x(680.0), y(-850.0), x(715.0), y(-885.0));
    path.quadraticBezierTo(x(750.0), y(-920.0), x(800.0), y(-920.0));
    path.quadraticBezierTo(x(850.0), y(-920.0), x(885.0), y(-885.0));
    path.quadraticBezierTo(x(920.0), y(-850.0), x(920.0), y(-800.0));
    path.quadraticBezierTo(x(920.0), y(-750.0), x(885.0), y(-715.0));
    path.quadraticBezierTo(x(850.0), y(-680.0), x(800.0), y(-680.0));
    path.close();
