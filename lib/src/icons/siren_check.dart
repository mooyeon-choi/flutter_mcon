...
/// Animated siren_check icon from Google Material Icons
class MconSirenCheck extends MconBase {
  const MconSirenCheck({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSirenCheck> createState() => _MconSirenCheckState();
}

class _MconSirenCheckState extends MconBaseState<MconSirenCheck> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSirenCheckPainter(
      animation: animation,
...
class _MconSirenCheckPainter extends MconPainter {
  _MconSirenCheckPainter({
