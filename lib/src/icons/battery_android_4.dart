...
/// Animated battery_android_4 icon from Google Material Icons
class MconBatteryAndroid4 extends MconBase {
  const MconBatteryAndroid4({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryAndroid4> createState() => _MconBatteryAndroid4State();
}

class _MconBatteryAndroid4State extends MconBaseState<MconBatteryAndroid4> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryAndroid4Painter(
      animation: animation,
...
class _MconBatteryAndroid4Painter extends MconPainter {
  _MconBatteryAndroid4Painter({
