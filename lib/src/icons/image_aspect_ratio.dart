...
/// Animated image_aspect_ratio icon from Google Material Icons
class MconImageAspectRatio extends MconBase {
  const MconImageAspectRatio({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconImageAspectRatio> createState() =>
      _MconImageAspectRatioState();
}

class _MconImageAspectRatioState extends MconBaseState<MconImageAspectRatio> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconImageAspectRatioPainter(
      animation: animation,
...
class _MconImageAspectRatioPainter extends MconPainter {
  _MconImageAspectRatioPainter({
