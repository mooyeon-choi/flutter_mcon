...
/// Animated location_home icon from Google Material Icons
class MconLocationHome extends MconBase {
  const MconLocationHome({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconLocationHome> createState() => _MconLocationHomeState();
}

class _MconLocationHomeState extends MconBaseState<MconLocationHome> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLocationHomePainter(
      animation: animation,
...
class _MconLocationHomePainter extends MconPainter {
  _MconLocationHomePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(292.0), y(-279.0), x(353.0), y(-299.5));
    path.quadraticBezierTo(x(414.0), y(-320.0), x(480.0), y(-320.0));
    path.quadraticBezierTo(x(546.0), y(-320.0), x(607.0), y(-299.5));
    path.quadraticBezierTo(x(668.0), y(-279.0), x(720.0), y(-240.0));
