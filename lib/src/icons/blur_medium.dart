...
/// Animated blur_medium icon from Google Material Icons
class MconBlurMedium extends MconBase {
  const MconBlurMedium({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBlurMedium> createState() => _MconBlurMediumState();
}

class _MconBlurMediumState extends MconBaseState<MconBlurMedium> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBlurMediumPainter(
      animation: animation,
...
class _MconBlurMediumPainter extends MconPainter {
  _MconBlurMediumPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(426.0), y(-377.0), x(417.5), y(-397.5));
    path.quadraticBezierTo(x(409.0), y(-418.0), x(404.0), y(-440.0));
