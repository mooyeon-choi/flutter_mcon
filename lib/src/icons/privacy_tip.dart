...
/// Animated privacy_tip icon from Google Material Icons
class MconPrivacyTip extends MconBase {
  const MconPrivacyTip({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPrivacyTip> createState() => _MconPrivacyTipState();
}

class _MconPrivacyTipState extends MconBaseState<MconPrivacyTip> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPrivacyTipPainter(
      animation: animation,
...
class _MconPrivacyTipPainter extends MconPainter {
  _MconPrivacyTipPainter({
