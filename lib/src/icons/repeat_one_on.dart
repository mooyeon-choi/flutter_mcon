...
/// Animated repeat_one_on icon from Google Material Icons
class MconRepeatOneOn extends MconBase {
  const MconRepeatOneOn({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconRepeatOneOn> createState() => _MconRepeatOneOnState();
}

class _MconRepeatOneOnState extends MconBaseState<MconRepeatOneOn> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconRepeatOneOnPainter(
      animation: animation,
...
class _MconRepeatOneOnPainter extends MconPainter {
  _MconRepeatOneOnPainter({
