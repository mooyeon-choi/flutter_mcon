...
/// Animated schedule icon from Google Material Icons
class MconSchedule extends MconBase {
  const MconSchedule({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconSchedule> createState() => _MconScheduleState();
}

class _MconScheduleState extends MconBaseState<MconSchedule> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSchedulePainter(
      animation: animation,
...
class _MconSchedulePainter extends MconPainter {
  _MconSchedulePainter({
