...
/// Animated masked_transitions_add icon from Google Material Icons
class MconMaskedTransitionsAdd extends MconBase {
  const MconMaskedTransitionsAdd({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMaskedTransitionsAdd> createState() =>
      _MconMaskedTransitionsAddState();
}

class _MconMaskedTransitionsAddState
    extends MconBaseState<MconMaskedTransitionsAdd> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMaskedTransitionsAddPainter(
      animation: animation,
...
class _MconMaskedTransitionsAddPainter extends MconPainter {
  _MconMaskedTransitionsAddPainter({
