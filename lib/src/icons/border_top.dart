...
/// Animated border_top icon from Google Material Icons
class MconBorderTop extends MconBase {
  const MconBorderTop({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconBorderTop> createState() => _MconBorderTopState();
}

class _MconBorderTopState extends MconBaseState<MconBorderTop> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBorderTopPainter(
      animation: animation,
...
class _MconBorderTopPainter extends MconPainter {
  _MconBorderTopPainter({
