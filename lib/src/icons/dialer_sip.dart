...
/// Animated dialer_sip icon from Google Material Icons
class MconDialerSip extends MconBase {
  const MconDialerSip({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconDialerSip> createState() => _MconDialerSipState();
}

class _MconDialerSipState extends MconBaseState<MconDialerSip> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDialerSipPainter(
      animation: animation,
...
class _MconDialerSipPainter extends MconPainter {
  _MconDialerSipPainter({
