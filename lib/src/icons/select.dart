...
/// Animated select icon from Google Material Icons
class MconSelect extends MconBase {
  const MconSelect({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconSelect> createState() => _MconSelectState();
}

class _MconSelectState extends MconBaseState<MconSelect> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSelectPainter(
      animation: animation,
...
class _MconSelectPainter extends MconPainter {
  _MconSelectPainter({
