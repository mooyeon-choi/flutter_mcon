...
/// Animated resize icon from Google Material Icons
class MconResize extends MconBase {
  const MconResize({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconResize> createState() => _MconResizeState();
}

class _MconResizeState extends MconBaseState<MconResize> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconResizePainter(
      animation: animation,
...
class _MconResizePainter extends MconPainter {
  _MconResizePainter({
