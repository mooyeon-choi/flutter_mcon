...
/// Animated 20mp icon from Google Material Icons
class Mcon20mp extends MconBase {
  const Mcon20mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon20mp> createState() => _Mcon20mpState();
}

class _Mcon20mpState extends MconBaseState<Mcon20mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon20mpPainter(
      animation: animation,
...
class _Mcon20mpPainter extends MconPainter {
  _Mcon20mpPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(543.0), y(-740.0), x(531.5), y(-728.5));
    path.quadraticBezierTo(x(520.0), y(-717.0), x(520.0), y(-700.0));
    path.lineTo(x(520.0), y(-540.0));
    path.quadraticBezierTo(x(520.0), y(-523.0), x(531.5), y(-511.5));
    path.quadraticBezierTo(x(543.0), y(-500.0), x(560.0), y(-500.0));
    path.close();
