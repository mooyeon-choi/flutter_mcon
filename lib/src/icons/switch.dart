...
/// Animated switch icon from Google Material Icons
class MconSwitch extends MconBase {
  const MconSwitch({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconSwitch> createState() => _MconSwitchState();
}

class _MconSwitchState extends MconBaseState<MconSwitch> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSwitchPainter(
      animation: animation,
...
class _MconSwitchPainter extends MconPainter {
  _MconSwitchPainter({
