...
/// Animated battery_android_0 icon from Google Material Icons
class MconBatteryAndroid0 extends MconBase {
  const MconBatteryAndroid0({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryAndroid0> createState() => _MconBatteryAndroid0State();
}

class _MconBatteryAndroid0State extends MconBaseState<MconBatteryAndroid0> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryAndroid0Painter(
      animation: animation,
...
class _MconBatteryAndroid0Painter extends MconPainter {
  _MconBatteryAndroid0Painter({
