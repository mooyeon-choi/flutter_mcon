...
/// Animated zoom_out_map icon from Google Material Icons
class MconZoomOutMap extends MconBase {
  const MconZoomOutMap({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconZoomOutMap> createState() => _MconZoomOutMapState();
}

class _MconZoomOutMapState extends MconBaseState<MconZoomOutMap> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconZoomOutMapPainter(
      animation: animation,
...
class _MconZoomOutMapPainter extends MconPainter {
  _MconZoomOutMapPainter({
