...
/// Animated assignment icon from Google Material Icons
class MconAssignment extends MconBase {
  const MconAssignment({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconAssignment> createState() => _MconAssignmentState();
}

class _MconAssignmentState extends MconBaseState<MconAssignment> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAssignmentPainter(
      animation: animation,
...
class _MconAssignmentPainter extends MconPainter {
  _MconAssignmentPainter({
