...
/// Animated mobile_info icon from Google Material Icons
class MconMobileInfo extends MconBase {
  const MconMobileInfo({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMobileInfo> createState() => _MconMobileInfoState();
}

class _MconMobileInfoState extends MconBaseState<MconMobileInfo> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMobileInfoPainter(
      animation: animation,
...
class _MconMobileInfoPainter extends MconPainter {
  _MconMobileInfoPainter({
