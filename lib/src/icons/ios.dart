...
/// Animated ios icon from Google Material Icons
class MconIos extends MconBase {
  const MconIos({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconIos> createState() => _MconIosState();
}

class _MconIosState extends MconBaseState<MconIos> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconIosPainter(
      animation: animation,
...
class _MconIosPainter extends MconPainter {
  _MconIosPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(520.0), y(-327.0), x(496.5), y(-303.5));
    path.quadraticBezierTo(x(473.0), y(-280.0), x(440.0), y(-280.0));
    path.close();
    ...
    path.quadraticBezierTo(x(560.0), y(-633.0), x(583.5), y(-656.5));
    path.quadraticBezierTo(x(607.0), y(-680.0), x(640.0), y(-680.0));
