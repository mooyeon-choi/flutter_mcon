...
/// Animated frame_bug icon from Google Material Icons
class MconFrameBug extends MconBase {
  const MconFrameBug({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconFrameBug> createState() => _MconFrameBugState();
}

class _MconFrameBugState extends MconBaseState<MconFrameBug> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFrameBugPainter(
      animation: animation,
...
class _MconFrameBugPainter extends MconPainter {
  _MconFrameBugPainter({
