...
/// Animated shuffle_on icon from Google Material Icons
class MconShuffleOn extends MconBase {
  const MconShuffleOn({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconShuffleOn> createState() => _MconShuffleOnState();
}

class _MconShuffleOnState extends MconBaseState<MconShuffleOn> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconShuffleOnPainter(
      animation: animation,
...
class _MconShuffleOnPainter extends MconPainter {
  _MconShuffleOnPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(720.0), y(-298.0));
    path.lineTo(x(594.0), y(-424.0));
    path.lineTo(x(537.0), y(-367.0));
    ...
    path.close();
    path.moveTo(x(367.0), y(-537.0));
    path.lineTo(x(423.0), y(-593.0));
    path.lineTo(x(216.0), y(-800.0));
    path.lineTo(x(160.0), y(-744.0));
    path.lineTo(x(367.0), y(-537.0));
    path.close();
