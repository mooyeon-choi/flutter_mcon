...
/// Animated photo_size_select_large icon from Google Material Icons
class MconPhotoSizeSelectLarge extends MconBase {
  const MconPhotoSizeSelectLarge({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPhotoSizeSelectLarge> createState() =>
      _MconPhotoSizeSelectLargeState();
}

class _MconPhotoSizeSelectLargeState
    extends MconBaseState<MconPhotoSizeSelectLarge> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPhotoSizeSelectLargePainter(
      animation: animation,
...
class _MconPhotoSizeSelectLargePainter extends MconPainter {
  _MconPhotoSizeSelectLargePainter({
