...
/// Animated barcode_scanner icon from Google Material Icons
class MconBarcodeScanner extends MconBase {
  const MconBarcodeScanner({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBarcodeScanner> createState() => _MconBarcodeScannerState();
}

class _MconBarcodeScannerState extends MconBaseState<MconBarcodeScanner> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBarcodeScannerPainter(
      animation: animation,
...
class _MconBarcodeScannerPainter extends MconPainter {
  _MconBarcodeScannerPainter({
