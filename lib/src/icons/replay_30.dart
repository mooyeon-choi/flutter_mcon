...
/// Animated replay_30 icon from Google Material Icons
class MconReplay30 extends MconBase {
  const MconReplay30({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconReplay30> createState() => _MconReplay30State();
}

class _MconReplay30State extends MconBaseState<MconReplay30> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconReplay30Painter(
      animation: animation,
...
class _MconReplay30Painter extends MconPainter {
  _MconReplay30Painter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(536.0), y(-658.0));
    path.lineTo(x(480.0), y(-600.0));
    path.lineTo(x(320.0), y(-760.0));
    path.lineTo(x(480.0), y(-920.0));
    path.lineTo(x(536.0), y(-862.0));
    path.lineTo(x(474.0), y(-800.0));
    ...
    path.quadraticBezierTo(x(460.0), y(-343.0), x(448.5), y(-331.5));
    path.quadraticBezierTo(x(437.0), y(-320.0), x(420.0), y(-320.0));
    path.lineTo(x(300.0), y(-320.0));
    path.close();
    path.moveTo(x(540.0), y(-320.0));
    path.quadraticBezierTo(x(523.0), y(-320.0), x(511.5), y(-331.5));
    path.quadraticBezierTo(x(500.0), y(-343.0), x(500.0), y(-360.0));
    ...
    path.quadraticBezierTo(x(660.0), y(-343.0), x(648.5), y(-331.5));
    path.quadraticBezierTo(x(637.0), y(-320.0), x(620.0), y(-320.0));
    path.lineTo(x(540.0), y(-320.0));
    path.close();
    path.moveTo(x(560.0), y(-380.0));
