...
/// Animated topic icon from Google Material Icons
class MconTopic extends MconBase {
  const MconTopic({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconTopic> createState() => _MconTopicState();
}

class _MconTopicState extends MconBaseState<MconTopic> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTopicPainter(
      animation: animation,
...
class _MconTopicPainter extends MconPainter {
  _MconTopicPainter({
