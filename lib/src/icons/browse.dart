...
/// Animated browse icon from Google Material Icons
class MconBrowse extends MconBase {
  const MconBrowse({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconBrowse> createState() => _MconBrowseState();
}

class _MconBrowseState extends MconBaseState<MconBrowse> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBrowsePainter(
      animation: animation,
...
class _MconBrowsePainter extends MconPainter {
  _MconBrowsePainter({
