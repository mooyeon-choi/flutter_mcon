...
/// Animated book icon from Google Material Icons
class MconBook extends MconBase {
  const MconBook({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconBook> createState() => _MconBookState();
}

class _MconBookState extends MconBaseState<MconBook> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBookPainter(
      animation: animation,
...
class _MconBookPainter extends MconPainter {
  _MconBookPainter({
