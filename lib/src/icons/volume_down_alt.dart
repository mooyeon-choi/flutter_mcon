...
/// Animated volume_down_alt icon from Google Material Icons
class MconVolumeDownAlt extends MconBase {
  const MconVolumeDownAlt({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconVolumeDownAlt> createState() => _MconVolumeDownAltState();
}

class _MconVolumeDownAltState extends MconBaseState<MconVolumeDownAlt> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconVolumeDownAltPainter(
      animation: animation,
...
class _MconVolumeDownAltPainter extends MconPainter {
  _MconVolumeDownAltPainter({
