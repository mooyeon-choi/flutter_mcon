...
/// Animated network_wifi_1_bar_locked icon from Google Material Icons
class MconNetworkWifi1BarLocked extends MconBase {
  const MconNetworkWifi1BarLocked({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconNetworkWifi1BarLocked> createState() =>
      _MconNetworkWifi1BarLockedState();
}

class _MconNetworkWifi1BarLockedState
    extends MconBaseState<MconNetworkWifi1BarLocked> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconNetworkWifi1BarLockedPainter(
      animation: animation,
...
class _MconNetworkWifi1BarLockedPainter extends MconPainter {
  _MconNetworkWifi1BarLockedPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(348.0), y(-366.0));
    path.quadraticBezierTo(x(390.0), y(-391.0), x(446.0), y(-398.5));
    path.quadraticBezierTo(x(502.0), y(-406.0), x(548.0), y(-392.0));
    path.quadraticBezierTo(x(534.0), y(-367.0), x(527.0), y(-336.5));
    path.quadraticBezierTo(x(520.0), y(-306.0), x(520.0), y(-279.0));
