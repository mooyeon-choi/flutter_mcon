...
/// Animated battery_low icon from Google Material Icons
class MconBatteryLow extends MconBase {
  const MconBatteryLow({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryLow> createState() => _MconBatteryLowState();
}

class _MconBatteryLowState extends MconBaseState<MconBatteryLow> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryLowPainter(
      animation: animation,
...
class _MconBatteryLowPainter extends MconPainter {
  _MconBatteryLowPainter({
