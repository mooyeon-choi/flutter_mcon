...
/// Animated join_left icon from Google Material Icons
class MconJoinLeft extends MconBase {
  const MconJoinLeft({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconJoinLeft> createState() => _MconJoinLeftState();
}

class _MconJoinLeftState extends MconBaseState<MconJoinLeft> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconJoinLeftPainter(
      animation: animation,
...
class _MconJoinLeftPainter extends MconPainter {
  _MconJoinLeftPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(364.0), y(-692.0), x(332.0), y(-624.0));
    path.quadraticBezierTo(x(300.0), y(-556.0), x(300.0), y(-480.0));
    path.quadraticBezierTo(x(300.0), y(-404.0), x(332.0), y(-336.0));
    path.quadraticBezierTo(x(364.0), y(-268.0), x(422.0), y(-219.0));
