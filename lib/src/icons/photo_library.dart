...
/// Animated photo_library icon from Google Material Icons
class MconPhotoLibrary extends MconBase {
  const MconPhotoLibrary({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPhotoLibrary> createState() => _MconPhotoLibraryState();
}

class _MconPhotoLibraryState extends MconBaseState<MconPhotoLibrary> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPhotoLibraryPainter(
      animation: animation,
...
class _MconPhotoLibraryPainter extends MconPainter {
  _MconPhotoLibraryPainter({
