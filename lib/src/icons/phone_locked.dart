...
/// Animated phone_locked icon from Google Material Icons
class MconPhoneLocked extends MconBase {
  const MconPhoneLocked({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPhoneLocked> createState() => _MconPhoneLockedState();
}

class _MconPhoneLockedState extends MconBaseState<MconPhoneLocked> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPhoneLockedPainter(
      animation: animation,
...
class _MconPhoneLockedPainter extends MconPainter {
  _MconPhoneLockedPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(600.0), y(-737.0), x(611.5), y(-748.5));
    ...
    path.quadraticBezierTo(x(760.0), y(-817.0), x(748.5), y(-828.5));
    path.quadraticBezierTo(x(737.0), y(-840.0), x(720.0), y(-840.0));
    path.quadraticBezierTo(x(703.0), y(-840.0), x(691.5), y(-828.5));
