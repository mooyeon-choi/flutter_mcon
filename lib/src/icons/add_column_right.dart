...
/// Animated add_column_right icon from Google Material Icons
class MconAddColumnRight extends MconBase {
  const MconAddColumnRight({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconAddColumnRight> createState() => _MconAddColumnRightState();
}

class _MconAddColumnRightState extends MconBaseState<MconAddColumnRight> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAddColumnRightPainter(
      animation: animation,
...
class _MconAddColumnRightPainter extends MconPainter {
  _MconAddColumnRightPainter({
