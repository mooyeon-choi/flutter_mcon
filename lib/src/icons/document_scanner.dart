...
/// Animated document_scanner icon from Google Material Icons
class MconDocumentScanner extends MconBase {
  const MconDocumentScanner({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDocumentScanner> createState() =>
      _MconDocumentScannerState();
}

class _MconDocumentScannerState extends MconBaseState<MconDocumentScanner> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDocumentScannerPainter(
      animation: animation,
...
class _MconDocumentScannerPainter extends MconPainter {
  _MconDocumentScannerPainter({
