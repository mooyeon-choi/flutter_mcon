...
/// Animated cast icon from Google Material Icons
class MconCast extends MconBase {
  const MconCast({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCast> createState() => _MconCastState();
}

class _MconCastState extends MconBaseState<MconCast> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCastPainter(
      animation: animation,
...
class _MconCastPainter extends MconPainter {
  _MconCastPainter({
