...
/// Animated home_work icon from Google Material Icons
class MconHomeWork extends MconBase {
  const MconHomeWork({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconHomeWork> createState() => _MconHomeWorkState();
}

class _MconHomeWorkState extends MconBaseState<MconHomeWork> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHomeWorkPainter(
      animation: animation,
...
class _MconHomeWorkPainter extends MconPainter {
  _MconHomeWorkPainter({
