...
/// Animated card_travel icon from Google Material Icons
class MconCardTravel extends MconBase {
  const MconCardTravel({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCardTravel> createState() => _MconCardTravelState();
}

class _MconCardTravelState extends MconBaseState<MconCardTravel> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCardTravelPainter(
      animation: animation,
...
class _MconCardTravelPainter extends MconPainter {
  _MconCardTravelPainter({
