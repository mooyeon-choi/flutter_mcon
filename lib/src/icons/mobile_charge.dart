...
/// Animated mobile_charge icon from Google Material Icons
class MconMobileCharge extends MconBase {
  const MconMobileCharge({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMobileCharge> createState() => _MconMobileChargeState();
}

class _MconMobileChargeState extends MconBaseState<MconMobileCharge> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMobileChargePainter(
      animation: animation,
...
class _MconMobileChargePainter extends MconPainter {
  _MconMobileChargePainter({
