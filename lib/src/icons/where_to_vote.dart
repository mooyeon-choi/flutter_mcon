...
/// Animated where_to_vote icon from Google Material Icons
class MconWhereToVote extends MconBase {
  const MconWhereToVote({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconWhereToVote> createState() => _MconWhereToVoteState();
}

class _MconWhereToVoteState extends MconBaseState<MconWhereToVote> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWhereToVotePainter(
      animation: animation,
...
class _MconWhereToVotePainter extends MconPainter {
  _MconWhereToVotePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.moveTo(x(438.0), y(-426.0));
    path.lineTo(x(636.0), y(-624.0));
    path.lineTo(x(579.0), y(-681.0));
    path.lineTo(x(438.0), y(-540.0));
    path.lineTo(x(382.0), y(-596.0));
    path.lineTo(x(325.0), y(-539.0));
    path.lineTo(x(438.0), y(-426.0));
    path.close();
