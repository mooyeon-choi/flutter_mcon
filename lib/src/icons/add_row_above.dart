...
/// Animated add_row_above icon from Google Material Icons
class MconAddRowAbove extends MconBase {
  const MconAddRowAbove({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconAddRowAbove> createState() => _MconAddRowAboveState();
}

class _MconAddRowAboveState extends MconBaseState<MconAddRowAbove> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAddRowAbovePainter(
      animation: animation,
...
class _MconAddRowAbovePainter extends MconPainter {
  _MconAddRowAbovePainter({
