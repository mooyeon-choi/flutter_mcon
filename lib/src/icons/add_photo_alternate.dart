...
/// Animated add_photo_alternate icon from Google Material Icons
class MconAddPhotoAlternate extends MconBase {
  const MconAddPhotoAlternate({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconAddPhotoAlternateState extends MconBaseState<MconAddPhotoAlternate> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAddPhotoAlternatePainter(
      animation: animation,
...
class _MconAddPhotoAlternatePainter extends MconPainter {
  _MconAddPhotoAlternatePainter({
