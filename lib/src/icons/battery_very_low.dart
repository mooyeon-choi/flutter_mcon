...
/// Animated battery_very_low icon from Google Material Icons
class MconBatteryVeryLow extends MconBase {
  const MconBatteryVeryLow({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryVeryLow> createState() => _MconBatteryVeryLowState();
}

class _MconBatteryVeryLowState extends MconBaseState<MconBatteryVeryLow> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryVeryLowPainter(
      animation: animation,
...
class _MconBatteryVeryLowPainter extends MconPainter {
  _MconBatteryVeryLowPainter({
