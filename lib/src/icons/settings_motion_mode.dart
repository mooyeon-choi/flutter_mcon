...
/// Animated settings_motion_mode icon from Google Material Icons
class MconSettingsMotionMode extends MconBase {
  const MconSettingsMotionMode({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSettingsMotionMode> createState() =>
      _MconSettingsMotionModeState();
}

class _MconSettingsMotionModeState
    extends MconBaseState<MconSettingsMotionMode> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSettingsMotionModePainter(
      animation: animation,
...
class _MconSettingsMotionModePainter extends MconPainter {
  _MconSettingsMotionModePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(696.0), y(-480.0), x(711.0), y(-477.5));
    path.quadraticBezierTo(x(726.0), y(-475.0), x(740.0), y(-470.0));
    path.lineTo(x(740.0), y(-90.0));
    path.quadraticBezierTo(x(726.0), y(-85.0), x(711.0), y(-82.5));
    path.quadraticBezierTo(x(696.0), y(-80.0), x(680.0), y(-80.0));
    path.close();
    path.moveTo(x(580.0), y(-108.0));
    path.lineTo(x(580.0), y(-452.0));
    path.quadraticBezierTo(x(594.0), y(-460.0), x(608.5), y(-466.5));
    path.quadraticBezierTo(x(623.0), y(-473.0), x(640.0), y(-476.0));
    path.lineTo(x(640.0), y(-84.0));
    path.quadraticBezierTo(x(623.0), y(-87.0), x(608.5), y(-93.5));
    path.quadraticBezierTo(x(594.0), y(-100.0), x(580.0), y(-108.0));
    path.close();
    path.moveTo(x(780.0), y(-108.0));
    path.lineTo(x(780.0), y(-452.0));
    path.quadraticBezierTo(x(825.0), y(-426.0), x(852.5), y(-381.0));
    path.quadraticBezierTo(x(880.0), y(-336.0), x(880.0), y(-280.0));
    path.quadraticBezierTo(x(880.0), y(-224.0), x(852.5), y(-179.0));
    path.quadraticBezierTo(x(825.0), y(-134.0), x(780.0), y(-108.0));
    path.close();
    path.moveTo(x(540.0), y(-138.0));
    path.quadraticBezierTo(x(512.0), y(-165.0), x(496.0), y(-201.5));
    path.quadraticBezierTo(x(480.0), y(-238.0), x(480.0), y(-280.0));
    path.quadraticBezierTo(x(480.0), y(-322.0), x(496.0), y(-359.0));
    path.quadraticBezierTo(x(512.0), y(-396.0), x(540.0), y(-423.0));
    path.lineTo(x(540.0), y(-138.0));
    path.close();
