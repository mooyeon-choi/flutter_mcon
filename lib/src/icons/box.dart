...
/// Animated box icon from Google Material Icons
class MconBox extends MconBase {
  const MconBox({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconBox> createState() => _MconBoxState();
}

class _MconBoxState extends MconBaseState<MconBox> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBoxPainter(
      animation: animation,
...
class _MconBoxPainter extends MconPainter {
  _MconBoxPainter({
