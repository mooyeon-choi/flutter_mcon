...
/// Animated border_right icon from Google Material Icons
class MconBorderRight extends MconBase {
  const MconBorderRight({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBorderRight> createState() => _MconBorderRightState();
}

class _MconBorderRightState extends MconBaseState<MconBorderRight> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBorderRightPainter(
      animation: animation,
...
class _MconBorderRightPainter extends MconPainter {
  _MconBorderRightPainter({
