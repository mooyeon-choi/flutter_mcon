...
/// Animated battery_android_frame_6 icon from Google Material Icons
class MconBatteryAndroidFrame6 extends MconBase {
  const MconBatteryAndroidFrame6({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryAndroidFrame6> createState() => _MconBatteryAndroidFrame6State();
}

class _MconBatteryAndroidFrame6State extends MconBaseState<MconBatteryAndroidFrame6> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryAndroidFrame6Painter(
      animation: animation,
...
class _MconBatteryAndroidFrame6Painter extends MconPainter {
  _MconBatteryAndroidFrame6Painter({
