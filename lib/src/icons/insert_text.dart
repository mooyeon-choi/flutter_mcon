...
/// Animated insert_text icon from Google Material Icons
class MconInsertText extends MconBase {
  const MconInsertText({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconInsertText> createState() => _MconInsertTextState();
}

class _MconInsertTextState extends MconBaseState<MconInsertText> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconInsertTextPainter(
      animation: animation,
...
class _MconInsertTextPainter extends MconPainter {
  _MconInsertTextPainter({
