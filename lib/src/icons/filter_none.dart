...
/// Animated filter_none icon from Google Material Icons
class MconFilterNone extends MconBase {
  const MconFilterNone({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconFilterNone> createState() => _MconFilterNoneState();
}

class _MconFilterNoneState extends MconBaseState<MconFilterNone> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFilterNonePainter(
      animation: animation,
...
class _MconFilterNonePainter extends MconPainter {
  _MconFilterNonePainter({
