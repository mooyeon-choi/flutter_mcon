...
/// Animated contrast_circle icon from Google Material Icons
class MconContrastCircle extends MconBase {
  const MconContrastCircle({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconContrastCircle> createState() => _MconContrastCircleState();
}

class _MconContrastCircleState extends MconBaseState<MconContrastCircle> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconContrastCirclePainter(
      animation: animation,
...
class _MconContrastCirclePainter extends MconPainter {
  _MconContrastCirclePainter({
