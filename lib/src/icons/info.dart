...
/// Animated info icon from Google Material Icons
class MconInfo extends MconBase {
  const MconInfo({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconInfo> createState() => _MconInfoState();
}

class _MconInfoState extends MconBaseState<MconInfo> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconInfoPainter(
      animation: animation,
...
class _MconInfoPainter extends MconPainter {
  _MconInfoPainter({
