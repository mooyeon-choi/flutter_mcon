...
/// Animated battery_android_2 icon from Google Material Icons
class MconBatteryAndroid2 extends MconBase {
  const MconBatteryAndroid2({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryAndroid2> createState() => _MconBatteryAndroid2State();
}

class _MconBatteryAndroid2State extends MconBaseState<MconBatteryAndroid2> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryAndroid2Painter(
      animation: animation,
...
class _MconBatteryAndroid2Painter extends MconPainter {
  _MconBatteryAndroid2Painter({
