...
/// Animated touch_triple icon from Google Material Icons
class MconTouchTriple extends MconBase {
  const MconTouchTriple({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconTouchTriple> createState() => _MconTouchTripleState();
}

class _MconTouchTripleState extends MconBaseState<MconTouchTriple> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTouchTriplePainter(
      animation: animation,
...
class _MconTouchTriplePainter extends MconPainter {
  _MconTouchTriplePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(367.0), y(-920.0), x(392.0), y(-913.5));
    path.quadraticBezierTo(x(417.0), y(-907.0), x(439.0), y(-894.0));
    path.quadraticBezierTo(x(486.0), y(-868.0), x(513.0), y(-821.0));
    path.quadraticBezierTo(x(540.0), y(-774.0), x(540.0), y(-720.0));
    ...
    path.quadraticBezierTo(x(460.0), y(-752.0), x(443.5), y(-780.0));
    path.quadraticBezierTo(x(427.0), y(-808.0), x(399.0), y(-824.0));
    path.quadraticBezierTo(x(386.0), y(-832.0), x(371.0), y(-836.0));
    path.quadraticBezierTo(x(356.0), y(-840.0), x(340.0), y(-840.0));
    ...
    path.close();
    path.moveTo(x(719.0), y(-824.0));
    path.lineTo(x(759.0), y(-894.0));
    path.quadraticBezierTo(x(806.0), y(-868.0), x(833.0), y(-821.0));
    path.quadraticBezierTo(x(860.0), y(-774.0), x(860.0), y(-720.0));
    path.quadraticBezierTo(x(860.0), y(-693.0), x(853.0), y(-667.5));
    path.quadraticBezierTo(x(846.0), y(-642.0), x(833.0), y(-620.0));
    path.lineTo(x(764.0), y(-660.0));
    path.quadraticBezierTo(x(772.0), y(-674.0), x(776.0), y(-688.5));
    path.quadraticBezierTo(x(780.0), y(-703.0), x(780.0), y(-720.0));
    path.quadraticBezierTo(x(780.0), y(-752.0), x(763.5), y(-780.0));
    path.quadraticBezierTo(x(747.0), y(-808.0), x(719.0), y(-824.0));
    path.close();
    path.moveTo(x(559.0), y(-824.0));
    path.lineTo(x(599.0), y(-894.0));
    path.quadraticBezierTo(x(646.0), y(-868.0), x(673.0), y(-821.0));
    path.quadraticBezierTo(x(700.0), y(-774.0), x(700.0), y(-720.0));
    path.quadraticBezierTo(x(700.0), y(-693.0), x(693.0), y(-667.5));
    path.quadraticBezierTo(x(686.0), y(-642.0), x(673.0), y(-620.0));
    path.lineTo(x(604.0), y(-660.0));
    path.quadraticBezierTo(x(612.0), y(-674.0), x(616.0), y(-688.5));
    path.quadraticBezierTo(x(620.0), y(-703.0), x(620.0), y(-720.0));
    path.quadraticBezierTo(x(620.0), y(-752.0), x(603.5), y(-780.0));
    path.quadraticBezierTo(x(587.0), y(-808.0), x(559.0), y(-824.0));
    path.close();
