...
/// Animated cancel icon from Google Material Icons
class MconCancel extends MconBase {
  const MconCancel({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCancel> createState() => _MconCancelState();
}

class _MconCancelState extends MconBaseState<MconCancel> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCancelPainter(
      animation: animation,
...
class _MconCancelPainter extends MconPainter {
  _MconCancelPainter({
