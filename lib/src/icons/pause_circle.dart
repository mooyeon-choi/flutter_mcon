...
/// Animated pause_circle icon from Google Material Icons
class MconPauseCircle extends MconBase {
  const MconPauseCircle({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPauseCircle> createState() => _MconPauseCircleState();
}

class _MconPauseCircleState extends MconBaseState<MconPauseCircle> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPauseCirclePainter(
      animation: animation,
...
class _MconPauseCirclePainter extends MconPainter {
  _MconPauseCirclePainter({
