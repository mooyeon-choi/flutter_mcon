...
/// Animated text_select_end icon from Google Material Icons
class MconTextSelectEnd extends MconBase {
  const MconTextSelectEnd({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconTextSelectEnd> createState() => _MconTextSelectEndState();
}

class _MconTextSelectEndState extends MconBaseState<MconTextSelectEnd> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTextSelectEndPainter(
      animation: animation,
...
class _MconTextSelectEndPainter extends MconPainter {
  _MconTextSelectEndPainter({
