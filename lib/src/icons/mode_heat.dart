...
/// Animated mode_heat icon from Google Material Icons
class MconModeHeat extends MconBase {
  const MconModeHeat({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconModeHeat> createState() => _MconModeHeatState();
}

class _MconModeHeatState extends MconBaseState<MconModeHeat> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconModeHeatPainter(
      animation: animation,
...
class _MconModeHeatPainter extends MconPainter {
  _MconModeHeatPainter({
