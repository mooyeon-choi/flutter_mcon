...
/// Animated domain icon from Google Material Icons
class MconDomain extends MconBase {
  const MconDomain({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconDomain> createState() => _MconDomainState();
}

class _MconDomainState extends MconBaseState<MconDomain> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDomainPainter(
      animation: animation,
...
class _MconDomainPainter extends MconPainter {
  _MconDomainPainter({
