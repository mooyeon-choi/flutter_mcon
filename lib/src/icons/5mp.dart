...
/// Animated 5mp icon from Google Material Icons
class Mcon5mp extends MconBase {
  const Mcon5mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon5mp> createState() => _Mcon5mpState();
}

class _Mcon5mpState extends MconBaseState<Mcon5mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon5mpPainter(
      animation: animation,
...
class _Mcon5mpPainter extends MconPainter {
  _Mcon5mpPainter({
