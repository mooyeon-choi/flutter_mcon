...
/// Animated perm_phone_msg icon from Google Material Icons
class MconPermPhoneMsg extends MconBase {
  const MconPermPhoneMsg({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPermPhoneMsg> createState() => _MconPermPhoneMsgState();
}

class _MconPermPhoneMsgState extends MconBaseState<MconPermPhoneMsg> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPermPhoneMsgPainter(
      animation: animation,
...
class _MconPermPhoneMsgPainter extends MconPainter {
  _MconPermPhoneMsgPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(480.0), y(-817.0), x(491.5), y(-828.5));
    path.quadraticBezierTo(x(503.0), y(-840.0), x(520.0), y(-840.0));
