...
/// Animated contact_mail icon from Google Material Icons
class MconContactMail extends MconBase {
  const MconContactMail({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconContactMail> createState() => _MconContactMailState();
}

class _MconContactMailState extends MconBaseState<MconContactMail> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconContactMailPainter(
      animation: animation,
...
class _MconContactMailPainter extends MconPainter {
  _MconContactMailPainter({
