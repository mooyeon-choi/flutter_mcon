...
/// Animated pending_actions icon from Google Material Icons
class MconPendingActions extends MconBase {
  const MconPendingActions({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPendingActions> createState() => _MconPendingActionsState();
}

class _MconPendingActionsState extends MconBaseState<MconPendingActions> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPendingActionsPainter(
      animation: animation,
...
class _MconPendingActionsPainter extends MconPainter {
  _MconPendingActionsPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(840.0), y(-510.0));
    path.quadraticBezierTo(x(822.0), y(-523.0), x(802.0), y(-532.0));
    path.quadraticBezierTo(x(782.0), y(-541.0), x(760.0), y(-548.0));
    ...
    path.quadraticBezierTo(x(419.0), y(-178.0), x(428.0), y(-158.0));
    path.quadraticBezierTo(x(437.0), y(-138.0), x(450.0), y(-120.0));
