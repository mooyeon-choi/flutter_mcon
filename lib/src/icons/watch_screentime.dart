...
/// Animated watch_screentime icon from Google Material Icons
class MconWatchScreentime extends MconBase {
  const MconWatchScreentime({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconWatchScreentime> createState() =>
      _MconWatchScreentimeState();
}

class _MconWatchScreentimeState extends MconBaseState<MconWatchScreentime> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWatchScreentimePainter(
      animation: animation,
...
class _MconWatchScreentimePainter extends MconPainter {
  _MconWatchScreentimePainter({
