...
/// Animated segment icon from Google Material Icons
class MconSegment extends MconBase {
  const MconSegment({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconSegment> createState() => _MconSegmentState();
}

class _MconSegmentState extends MconBaseState<MconSegment> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSegmentPainter(
      animation: animation,
...
class _MconSegmentPainter extends MconPainter {
  _MconSegmentPainter({
