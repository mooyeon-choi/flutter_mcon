...
/// Animated 8k icon from Google Material Icons
class Mcon8k extends MconBase {
  const Mcon8k({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon8k> createState() => _Mcon8kState();
}

class _Mcon8kState extends MconBaseState<Mcon8k> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon8kPainter(
      animation: animation,
...
class _Mcon8kPainter extends MconPainter {
  _Mcon8kPainter({
