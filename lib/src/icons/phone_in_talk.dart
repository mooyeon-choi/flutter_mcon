...
/// Animated phone_in_talk icon from Google Material Icons
class MconPhoneInTalk extends MconBase {
  const MconPhoneInTalk({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPhoneInTalk> createState() => _MconPhoneInTalkState();
}

class _MconPhoneInTalkState extends MconBaseState<MconPhoneInTalk> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPhoneInTalkPainter(
      animation: animation,
...
class _MconPhoneInTalkPainter extends MconPainter {
  _MconPhoneInTalkPainter({
