...
/// Animated car_fan_mid_low_right icon from Google Material Icons
class MconCarFanMidLowRight extends MconBase {
  const MconCarFanMidLowRight({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCarFanMidLowRight> createState() => _MconCarFanMidLowRightState();
}

class _MconCarFanMidLowRightState extends MconBaseState<MconCarFanMidLowRight> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCarFanMidLowRightPainter(
      animation: animation,
...
class _MconCarFanMidLowRightPainter extends MconPainter {
  _MconCarFanMidLowRightPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(318.0), y(-682.0));
    path.lineTo(x(365.0), y(-730.0));
    path.lineTo(x(240.0), y(-730.0));
    path.lineTo(x(240.0), y(-790.0));
    path.lineTo(x(365.0), y(-790.0));
    path.lineTo(x(318.0), y(-838.0));
    ...
    path.lineTo(x(122.0), y(-562.0));
    path.lineTo(x(170.0), y(-515.0));
    path.lineTo(x(170.0), y(-640.0));
    path.lineTo(x(230.0), y(-640.0));
    path.lineTo(x(230.0), y(-515.0));
    path.lineTo(x(278.0), y(-562.0));
