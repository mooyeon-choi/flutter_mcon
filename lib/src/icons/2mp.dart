...
/// Animated 2mp icon from Google Material Icons
class Mcon2mp extends MconBase {
  const Mcon2mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon2mp> createState() => _Mcon2mpState();
}

class _Mcon2mpState extends MconBaseState<Mcon2mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon2mpPainter(
      animation: animation,
...
class _Mcon2mpPainter extends MconPainter {
  _Mcon2mpPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.close();
    path.moveTo(x(390.0), y(-500.0));
    path.lineTo(x(570.0), y(-500.0));
    path.lineTo(x(570.0), y(-560.0));
    path.lineTo(x(450.0), y(-560.0));
    path.lineTo(x(450.0), y(-600.0));
    path.lineTo(x(530.0), y(-600.0));
    path.quadraticBezierTo(x(547.0), y(-600.0), x(558.5), y(-611.5));
    path.quadraticBezierTo(x(570.0), y(-623.0), x(570.0), y(-640.0));
    path.lineTo(x(570.0), y(-700.0));
    path.quadraticBezierTo(x(570.0), y(-717.0), x(558.5), y(-728.5));
    path.quadraticBezierTo(x(547.0), y(-740.0), x(530.0), y(-740.0));
    path.lineTo(x(390.0), y(-740.0));
    path.lineTo(x(390.0), y(-680.0));
    path.lineTo(x(510.0), y(-680.0));
    path.lineTo(x(510.0), y(-640.0));
    path.lineTo(x(430.0), y(-640.0));
    path.quadraticBezierTo(x(413.0), y(-640.0), x(401.5), y(-628.5));
    path.quadraticBezierTo(x(390.0), y(-617.0), x(390.0), y(-600.0));
    path.lineTo(x(390.0), y(-500.0));
    path.close();
