...
/// Animated delivery_truck_speed icon from Google Material Icons
class MconDeliveryTruckSpeed extends MconBase {
  const MconDeliveryTruckSpeed({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDeliveryTruckSpeed> createState() =>
      _MconDeliveryTruckSpeedState();
}

class _MconDeliveryTruckSpeedState
    extends MconBaseState<MconDeliveryTruckSpeed> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDeliveryTruckSpeedPainter(
      animation: animation,
...
class _MconDeliveryTruckSpeedPainter extends MconPainter {
  _MconDeliveryTruckSpeedPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(182.0), y(-720.0));
    path.lineTo(x(186.0), y(-737.0));
    path.quadraticBezierTo(x(192.0), y(-765.0), x(213.5), y(-782.5));
    path.quadraticBezierTo(x(235.0), y(-800.0), x(264.0), y(-800.0));
    ...
    path.close();
    path.moveTo(x(618.0), y(-713.0));
    path.lineTo(x(620.0), y(-720.0));
    path.lineTo(x(536.0), y(-360.0));
    path.lineTo(x(538.0), y(-367.0));
    path.lineTo(x(572.0), y(-513.0));
    path.lineTo(x(618.0), y(-713.0));
    path.close();
    path.moveTo(x(20.0), y(-427.0));
    path.lineTo(x(40.0), y(-507.0));
    path.lineTo(x(260.0), y(-507.0));
    path.lineTo(x(240.0), y(-427.0));
    path.lineTo(x(20.0), y(-427.0));
    path.close();
    path.moveTo(x(100.0), y(-573.0));
    path.lineTo(x(120.0), y(-653.0));
    path.lineTo(x(380.0), y(-653.0));
    path.lineTo(x(360.0), y(-573.0));
    path.lineTo(x(100.0), y(-573.0));
    path.close();
