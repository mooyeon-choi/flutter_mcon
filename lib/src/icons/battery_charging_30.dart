...
/// Animated battery_charging_30 icon from Google Material Icons
class MconBatteryCharging30 extends MconBase {
  const MconBatteryCharging30({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryCharging30> createState() => _MconBatteryCharging30State();
}

class _MconBatteryCharging30State extends MconBaseState<MconBatteryCharging30> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryCharging30Painter(
      animation: animation,
...
class _MconBatteryCharging30Painter extends MconPainter {
  _MconBatteryCharging30Painter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(454.0), y(-320.0));
    path.quadraticBezierTo(x(447.0), y(-301.0), x(443.5), y(-281.0));
    path.quadraticBezierTo(x(440.0), y(-261.0), x(440.0), y(-240.0));
