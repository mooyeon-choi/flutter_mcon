...
/// Animated do_not_disturb_off icon from Google Material Icons
class MconDoNotDisturbOff extends MconBase {
  const MconDoNotDisturbOff({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDoNotDisturbOff> createState() =>
      _MconDoNotDisturbOffState();
}

class _MconDoNotDisturbOffState extends MconBaseState<MconDoNotDisturbOff> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDoNotDisturbOffPainter(
      animation: animation,
...
class _MconDoNotDisturbOffPainter extends MconPainter {
  _MconDoNotDisturbOffPainter({
