...
/// Animated splitscreen_right icon from Google Material Icons
class MconSplitscreenRight extends MconBase {
  const MconSplitscreenRight({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSplitscreenRight> createState() =>
      _MconSplitscreenRightState();
}

class _MconSplitscreenRightState extends MconBaseState<MconSplitscreenRight> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSplitscreenRightPainter(
      animation: animation,
...
class _MconSplitscreenRightPainter extends MconPainter {
  _MconSplitscreenRightPainter({
