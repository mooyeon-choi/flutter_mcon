...
/// Animated cast_warning icon from Google Material Icons
class MconCastWarning extends MconBase {
  const MconCastWarning({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCastWarning> createState() => _MconCastWarningState();
}

class _MconCastWarningState extends MconBaseState<MconCastWarning> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCastWarningPainter(
      animation: animation,
...
class _MconCastWarningPainter extends MconPainter {
  _MconCastWarningPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(728.0), y(-600.0), x(734.0), y(-606.0));
    path.quadraticBezierTo(x(740.0), y(-612.0), x(740.0), y(-620.0));
    path.quadraticBezierTo(x(740.0), y(-628.0), x(734.0), y(-634.0));
    path.quadraticBezierTo(x(728.0), y(-640.0), x(720.0), y(-640.0));
    path.quadraticBezierTo(x(712.0), y(-640.0), x(706.0), y(-634.0));
    path.quadraticBezierTo(x(700.0), y(-628.0), x(700.0), y(-620.0));
    path.quadraticBezierTo(x(700.0), y(-612.0), x(706.0), y(-606.0));
    path.quadraticBezierTo(x(712.0), y(-600.0), x(720.0), y(-600.0));
    path.close();
    path.moveTo(x(700.0), y(-680.0));
