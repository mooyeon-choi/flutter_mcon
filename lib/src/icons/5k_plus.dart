...
/// Animated 5k_plus icon from Google Material Icons
class Mcon5kPlus extends MconBase {
  const Mcon5kPlus({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon5kPlus> createState() => _Mcon5kPlusState();
}

class _Mcon5kPlusState extends MconBaseState<Mcon5kPlus> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon5kPlusPainter(
      animation: animation,
...
class _Mcon5kPlusPainter extends MconPainter {
  _Mcon5kPlusPainter({
