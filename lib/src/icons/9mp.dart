...
/// Animated 9mp icon from Google Material Icons
class Mcon9mp extends MconBase {
  const Mcon9mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon9mp> createState() => _Mcon9mpState();
}

class _Mcon9mpState extends MconBaseState<Mcon9mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon9mpPainter(
      animation: animation,
...
class _Mcon9mpPainter extends MconPainter {
  _Mcon9mpPainter({
