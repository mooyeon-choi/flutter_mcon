...
/// Animated keyboard_onscreen icon from Google Material Icons
class MconKeyboardOnscreen extends MconBase {
  const MconKeyboardOnscreen({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconKeyboardOnscreen> createState() =>
      _MconKeyboardOnscreenState();
}

class _MconKeyboardOnscreenState extends MconBaseState<MconKeyboardOnscreen> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconKeyboardOnscreenPainter(
      animation: animation,
...
class _MconKeyboardOnscreenPainter extends MconPainter {
  _MconKeyboardOnscreenPainter({
