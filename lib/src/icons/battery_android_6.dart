...
/// Animated battery_android_6 icon from Google Material Icons
class MconBatteryAndroid6 extends MconBase {
  const MconBatteryAndroid6({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryAndroid6> createState() => _MconBatteryAndroid6State();
}

class _MconBatteryAndroid6State extends MconBaseState<MconBatteryAndroid6> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryAndroid6Painter(
      animation: animation,
...
class _MconBatteryAndroid6Painter extends MconPainter {
  _MconBatteryAndroid6Painter({
