...
/// Animated 19mp icon from Google Material Icons
class Mcon19mp extends MconBase {
  const Mcon19mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon19mp> createState() => _Mcon19mpState();
}

class _Mcon19mpState extends MconBaseState<Mcon19mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon19mpPainter(
      animation: animation,
...
class _Mcon19mpPainter extends MconPainter {
  _Mcon19mpPainter({
