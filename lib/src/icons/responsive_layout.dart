...
/// Animated responsive_layout icon from Google Material Icons
class MconResponsiveLayout extends MconBase {
  const MconResponsiveLayout({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconResponsiveLayout> createState() =>
      _MconResponsiveLayoutState();
}

class _MconResponsiveLayoutState extends MconBaseState<MconResponsiveLayout> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconResponsiveLayoutPainter(
      animation: animation,
...
class _MconResponsiveLayoutPainter extends MconPainter {
  _MconResponsiveLayoutPainter({
