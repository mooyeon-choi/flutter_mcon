...
/// Animated parent_child_dining icon from Google Material Icons
class MconParentChildDining extends MconBase {
  const MconParentChildDining({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconParentChildDining> createState() =>
      _MconParentChildDiningState();
}

class _MconParentChildDiningState extends MconBaseState<MconParentChildDining> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconParentChildDiningPainter(
      animation: animation,
...
class _MconParentChildDiningPainter extends MconPainter {
  _MconParentChildDiningPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.close();
    path.moveTo(x(200.0), y(-454.0));
    path.lineTo(x(200.0), y(-191.0));
    path.quadraticBezierTo(x(220.0), y(-211.0), x(274.0), y(-225.5));
    path.quadraticBezierTo(x(328.0), y(-240.0), x(380.0), y(-240.0));
    path.quadraticBezierTo(x(427.0), y(-240.0), x(476.0), y(-228.0));
    path.quadraticBezierTo(x(525.0), y(-216.0), x(550.0), y(-199.0));
    ...
    path.close();
    path.moveTo(x(380.0), y(-354.0));
    path.close();
    path.moveTo(x(380.0), y(-280.0));
    path.quadraticBezierTo(x(422.0), y(-280.0), x(451.0), y(-309.0));
    path.quadraticBezierTo(x(480.0), y(-338.0), x(480.0), y(-380.0));
    path.quadraticBezierTo(x(480.0), y(-422.0), x(451.0), y(-451.0));
    path.quadraticBezierTo(x(422.0), y(-480.0), x(380.0), y(-480.0));
    path.quadraticBezierTo(x(338.0), y(-480.0), x(309.0), y(-451.0));
    path.quadraticBezierTo(x(280.0), y(-422.0), x(280.0), y(-380.0));
    path.quadraticBezierTo(x(280.0), y(-338.0), x(309.0), y(-309.0));
    path.quadraticBezierTo(x(338.0), y(-280.0), x(380.0), y(-280.0));
    path.close();
