...
/// Animated airplay icon from Google Material Icons
class MconAirplay extends MconBase {
  const MconAirplay({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconAirplay> createState() => _MconAirplayState();
}

class _MconAirplayState extends MconBaseState<MconAirplay> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAirplayPainter(
      animation: animation,
...
class _MconAirplayPainter extends MconPainter {
  _MconAirplayPainter({
