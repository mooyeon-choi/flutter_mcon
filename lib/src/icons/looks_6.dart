...
/// Animated looks_6 icon from Google Material Icons
class MconLooks6 extends MconBase {
  const MconLooks6({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconLooks6> createState() => _MconLooks6State();
}

class _MconLooks6State extends MconBaseState<MconLooks6> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLooks6Painter(
      animation: animation,
...
class _MconLooks6Painter extends MconPainter {
  _MconLooks6Painter({
