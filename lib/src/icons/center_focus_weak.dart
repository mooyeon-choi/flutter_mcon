...
/// Animated center_focus_weak icon from Google Material Icons
class MconCenterFocusWeak extends MconBase {
  const MconCenterFocusWeak({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconCenterFocusWeakState extends MconBaseState<MconCenterFocusWeak> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCenterFocusWeakPainter(
      animation: animation,
...
class _MconCenterFocusWeakPainter extends MconPainter {
  _MconCenterFocusWeakPainter({
