...
/// Animated lock icon from Google Material Icons
class MconLock extends MconBase {
  const MconLock({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconLock> createState() => _MconLockState();
}

class _MconLockState extends MconBaseState<MconLock> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLockPainter(
      animation: animation,
...
class _MconLockPainter extends MconPainter {
  _MconLockPainter({
