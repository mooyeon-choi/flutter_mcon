...
/// Animated adjust icon from Google Material Icons
class MconAdjust extends MconBase {
  const MconAdjust({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconAdjust> createState() => _MconAdjustState();
}

class _MconAdjustState extends MconBaseState<MconAdjust> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAdjustPainter(
      animation: animation,
...
class _MconAdjustPainter extends MconPainter {
  _MconAdjustPainter({
