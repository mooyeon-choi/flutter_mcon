...
/// Animated gite icon from Google Material Icons
class MconGite extends MconBase {
  const MconGite({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconGite> createState() => _MconGiteState();
}

class _MconGiteState extends MconBaseState<MconGite> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconGitePainter(
      animation: animation,
...
class _MconGitePainter extends MconPainter {
  _MconGitePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(800.0), y(-527.0));
    path.lineTo(x(720.0), y(-607.0));
    path.lineTo(x(640.0), y(-527.0));
