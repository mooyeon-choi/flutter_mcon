...
/// Animated ev_mobiledata_badge icon from Google Material Icons
class MconEvMobiledataBadge extends MconBase {
  const MconEvMobiledataBadge({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconEvMobiledataBadge> createState() =>
      _MconEvMobiledataBadgeState();
}

class _MconEvMobiledataBadgeState extends MconBaseState<MconEvMobiledataBadge> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconEvMobiledataBadgePainter(
      animation: animation,
...
class _MconEvMobiledataBadgePainter extends MconPainter {
  _MconEvMobiledataBadgePainter({
