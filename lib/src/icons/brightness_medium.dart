...
/// Animated brightness_medium icon from Google Material Icons
class MconBrightnessMedium extends MconBase {
  const MconBrightnessMedium({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconBrightnessMediumState extends MconBaseState<MconBrightnessMedium> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBrightnessMediumPainter(
      animation: animation,
...
class _MconBrightnessMediumPainter extends MconPainter {
  _MconBrightnessMediumPainter({
