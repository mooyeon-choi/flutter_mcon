...
/// Animated 2k_plus icon from Google Material Icons
class Mcon2kPlus extends MconBase {
  const Mcon2kPlus({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon2kPlus> createState() => _Mcon2kPlusState();
}

class _Mcon2kPlusState extends MconBaseState<Mcon2kPlus> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon2kPlusPainter(
      animation: animation,
...
class _Mcon2kPlusPainter extends MconPainter {
  _Mcon2kPlusPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(377.0), y(-460.0), x(388.5), y(-471.5));
    path.quadraticBezierTo(x(400.0), y(-483.0), x(400.0), y(-500.0));
    ...
    path.quadraticBezierTo(x(263.0), y(-500.0), x(251.5), y(-488.5));
    path.quadraticBezierTo(x(240.0), y(-477.0), x(240.0), y(-460.0));
