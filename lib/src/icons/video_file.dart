...
/// Animated video_file icon from Google Material Icons
class MconVideoFile extends MconBase {
  const MconVideoFile({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconVideoFile> createState() => _MconVideoFileState();
}

class _MconVideoFileState extends MconBaseState<MconVideoFile> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconVideoFilePainter(
      animation: animation,
...
class _MconVideoFilePainter extends MconPainter {
  _MconVideoFilePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(640.0), y(-278.0));
    path.lineTo(x(640.0), y(-442.0));
