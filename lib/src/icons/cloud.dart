...
/// Animated cloud icon from Google Material Icons
class MconCloud extends MconBase {
  const MconCloud({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCloud> createState() => _MconCloudState();
}

class _MconCloudState extends MconBaseState<MconCloud> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCloudPainter(
      animation: animation,
...
class _MconCloudPainter extends MconPainter {
  _MconCloudPainter({
