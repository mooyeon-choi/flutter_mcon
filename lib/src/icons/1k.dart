...
/// Animated 1k icon from Google Material Icons
class Mcon1k extends MconBase {
  const Mcon1k({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon1k> createState() => _Mcon1kState();
}

class _Mcon1kState extends MconBaseState<Mcon1k> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon1kPainter(
      animation: animation,
...
class _Mcon1kPainter extends MconPainter {
  _Mcon1kPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(540.0), y(-450.0));
    path.lineTo(x(610.0), y(-360.0));
    path.lineTo(x(683.0), y(-360.0));
    path.lineTo(x(590.0), y(-480.0));
    path.lineTo(x(683.0), y(-600.0));
    path.lineTo(x(610.0), y(-600.0));
    path.lineTo(x(540.0), y(-510.0));
