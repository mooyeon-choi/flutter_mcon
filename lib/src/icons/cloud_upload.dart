...
/// Animated cloud_upload icon from Google Material Icons
class MconCloudUpload extends MconBase {
  const MconCloudUpload({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCloudUpload> createState() => _MconCloudUploadState();
}

class _MconCloudUploadState extends MconBaseState<MconCloudUpload> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCloudUploadPainter(
      animation: animation,
...
class _MconCloudUploadPainter extends MconPainter {
  _MconCloudUploadPainter({
