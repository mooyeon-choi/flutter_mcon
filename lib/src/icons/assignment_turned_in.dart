...
/// Animated assignment_turned_in icon from Google Material Icons
class MconAssignmentTurnedIn extends MconBase {
  const MconAssignmentTurnedIn({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconAssignmentTurnedInPainter extends MconPainter {
  _MconAssignmentTurnedInPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.moveTo(x(424.0), y(-318.0));
    path.lineTo(x(706.0), y(-600.0));
    path.lineTo(x(650.0), y(-656.0));
    path.lineTo(x(424.0), y(-430.0));
    path.lineTo(x(310.0), y(-544.0));
    path.lineTo(x(254.0), y(-488.0));
    path.lineTo(x(424.0), y(-318.0));
    path.close();
