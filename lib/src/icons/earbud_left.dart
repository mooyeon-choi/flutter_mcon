...
/// Animated earbud_left icon from Google Material Icons
class MconEarbudLeft extends MconBase {
  const MconEarbudLeft({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconEarbudLeft> createState() => _MconEarbudLeftState();
}

class _MconEarbudLeftState extends MconBaseState<MconEarbudLeft> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconEarbudLeftPainter(
      animation: animation,
...
class _MconEarbudLeftPainter extends MconPainter {
  _MconEarbudLeftPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(700.0), y(-880.0), x(770.0), y(-810.0));
    path.quadraticBezierTo(x(840.0), y(-740.0), x(840.0), y(-640.0));
    path.quadraticBezierTo(x(840.0), y(-540.0), x(770.0), y(-470.0));
    path.quadraticBezierTo(x(700.0), y(-400.0), x(600.0), y(-400.0));
    path.lineTo(x(560.0), y(-400.0));
    path.close();
    path.moveTo(x(640.0), y(-485.0));
    path.quadraticBezierTo(x(694.0), y(-499.0), x(727.0), y(-542.0));
    path.quadraticBezierTo(x(760.0), y(-585.0), x(760.0), y(-640.0));
    path.quadraticBezierTo(x(760.0), y(-695.0), x(727.0), y(-738.0));
    path.quadraticBezierTo(x(694.0), y(-781.0), x(640.0), y(-795.0));
    path.lineTo(x(640.0), y(-485.0));
    path.close();
