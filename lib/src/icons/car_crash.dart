...
/// Animated car_crash icon from Google Material Icons
class MconCarCrash extends MconBase {
  const MconCarCrash({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCarCrash> createState() => _MconCarCrashState();
}

class _MconCarCrashState extends MconBaseState<MconCarCrash> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCarCrashPainter(
      animation: animation,
...
class _MconCarCrashPainter extends MconPainter {
  _MconCarCrashPainter({
