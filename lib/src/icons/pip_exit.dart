...
/// Animated pip_exit icon from Google Material Icons
class MconPipExit extends MconBase {
  const MconPipExit({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconPipExit> createState() => _MconPipExitState();
}

class _MconPipExitState extends MconBaseState<MconPipExit> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPipExitPainter(
      animation: animation,
...
class _MconPipExitPainter extends MconPainter {
  _MconPipExitPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.close();
    path.moveTo(x(683.0), y(-300.0));
    path.lineTo(x(740.0), y(-357.0));
