...
/// Animated output icon from Google Material Icons
class MconOutput extends MconBase {
  const MconOutput({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconOutput> createState() => _MconOutputState();
}

class _MconOutputState extends MconBaseState<MconOutput> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconOutputPainter(
      animation: animation,
...
class _MconOutputPainter extends MconPainter {
  _MconOutputPainter({
