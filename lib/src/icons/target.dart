...
/// Animated target icon from Google Material Icons
class MconTarget extends MconBase {
  const MconTarget({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconTarget> createState() => _MconTargetState();
}

class _MconTargetState extends MconBaseState<MconTarget> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTargetPainter(
      animation: animation,
...
class _MconTargetPainter extends MconPainter {
  _MconTargetPainter({
