...
/// Animated compare icon from Google Material Icons
class MconCompare extends MconBase {
  const MconCompare({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCompare> createState() => _MconCompareState();
}

class _MconCompareState extends MconBaseState<MconCompare> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconComparePainter(
      animation: animation,
...
class _MconComparePainter extends MconPainter {
  _MconComparePainter({
