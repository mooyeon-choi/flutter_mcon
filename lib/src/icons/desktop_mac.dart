...
/// Animated desktop_mac icon from Google Material Icons
class MconDesktopMac extends MconBase {
  const MconDesktopMac({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDesktopMac> createState() => _MconDesktopMacState();
}

class _MconDesktopMacState extends MconBaseState<MconDesktopMac> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDesktopMacPainter(
      animation: animation,
...
class _MconDesktopMacPainter extends MconPainter {
  _MconDesktopMacPainter({
