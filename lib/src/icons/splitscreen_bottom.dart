...
/// Animated splitscreen_bottom icon from Google Material Icons
class MconSplitscreenBottom extends MconBase {
  const MconSplitscreenBottom({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSplitscreenBottom> createState() =>
      _MconSplitscreenBottomState();
}

class _MconSplitscreenBottomState extends MconBaseState<MconSplitscreenBottom> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSplitscreenBottomPainter(
      animation: animation,
...
class _MconSplitscreenBottomPainter extends MconPainter {
  _MconSplitscreenBottomPainter({
