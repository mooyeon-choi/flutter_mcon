...
/// Animated tab_new_right icon from Google Material Icons
class MconTabNewRight extends MconBase {
  const MconTabNewRight({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconTabNewRight> createState() => _MconTabNewRightState();
}

class _MconTabNewRightState extends MconBaseState<MconTabNewRight> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTabNewRightPainter(
      animation: animation,
...
class _MconTabNewRightPainter extends MconPainter {
  _MconTabNewRightPainter({
