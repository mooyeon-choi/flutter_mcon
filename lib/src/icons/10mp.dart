...
/// Animated 10mp icon from Google Material Icons
class Mcon10mp extends MconBase {
  const Mcon10mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon10mp> createState() => _Mcon10mpState();
}

class _Mcon10mpState extends MconBaseState<Mcon10mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon10mpPainter(
      animation: animation,
...
class _Mcon10mpPainter extends MconPainter {
  _Mcon10mpPainter({
