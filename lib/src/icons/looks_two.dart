...
/// Animated looks_two icon from Google Material Icons
class MconLooksTwo extends MconBase {
  const MconLooksTwo({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconLooksTwo> createState() => _MconLooksTwoState();
}

class _MconLooksTwoState extends MconBaseState<MconLooksTwo> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLooksTwoPainter(
      animation: animation,
...
class _MconLooksTwoPainter extends MconPainter {
  _MconLooksTwoPainter({
