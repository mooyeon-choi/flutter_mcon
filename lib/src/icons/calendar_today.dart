...
/// Animated calendar_today icon from Google Material Icons
class MconCalendarToday extends MconBase {
  const MconCalendarToday({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCalendarToday> createState() => _MconCalendarTodayState();
}

class _MconCalendarTodayState extends MconBaseState<MconCalendarToday> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCalendarTodayPainter(
      animation: animation,
...
class _MconCalendarTodayPainter extends MconPainter {
  _MconCalendarTodayPainter({
