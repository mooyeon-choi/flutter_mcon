...
/// Animated event_note icon from Google Material Icons
class MconEventNote extends MconBase {
  const MconEventNote({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconEventNote> createState() => _MconEventNoteState();
}

class _MconEventNoteState extends MconBaseState<MconEventNote> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconEventNotePainter(
      animation: animation,
...
class _MconEventNotePainter extends MconPainter {
  _MconEventNotePainter({
