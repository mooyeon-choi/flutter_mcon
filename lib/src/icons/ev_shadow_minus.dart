...
/// Animated ev_shadow_minus icon from Google Material Icons
class MconEvShadowMinus extends MconBase {
  const MconEvShadowMinus({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconEvShadowMinus> createState() => _MconEvShadowMinusState();
}

class _MconEvShadowMinusState extends MconBaseState<MconEvShadowMinus> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconEvShadowMinusPainter(
      animation: animation,
...
class _MconEvShadowMinusPainter extends MconPainter {
  _MconEvShadowMinusPainter({
