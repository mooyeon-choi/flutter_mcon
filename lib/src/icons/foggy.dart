...
/// Animated foggy icon from Google Material Icons
class MconFoggy extends MconBase {
  const MconFoggy({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconFoggy> createState() => _MconFoggyState();
}

class _MconFoggyState extends MconBaseState<MconFoggy> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFoggyPainter(
      animation: animation,
...
class _MconFoggyPainter extends MconPainter {
  _MconFoggyPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(263.0), y(-80.0), x(251.5), y(-91.5));
    path.quadraticBezierTo(x(240.0), y(-103.0), x(240.0), y(-120.0));
    path.quadraticBezierTo(x(240.0), y(-137.0), x(251.5), y(-148.5));
    path.quadraticBezierTo(x(263.0), y(-160.0), x(280.0), y(-160.0));
    path.quadraticBezierTo(x(297.0), y(-160.0), x(308.5), y(-148.5));
    path.quadraticBezierTo(x(320.0), y(-137.0), x(320.0), y(-120.0));
    path.quadraticBezierTo(x(320.0), y(-103.0), x(308.5), y(-91.5));
    path.quadraticBezierTo(x(297.0), y(-80.0), x(280.0), y(-80.0));
    path.close();
    ...
    path.quadraticBezierTo(x(617.0), y(-280.0), x(628.5), y(-268.5));
    path.quadraticBezierTo(x(640.0), y(-257.0), x(640.0), y(-240.0));
    path.quadraticBezierTo(x(640.0), y(-223.0), x(628.5), y(-211.5));
    path.quadraticBezierTo(x(617.0), y(-200.0), x(600.0), y(-200.0));
    ...
    path.quadraticBezierTo(x(360.0), y(-137.0), x(371.5), y(-148.5));
    path.quadraticBezierTo(x(383.0), y(-160.0), x(400.0), y(-160.0));
    path.lineTo(x(680.0), y(-160.0));
    path.quadraticBezierTo(x(697.0), y(-160.0), x(708.5), y(-148.5));
    path.quadraticBezierTo(x(720.0), y(-137.0), x(720.0), y(-120.0));
    path.quadraticBezierTo(x(720.0), y(-103.0), x(708.5), y(-91.5));
    path.quadraticBezierTo(x(697.0), y(-80.0), x(680.0), y(-80.0));
