...
/// Animated post_add icon from Google Material Icons
class MconPostAdd extends MconBase {
  const MconPostAdd({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconPostAdd> createState() => _MconPostAddState();
}

class _MconPostAddState extends MconBaseState<MconPostAdd> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPostAddPainter(
      animation: animation,
...
class _MconPostAddPainter extends MconPainter {
  _MconPostAddPainter({
