...
/// Animated fullscreen_portrait icon from Google Material Icons
class MconFullscreenPortrait extends MconBase {
  const MconFullscreenPortrait({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconFullscreenPortrait> createState() =>
      _MconFullscreenPortraitState();
}

class _MconFullscreenPortraitState
    extends MconBaseState<MconFullscreenPortrait> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFullscreenPortraitPainter(
      animation: animation,
...
class _MconFullscreenPortraitPainter extends MconPainter {
  _MconFullscreenPortraitPainter({
