...
/// Animated battery_android_1 icon from Google Material Icons
class MconBatteryAndroid1 extends MconBase {
  const MconBatteryAndroid1({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryAndroid1> createState() => _MconBatteryAndroid1State();
}

class _MconBatteryAndroid1State extends MconBaseState<MconBatteryAndroid1> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryAndroid1Painter(
      animation: animation,
...
class _MconBatteryAndroid1Painter extends MconPainter {
  _MconBatteryAndroid1Painter({
