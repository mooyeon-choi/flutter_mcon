...
/// Animated tooltip_2 icon from Google Material Icons
class MconTooltip2 extends MconBase {
  const MconTooltip2({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconTooltip2> createState() => _MconTooltip2State();
}

class _MconTooltip2State extends MconBaseState<MconTooltip2> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTooltip2Painter(
      animation: animation,
...
class _MconTooltip2Painter extends MconPainter {
  _MconTooltip2Painter({
