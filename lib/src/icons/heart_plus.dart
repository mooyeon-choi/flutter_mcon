...
/// Animated heart_plus icon from Google Material Icons
class MconHeartPlus extends MconBase {
  const MconHeartPlus({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconHeartPlus> createState() => _MconHeartPlusState();
}

class _MconHeartPlusState extends MconBaseState<MconHeartPlus> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHeartPlusPainter(
      animation: animation,
...
class _MconHeartPlusPainter extends MconPainter {
  _MconHeartPlusPainter({
