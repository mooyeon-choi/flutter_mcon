...
/// Animated settings_night_sight icon from Google Material Icons
class MconSettingsNightSight extends MconBase {
  const MconSettingsNightSight({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSettingsNightSight> createState() =>
      _MconSettingsNightSightState();
}

class _MconSettingsNightSightState
    extends MconBaseState<MconSettingsNightSight> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSettingsNightSightPainter(
      animation: animation,
...
class _MconSettingsNightSightPainter extends MconPainter {
  _MconSettingsNightSightPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.close();
    path.moveTo(x(768.0), y(-194.0));
    path.quadraticBezierTo(x(773.0), y(-199.0), x(770.5), y(-206.0));
    path.quadraticBezierTo(x(768.0), y(-213.0), x(761.0), y(-214.0));
    path.quadraticBezierTo(x(735.0), y(-219.0), x(712.5), y(-233.5));
    path.quadraticBezierTo(x(690.0), y(-248.0), x(676.0), y(-272.0));
    path.quadraticBezierTo(x(662.0), y(-296.0), x(660.5), y(-323.0));
    path.quadraticBezierTo(x(659.0), y(-350.0), x(668.0), y(-375.0));
    path.quadraticBezierTo(x(670.0), y(-382.0), x(665.5), y(-387.5));
    path.quadraticBezierTo(x(661.0), y(-393.0), x(654.0), y(-391.0));
    path.quadraticBezierTo(x(587.0), y(-379.0), x(562.5), y(-315.0));
    path.quadraticBezierTo(x(538.0), y(-251.0), x(582.0), y(-196.0));
    path.quadraticBezierTo(x(617.0), y(-152.0), x(674.0), y(-151.0));
    path.quadraticBezierTo(x(731.0), y(-150.0), x(768.0), y(-194.0));
    path.close();
