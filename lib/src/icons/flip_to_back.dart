...
/// Animated flip_to_back icon from Google Material Icons
class MconFlipToBack extends MconBase {
  const MconFlipToBack({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconFlipToBack> createState() => _MconFlipToBackState();
}

class _MconFlipToBackState extends MconBaseState<MconFlipToBack> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFlipToBackPainter(
      animation: animation,
...
class _MconFlipToBackPainter extends MconPainter {
  _MconFlipToBackPainter({
