...
/// Animated tune icon from Google Material Icons
class MconTune extends MconBase {
  const MconTune({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconTune> createState() => _MconTuneState();
}

class _MconTuneState extends MconBaseState<MconTune> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTunePainter(
      animation: animation,
...
class _MconTunePainter extends MconPainter {
  _MconTunePainter({
