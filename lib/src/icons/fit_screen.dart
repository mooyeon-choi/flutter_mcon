...
/// Animated fit_screen icon from Google Material Icons
class MconFitScreen extends MconBase {
  const MconFitScreen({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconFitScreen> createState() => _MconFitScreenState();
}

class _MconFitScreenState extends MconBaseState<MconFitScreen> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFitScreenPainter(
      animation: animation,
...
class _MconFitScreenPainter extends MconPainter {
  _MconFitScreenPainter({
