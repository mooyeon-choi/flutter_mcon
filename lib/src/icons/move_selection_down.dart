...
/// Animated move_selection_down icon from Google Material Icons
class MconMoveSelectionDown extends MconBase {
  const MconMoveSelectionDown({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMoveSelectionDown> createState() =>
      _MconMoveSelectionDownState();
}

class _MconMoveSelectionDownState extends MconBaseState<MconMoveSelectionDown> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMoveSelectionDownPainter(
      animation: animation,
...
class _MconMoveSelectionDownPainter extends MconPainter {
  _MconMoveSelectionDownPainter({
