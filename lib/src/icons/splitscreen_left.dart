...
/// Animated splitscreen_left icon from Google Material Icons
class MconSplitscreenLeft extends MconBase {
  const MconSplitscreenLeft({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSplitscreenLeft> createState() =>
      _MconSplitscreenLeftState();
}

class _MconSplitscreenLeftState extends MconBaseState<MconSplitscreenLeft> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSplitscreenLeftPainter(
      animation: animation,
...
class _MconSplitscreenLeftPainter extends MconPainter {
  _MconSplitscreenLeftPainter({
