...
/// Animated markdown_paste icon from Google Material Icons
class MconMarkdownPaste extends MconBase {
  const MconMarkdownPaste({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMarkdownPaste> createState() => _MconMarkdownPasteState();
}

class _MconMarkdownPasteState extends MconBaseState<MconMarkdownPaste> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMarkdownPastePainter(
      animation: animation,
...
class _MconMarkdownPastePainter extends MconPainter {
  _MconMarkdownPastePainter({
