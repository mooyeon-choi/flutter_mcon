...
/// Animated splitscreen_top icon from Google Material Icons
class MconSplitscreenTop extends MconBase {
  const MconSplitscreenTop({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSplitscreenTop> createState() => _MconSplitscreenTopState();
}

class _MconSplitscreenTopState extends MconBaseState<MconSplitscreenTop> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSplitscreenTopPainter(
      animation: animation,
...
class _MconSplitscreenTopPainter extends MconPainter {
  _MconSplitscreenTopPainter({
