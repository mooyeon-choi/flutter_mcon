...
/// Animated battery_horiz_050 icon from Google Material Icons
class MconBatteryHoriz050 extends MconBase {
  const MconBatteryHoriz050({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconBatteryHoriz050State extends MconBaseState<MconBatteryHoriz050> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryHoriz050Painter(
      animation: animation,
...
class _MconBatteryHoriz050Painter extends MconPainter {
  _MconBatteryHoriz050Painter({
