...
/// Animated format_h3 icon from Google Material Icons
class MconFormatH3 extends MconBase {
  const MconFormatH3({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconFormatH3> createState() => _MconFormatH3State();
}

class _MconFormatH3State extends MconBaseState<MconFormatH3> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFormatH3Painter(
      animation: animation,
...
class _MconFormatH3Painter extends MconPainter {
  _MconFormatH3Painter({
