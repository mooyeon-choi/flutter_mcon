...
/// Animated apartment icon from Google Material Icons
class MconApartment extends MconBase {
  const MconApartment({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconApartment> createState() => _MconApartmentState();
}

class _MconApartmentState extends MconBaseState<MconApartment> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconApartmentPainter(
      animation: animation,
...
class _MconApartmentPainter extends MconPainter {
  _MconApartmentPainter({
