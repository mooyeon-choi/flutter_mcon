...
/// Animated moped_package icon from Google Material Icons
class MconMopedPackage extends MconBase {
  const MconMopedPackage({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMopedPackage> createState() => _MconMopedPackageState();
}

class _MconMopedPackageState extends MconBaseState<MconMopedPackage> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMopedPackagePainter(
      animation: animation,
...
class _MconMopedPackagePainter extends MconPainter {
  _MconMopedPackagePainter({
