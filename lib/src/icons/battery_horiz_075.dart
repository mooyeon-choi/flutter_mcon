...
/// Animated battery_horiz_075 icon from Google Material Icons
class MconBatteryHoriz075 extends MconBase {
  const MconBatteryHoriz075({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryHoriz075> createState() => _MconBatteryHoriz075State();
}

class _MconBatteryHoriz075State extends MconBaseState<MconBatteryHoriz075> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryHoriz075Painter(
      animation: animation,
...
class _MconBatteryHoriz075Painter extends MconPainter {
  _MconBatteryHoriz075Painter({
