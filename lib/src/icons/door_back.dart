...
/// Animated door_back icon from Google Material Icons
class MconDoorBack extends MconBase {
  const MconDoorBack({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconDoorBack> createState() => _MconDoorBackState();
}

class _MconDoorBackState extends MconBaseState<MconDoorBack> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDoorBackPainter(
      animation: animation,
...
class _MconDoorBackPainter extends MconPainter {
  _MconDoorBackPainter({
