...
/// Animated stacked_bar_chart icon from Google Material Icons
class MconStackedBarChart extends MconBase {
  const MconStackedBarChart({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconStackedBarChart> createState() =>
      _MconStackedBarChartState();
}

class _MconStackedBarChartState extends MconBaseState<MconStackedBarChart> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconStackedBarChartPainter(
      animation: animation,
...
class _MconStackedBarChartPainter extends MconPainter {
  _MconStackedBarChartPainter({
