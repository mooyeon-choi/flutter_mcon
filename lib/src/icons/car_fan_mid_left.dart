...
/// Animated car_fan_mid_left icon from Google Material Icons
class MconCarFanMidLeft extends MconBase {
  const MconCarFanMidLeft({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCarFanMidLeft> createState() => _MconCarFanMidLeftState();
}

class _MconCarFanMidLeftState extends MconBaseState<MconCarFanMidLeft> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCarFanMidLeftPainter(
      animation: animation,
...
class _MconCarFanMidLeftPainter extends MconPainter {
  _MconCarFanMidLeftPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(736.0), y(-784.0));
    path.lineTo(x(673.0), y(-720.0));
    path.lineTo(x(840.0), y(-720.0));
    path.lineTo(x(840.0), y(-640.0));
    path.lineTo(x(673.0), y(-640.0));
    path.lineTo(x(737.0), y(-576.0));
