...
/// Animated 6mp icon from Google Material Icons
class Mcon6mp extends MconBase {
  const Mcon6mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon6mp> createState() => _Mcon6mpState();
}

class _Mcon6mpState extends MconBaseState<Mcon6mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon6mpPainter(
      animation: animation,
...
class _Mcon6mpPainter extends MconPainter {
  _Mcon6mpPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(580.0), y(-617.0), x(568.5), y(-628.5));
