...
/// Animated saved_search icon from Google Material Icons
class MconSavedSearch extends MconBase {
  const MconSavedSearch({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSavedSearch> createState() => _MconSavedSearchState();
}

class _MconSavedSearchState extends MconBaseState<MconSavedSearch> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSavedSearchPainter(
      animation: animation,
...
class _MconSavedSearchPainter extends MconPainter {
  _MconSavedSearchPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(330.0), y(-558.0));
    path.lineTo(x(250.0), y(-622.0));
    path.lineTo(x(348.0), y(-622.0));
    path.lineTo(x(380.0), y(-720.0));
    path.lineTo(x(412.0), y(-622.0));
    path.lineTo(x(510.0), y(-622.0));
    path.lineTo(x(430.0), y(-558.0));
    path.lineTo(x(460.0), y(-460.0));
    path.lineTo(x(380.0), y(-522.0));
