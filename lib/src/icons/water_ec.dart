...
/// Animated water_ec icon from Google Material Icons
class MconWaterEc extends MconBase {
  const MconWaterEc({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconWaterEc> createState() => _MconWaterEcState();
}

class _MconWaterEcState extends MconBaseState<MconWaterEc> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWaterEcPainter(
      animation: animation,
...
class _MconWaterEcPainter extends MconPainter {
  _MconWaterEcPainter({
