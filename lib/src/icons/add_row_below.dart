...
/// Animated add_row_below icon from Google Material Icons
class MconAddRowBelow extends MconBase {
  const MconAddRowBelow({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconAddRowBelow> createState() => _MconAddRowBelowState();
}

class _MconAddRowBelowState extends MconBaseState<MconAddRowBelow> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAddRowBelowPainter(
      animation: animation,
...
class _MconAddRowBelowPainter extends MconPainter {
  _MconAddRowBelowPainter({
