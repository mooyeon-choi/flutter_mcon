...
/// Animated crop_7_5 icon from Google Material Icons
class MconCrop75 extends MconBase {
  const MconCrop75({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCrop75> createState() => _MconCrop75State();
}

class _MconCrop75State extends MconBaseState<MconCrop75> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCrop75Painter(
      animation: animation,
...
class _MconCrop75Painter extends MconPainter {
  _MconCrop75Painter({
