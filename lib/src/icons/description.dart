...
/// Animated description icon from Google Material Icons
class MconDescription extends MconBase {
  const MconDescription({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDescription> createState() => _MconDescriptionState();
}

class _MconDescriptionState extends MconBaseState<MconDescription> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDescriptionPainter(
      animation: animation,
...
class _MconDescriptionPainter extends MconPainter {
  _MconDescriptionPainter({
