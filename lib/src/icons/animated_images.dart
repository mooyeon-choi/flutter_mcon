...
/// Animated animated_images icon from Google Material Icons
class MconAnimatedImages extends MconBase {
  const MconAnimatedImages({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconAnimatedImages> createState() => _MconAnimatedImagesState();
}

class _MconAnimatedImagesState extends MconBaseState<MconAnimatedImages> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAnimatedImagesPainter(
      animation: animation,
...
class _MconAnimatedImagesPainter extends MconPainter {
  _MconAnimatedImagesPainter({
