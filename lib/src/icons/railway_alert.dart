...
/// Animated railway_alert icon from Google Material Icons
class MconRailwayAlert extends MconBase {
  const MconRailwayAlert({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconRailwayAlert> createState() => _MconRailwayAlertState();
}

class _MconRailwayAlertState extends MconBaseState<MconRailwayAlert> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconRailwayAlertPainter(
      animation: animation,
...
class _MconRailwayAlertPainter extends MconPainter {
  _MconRailwayAlertPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(162.0), y(-160.0), x(121.0), y(-201.0));
    path.quadraticBezierTo(x(80.0), y(-242.0), x(80.0), y(-300.0));
    ...
    path.lineTo(x(160.0), y(-440.0));
    path.lineTo(x(160.0), y(-300.0));
    path.quadraticBezierTo(x(160.0), y(-275.0), x(177.5), y(-257.5));
    path.quadraticBezierTo(x(195.0), y(-240.0), x(220.0), y(-240.0));
    ...
    path.quadraticBezierTo(x(720.0), y(-242.0), x(679.0), y(-201.0));
    path.quadraticBezierTo(x(638.0), y(-160.0), x(580.0), y(-160.0));
