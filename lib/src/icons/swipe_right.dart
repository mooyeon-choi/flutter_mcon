...
/// Animated swipe_right icon from Google Material Icons
class MconSwipeRight extends MconBase {
  const MconSwipeRight({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSwipeRight> createState() => _MconSwipeRightState();
}

class _MconSwipeRightState extends MconBaseState<MconSwipeRight> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSwipeRightPainter(
      animation: animation,
...
class _MconSwipeRightPainter extends MconPainter {
  _MconSwipeRightPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(110.0), y(-786.0), x(222.0), y(-853.0));
    path.quadraticBezierTo(x(334.0), y(-920.0), x(480.0), y(-920.0));
    path.quadraticBezierTo(x(574.0), y(-920.0), x(661.0), y(-889.0));
    path.quadraticBezierTo(x(748.0), y(-858.0), x(820.0), y(-799.0));
    path.lineTo(x(820.0), y(-880.0));
    path.lineTo(x(880.0), y(-880.0));
    path.lineTo(x(880.0), y(-680.0));
    path.lineTo(x(680.0), y(-680.0));
    path.lineTo(x(680.0), y(-740.0));
    path.lineTo(x(796.0), y(-740.0));
    path.quadraticBezierTo(x(730.0), y(-798.0), x(649.0), y(-829.0));
    path.quadraticBezierTo(x(568.0), y(-860.0), x(480.0), y(-860.0));
    path.quadraticBezierTo(x(362.0), y(-860.0), x(271.5), y(-812.0));
    path.quadraticBezierTo(x(181.0), y(-764.0), x(143.0), y(-680.0));
