...
/// Animated voice_chat icon from Google Material Icons
class MconVoiceChat extends MconBase {
  const MconVoiceChat({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconVoiceChat> createState() => _MconVoiceChatState();
}

class _MconVoiceChatState extends MconBaseState<MconVoiceChat> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconVoiceChatPainter(
      animation: animation,
...
class _MconVoiceChatPainter extends MconPainter {
  _MconVoiceChatPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(510.0), y(-760.0));
    path.lineTo(x(450.0), y(-760.0));
