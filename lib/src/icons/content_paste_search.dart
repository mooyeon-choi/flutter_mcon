...
/// Animated content_paste_search icon from Google Material Icons
class MconContentPasteSearch extends MconBase {
  const MconContentPasteSearch({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconContentPasteSearchPainter extends MconPainter {
  _MconContentPasteSearchPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(716.0), y(-188.0));
    path.quadraticBezierTo(x(694.0), y(-175.0), x(670.0), y(-167.5));
    path.quadraticBezierTo(x(646.0), y(-160.0), x(620.0), y(-160.0));
    path.quadraticBezierTo(x(545.0), y(-160.0), x(492.5), y(-212.5));
    path.quadraticBezierTo(x(440.0), y(-265.0), x(440.0), y(-340.0));
    path.quadraticBezierTo(x(440.0), y(-415.0), x(492.5), y(-467.5));
    path.quadraticBezierTo(x(545.0), y(-520.0), x(620.0), y(-520.0));
    path.quadraticBezierTo(x(695.0), y(-520.0), x(747.5), y(-467.5));
    path.quadraticBezierTo(x(800.0), y(-415.0), x(800.0), y(-340.0));
    path.quadraticBezierTo(x(800.0), y(-314.0), x(792.5), y(-290.0));
    path.quadraticBezierTo(x(785.0), y(-266.0), x(772.0), y(-244.0));
    path.lineTo(x(880.0), y(-136.0));
    path.lineTo(x(824.0), y(-80.0));
    path.close();
    path.moveTo(x(620.0), y(-240.0));
    path.quadraticBezierTo(x(662.0), y(-240.0), x(691.0), y(-269.0));
    path.quadraticBezierTo(x(720.0), y(-298.0), x(720.0), y(-340.0));
    path.quadraticBezierTo(x(720.0), y(-382.0), x(691.0), y(-411.0));
    path.quadraticBezierTo(x(662.0), y(-440.0), x(620.0), y(-440.0));
    path.quadraticBezierTo(x(578.0), y(-440.0), x(549.0), y(-411.0));
    path.quadraticBezierTo(x(520.0), y(-382.0), x(520.0), y(-340.0));
    path.quadraticBezierTo(x(520.0), y(-298.0), x(549.0), y(-269.0));
    path.quadraticBezierTo(x(578.0), y(-240.0), x(620.0), y(-240.0));
    path.close();
