...
/// Animated select_window_off icon from Google Material Icons
class MconSelectWindowOff extends MconBase {
  const MconSelectWindowOff({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSelectWindowOff> createState() =>
      _MconSelectWindowOffState();
}

class _MconSelectWindowOffState extends MconBaseState<MconSelectWindowOff> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSelectWindowOffPainter(
      animation: animation,
...
class _MconSelectWindowOffPainter extends MconPainter {
  _MconSelectWindowOffPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(246.0), y(-829.0));
    path.quadraticBezierTo(x(254.0), y(-852.0), x(274.5), y(-866.0));
    path.quadraticBezierTo(x(295.0), y(-880.0), x(320.0), y(-880.0));
