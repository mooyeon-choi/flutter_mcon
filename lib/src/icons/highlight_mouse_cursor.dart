...
/// Animated highlight_mouse_cursor icon from Google Material Icons
class MconHighlightMouseCursor extends MconBase {
  const MconHighlightMouseCursor({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconHighlightMouseCursor> createState() =>
      _MconHighlightMouseCursorState();
}

class _MconHighlightMouseCursorState
    extends MconBaseState<MconHighlightMouseCursor> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHighlightMouseCursorPainter(
      animation: animation,
...
class _MconHighlightMouseCursorPainter extends MconPainter {
  _MconHighlightMouseCursorPainter({
