...
/// Animated encrypted_add_circle icon from Google Material Icons
class MconEncryptedAddCircle extends MconBase {
  const MconEncryptedAddCircle({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconEncryptedAddCircle> createState() =>
      _MconEncryptedAddCircleState();
}

class _MconEncryptedAddCircleState
    extends MconBaseState<MconEncryptedAddCircle> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconEncryptedAddCirclePainter(
      animation: animation,
...
class _MconEncryptedAddCirclePainter extends MconPainter {
  _MconEncryptedAddCirclePainter({
