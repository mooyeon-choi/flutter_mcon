...
/// Animated filter_3 icon from Google Material Icons
class MconFilter3 extends MconBase {
  const MconFilter3({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconFilter3> createState() => _MconFilter3State();
}

class _MconFilter3State extends MconBaseState<MconFilter3> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFilter3Painter(
      animation: animation,
...
class _MconFilter3Painter extends MconPainter {
  _MconFilter3Painter({
