...
/// Animated loyalty icon from Google Material Icons
class MconLoyalty extends MconBase {
  const MconLoyalty({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconLoyalty> createState() => _MconLoyaltyState();
}

class _MconLoyaltyState extends MconBaseState<MconLoyalty> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLoyaltyPainter(
      animation: animation,
...
class _MconLoyaltyPainter extends MconPainter {
  _MconLoyaltyPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(671.0), y(-411.0), x(677.5), y(-426.0));
    path.quadraticBezierTo(x(684.0), y(-441.0), x(684.0), y(-458.0));
    path.quadraticBezierTo(x(684.0), y(-492.0), x(660.0), y(-516.0));
    path.quadraticBezierTo(x(636.0), y(-540.0), x(602.0), y(-540.0));
    path.quadraticBezierTo(x(583.0), y(-540.0), x(564.5), y(-529.0));
    path.quadraticBezierTo(x(546.0), y(-518.0), x(520.0), y(-492.0));
    path.quadraticBezierTo(x(490.0), y(-520.0), x(473.0), y(-530.0));
    path.quadraticBezierTo(x(456.0), y(-540.0), x(438.0), y(-540.0));
    path.quadraticBezierTo(x(404.0), y(-540.0), x(380.0), y(-516.0));
    path.quadraticBezierTo(x(356.0), y(-492.0), x(356.0), y(-458.0));
    path.quadraticBezierTo(x(356.0), y(-441.0), x(362.5), y(-426.0));
    path.quadraticBezierTo(x(369.0), y(-411.0), x(380.0), y(-400.0));
