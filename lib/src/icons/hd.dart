...
/// Animated hd icon from Google Material Icons
class MconHd extends MconBase {
  const MconHd({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconHd> createState() => _MconHdState();
}

class _MconHdState extends MconBaseState<MconHd> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHdPainter(
      animation: animation,
...
class _MconHdPainter extends MconPainter {
  _MconHdPainter({
