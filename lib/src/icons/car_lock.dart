...
/// Animated car_lock icon from Google Material Icons
class MconCarLock extends MconBase {
  const MconCarLock({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCarLock> createState() => _MconCarLockState();
}

class _MconCarLockState extends MconBaseState<MconCarLock> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCarLockPainter(
      animation: animation,
...
class _MconCarLockPainter extends MconPainter {
  _MconCarLockPainter({
