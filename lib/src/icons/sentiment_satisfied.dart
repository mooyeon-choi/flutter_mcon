...
/// Animated sentiment_satisfied icon from Google Material Icons
class MconSentimentSatisfied extends MconBase {
  const MconSentimentSatisfied({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSentimentSatisfied> createState() =>
      _MconSentimentSatisfiedState();
}

class _MconSentimentSatisfiedState
    extends MconBaseState<MconSentimentSatisfied> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSentimentSatisfiedPainter(
      animation: animation,
...
class _MconSentimentSatisfiedPainter extends MconPainter {
  _MconSentimentSatisfiedPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(618.0), y(-400.0));
    path.quadraticBezierTo(x(596.0), y(-363.0), x(559.5), y(-341.5));
    path.quadraticBezierTo(x(523.0), y(-320.0), x(480.0), y(-320.0));
    path.quadraticBezierTo(x(437.0), y(-320.0), x(400.5), y(-341.5));
    path.quadraticBezierTo(x(364.0), y(-363.0), x(342.0), y(-400.0));
