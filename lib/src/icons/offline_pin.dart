...
/// Animated offline_pin icon from Google Material Icons
class MconOfflinePin extends MconBase {
  const MconOfflinePin({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconOfflinePin> createState() => _MconOfflinePinState();
}

class _MconOfflinePinState extends MconBaseState<MconOfflinePin> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconOfflinePinPainter(
      animation: animation,
...
class _MconOfflinePinPainter extends MconPainter {
  _MconOfflinePinPainter({
