...
/// Animated sim_card_download icon from Google Material Icons
class MconSimCardDownload extends MconBase {
  const MconSimCardDownload({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSimCardDownload> createState() =>
      _MconSimCardDownloadState();
}

class _MconSimCardDownloadState extends MconBaseState<MconSimCardDownload> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSimCardDownloadPainter(
      animation: animation,
...
class _MconSimCardDownloadPainter extends MconPainter {
  _MconSimCardDownloadPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(520.0), y(-434.0));
    path.lineTo(x(520.0), y(-600.0));
    path.lineTo(x(440.0), y(-600.0));
    path.lineTo(x(440.0), y(-434.0));
