...
/// Animated 9k_plus icon from Google Material Icons
class Mcon9kPlus extends MconBase {
  const Mcon9kPlus({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon9kPlus> createState() => _Mcon9kPlusState();
}

class _Mcon9kPlusState extends MconBaseState<Mcon9kPlus> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon9kPlusPainter(
      animation: animation,
...
class _Mcon9kPlusPainter extends MconPainter {
  _Mcon9kPlusPainter({
