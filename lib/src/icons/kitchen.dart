...
/// Animated kitchen icon from Google Material Icons
class MconKitchen extends MconBase {
  const MconKitchen({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconKitchen> createState() => _MconKitchenState();
}

class _MconKitchenState extends MconBaseState<MconKitchen> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconKitchenPainter(
      animation: animation,
...
class _MconKitchenPainter extends MconPainter {
  _MconKitchenPainter({
