...
/// Animated screenshot_monitor icon from Google Material Icons
class MconScreenshotMonitor extends MconBase {
  const MconScreenshotMonitor({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconScreenshotMonitor> createState() =>
      _MconScreenshotMonitorState();
}

class _MconScreenshotMonitorState extends MconBaseState<MconScreenshotMonitor> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconScreenshotMonitorPainter(
      animation: animation,
...
class _MconScreenshotMonitorPainter extends MconPainter {
  _MconScreenshotMonitorPainter({
