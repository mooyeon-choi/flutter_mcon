...
/// Animated add_chart icon from Google Material Icons
class MconAddChart extends MconBase {
  const MconAddChart({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconAddChart> createState() => _MconAddChartState();
}

class _MconAddChartState extends MconBaseState<MconAddChart> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAddChartPainter(
      animation: animation,
...
class _MconAddChartPainter extends MconPainter {
  _MconAddChartPainter({
