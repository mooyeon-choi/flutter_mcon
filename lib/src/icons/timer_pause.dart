...
/// Animated timer_pause icon from Google Material Icons
class MconTimerPause extends MconBase {
  const MconTimerPause({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconTimerPause> createState() => _MconTimerPauseState();
}

class _MconTimerPauseState extends MconBaseState<MconTimerPause> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTimerPausePainter(
      animation: animation,
...
class _MconTimerPausePainter extends MconPainter {
  _MconTimerPausePainter({
