...
/// Animated book_6 icon from Google Material Icons
class MconBook6 extends MconBase {
  const MconBook6({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconBook6> createState() => _MconBook6State();
}

class _MconBook6State extends MconBaseState<MconBook6> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBook6Painter(
      animation: animation,
...
class _MconBook6Painter extends MconPainter {
  _MconBook6Painter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.close();
    path.moveTo(x(270.0), y(-420.0));
    path.lineTo(x(318.0), y(-420.0));
    path.lineTo(x(344.0), y(-492.0));
    path.lineTo(x(457.0), y(-492.0));
    path.lineTo(x(482.0), y(-420.0));
    path.lineTo(x(530.0), y(-420.0));
    path.lineTo(x(425.0), y(-700.0));
    path.lineTo(x(375.0), y(-700.0));
    path.lineTo(x(270.0), y(-420.0));
    path.close();
    path.moveTo(x(358.0), y(-532.0));
    path.lineTo(x(399.0), y(-648.0));
    path.lineTo(x(401.0), y(-648.0));
    path.lineTo(x(442.0), y(-532.0));
    path.lineTo(x(358.0), y(-532.0));
    path.close();
    path.moveTo(x(200.0), y(-313.0));
