...
/// Animated align_horizontal_left icon from Google Material Icons
class MconAlignHorizontalLeft extends MconBase {
  const MconAlignHorizontalLeft({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconAlignHorizontalLeftPainter extends MconPainter {
  _MconAlignHorizontalLeftPainter({
