...
/// Animated person_add icon from Google Material Icons
class MconPersonAdd extends MconBase {
  const MconPersonAdd({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconPersonAdd> createState() => _MconPersonAddState();
}

class _MconPersonAddState extends MconBaseState<MconPersonAdd> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPersonAddPainter(
      animation: animation,
...
class _MconPersonAddPainter extends MconPainter {
  _MconPersonAddPainter({
