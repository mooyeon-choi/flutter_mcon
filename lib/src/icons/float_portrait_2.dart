...
/// Animated float_portrait_2 icon from Google Material Icons
class MconFloatPortrait2 extends MconBase {
  const MconFloatPortrait2({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconFloatPortrait2> createState() => _MconFloatPortrait2State();
}

class _MconFloatPortrait2State extends MconBaseState<MconFloatPortrait2> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFloatPortrait2Painter(
      animation: animation,
...
class _MconFloatPortrait2Painter extends MconPainter {
  _MconFloatPortrait2Painter({
