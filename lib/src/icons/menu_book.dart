...
/// Animated menu_book icon from Google Material Icons
class MconMenuBook extends MconBase {
  const MconMenuBook({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconMenuBook> createState() => _MconMenuBookState();
}

class _MconMenuBookState extends MconBaseState<MconMenuBook> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMenuBookPainter(
      animation: animation,
...
class _MconMenuBookPainter extends MconPainter {
  _MconMenuBookPainter({
