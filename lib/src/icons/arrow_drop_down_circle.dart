...
/// Animated arrow_drop_down_circle icon from Google Material Icons
class MconArrowDropDownCircle extends MconBase {
  const MconArrowDropDownCircle({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconArrowDropDownCirclePainter extends MconPainter {
  _MconArrowDropDownCirclePainter({
