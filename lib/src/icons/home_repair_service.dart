...
/// Animated home_repair_service icon from Google Material Icons
class MconHomeRepairService extends MconBase {
  const MconHomeRepairService({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconHomeRepairService> createState() =>
      _MconHomeRepairServiceState();
}

class _MconHomeRepairServiceState extends MconBaseState<MconHomeRepairService> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHomeRepairServicePainter(
      animation: animation,
...
class _MconHomeRepairServicePainter extends MconPainter {
  _MconHomeRepairServicePainter({
