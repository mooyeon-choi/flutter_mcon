...
/// Animated calendar_view_day icon from Google Material Icons
class MconCalendarViewDay extends MconBase {
  const MconCalendarViewDay({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCalendarViewDay> createState() => _MconCalendarViewDayState();
}

class _MconCalendarViewDayState extends MconBaseState<MconCalendarViewDay> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCalendarViewDayPainter(
      animation: animation,
...
class _MconCalendarViewDayPainter extends MconPainter {
  _MconCalendarViewDayPainter({
