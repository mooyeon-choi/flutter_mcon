...
/// Animated calendar_month icon from Google Material Icons
class MconCalendarMonth extends MconBase {
  const MconCalendarMonth({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCalendarMonth> createState() => _MconCalendarMonthState();
}

class _MconCalendarMonthState extends MconBaseState<MconCalendarMonth> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCalendarMonthPainter(
      animation: animation,
...
class _MconCalendarMonthPainter extends MconPainter {
  _MconCalendarMonthPainter({
