...
/// Animated keyboard icon from Google Material Icons
class MconKeyboard extends MconBase {
  const MconKeyboard({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconKeyboard> createState() => _MconKeyboardState();
}

class _MconKeyboardState extends MconBaseState<MconKeyboard> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconKeyboardPainter(
      animation: animation,
...
class _MconKeyboardPainter extends MconPainter {
  _MconKeyboardPainter({
