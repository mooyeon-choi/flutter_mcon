...
/// Animated zoom_in icon from Google Material Icons
class MconZoomIn extends MconBase {
  const MconZoomIn({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconZoomIn> createState() => _MconZoomInState();
}

class _MconZoomInState extends MconBaseState<MconZoomIn> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconZoomInPainter(
      animation: animation,
...
class _MconZoomInPainter extends MconPainter {
  _MconZoomInPainter({
