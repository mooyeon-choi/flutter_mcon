...
/// Animated tv_next icon from Google Material Icons
class MconTvNext extends MconBase {
  const MconTvNext({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconTvNext> createState() => _MconTvNextState();
}

class _MconTvNextState extends MconBaseState<MconTvNext> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTvNextPainter(
      animation: animation,
...
class _MconTvNextPainter extends MconPainter {
  _MconTvNextPainter({
