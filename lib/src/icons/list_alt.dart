...
/// Animated list_alt icon from Google Material Icons
class MconListAlt extends MconBase {
  const MconListAlt({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconListAlt> createState() => _MconListAltState();
}

class _MconListAltState extends MconBaseState<MconListAlt> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconListAltPainter(
      animation: animation,
...
class _MconListAltPainter extends MconPainter {
  _MconListAltPainter({
