...
/// Animated battery_charging_90 icon from Google Material Icons
class MconBatteryCharging90 extends MconBase {
  const MconBatteryCharging90({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryCharging90> createState() => _MconBatteryCharging90State();
}

class _MconBatteryCharging90State extends MconBaseState<MconBatteryCharging90> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryCharging90Painter(
      animation: animation,
...
class _MconBatteryCharging90Painter extends MconPainter {
  _MconBatteryCharging90Painter({
