...
/// Animated vertical_split icon from Google Material Icons
class MconVerticalSplit extends MconBase {
  const MconVerticalSplit({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconVerticalSplit> createState() => _MconVerticalSplitState();
}

class _MconVerticalSplitState extends MconBaseState<MconVerticalSplit> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconVerticalSplitPainter(
      animation: animation,
...
class _MconVerticalSplitPainter extends MconPainter {
  _MconVerticalSplitPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(520.0), y(-713.0), x(543.5), y(-736.5));
    path.quadraticBezierTo(x(567.0), y(-760.0), x(600.0), y(-760.0));
