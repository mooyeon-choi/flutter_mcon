...
/// Animated blur_on icon from Google Material Icons
class MconBlurOn extends MconBase {
  const MconBlurOn({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconBlurOn> createState() => _MconBlurOnState();
}

class _MconBlurOnState extends MconBaseState<MconBlurOn> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBlurOnPainter(
      animation: animation,
...
class _MconBlurOnPainter extends MconPainter {
  _MconBlurOnPainter({
