...
/// Animated library_add icon from Google Material Icons
class MconLibraryAdd extends MconBase {
  const MconLibraryAdd({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconLibraryAdd> createState() => _MconLibraryAddState();
}

class _MconLibraryAddState extends MconBaseState<MconLibraryAdd> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLibraryAddPainter(
      animation: animation,
...
class _MconLibraryAddPainter extends MconPainter {
  _MconLibraryAddPainter({
