...
/// Animated pregnant_woman icon from Google Material Icons
class MconPregnantWoman extends MconBase {
  const MconPregnantWoman({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPregnantWoman> createState() => _MconPregnantWomanState();
}

class _MconPregnantWomanState extends MconBaseState<MconPregnantWoman> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPregnantWomanPainter(
      animation: animation,
...
class _MconPregnantWomanPainter extends MconPainter {
  _MconPregnantWomanPainter({
