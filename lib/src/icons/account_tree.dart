...
/// Animated account_tree icon from Google Material Icons
class MconAccountTree extends MconBase {
  const MconAccountTree({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconAccountTree> createState() => _MconAccountTreeState();
}

class _MconAccountTreeState extends MconBaseState<MconAccountTree> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAccountTreePainter(
      animation: animation,
...
class _MconAccountTreePainter extends MconPainter {
  _MconAccountTreePainter({
