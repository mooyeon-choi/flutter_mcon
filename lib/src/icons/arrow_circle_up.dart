...
/// Animated arrow_circle_up icon from Google Material Icons
class MconArrowCircleUp extends MconBase {
  const MconArrowCircleUp({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconArrowCircleUp> createState() => _MconArrowCircleUpState();
}

class _MconArrowCircleUpState extends MconBaseState<MconArrowCircleUp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconArrowCircleUpPainter(
      animation: animation,
...
class _MconArrowCircleUpPainter extends MconPainter {
  _MconArrowCircleUpPainter({
