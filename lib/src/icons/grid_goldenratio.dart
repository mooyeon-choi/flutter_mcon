...
/// Animated grid_goldenratio icon from Google Material Icons
class MconGridGoldenratio extends MconBase {
  const MconGridGoldenratio({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconGridGoldenratio> createState() =>
      _MconGridGoldenratioState();
}

class _MconGridGoldenratioState extends MconBaseState<MconGridGoldenratio> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconGridGoldenratioPainter(
      animation: animation,
...
class _MconGridGoldenratioPainter extends MconPainter {
  _MconGridGoldenratioPainter({
