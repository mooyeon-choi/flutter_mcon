...
/// Animated radio_button_checked icon from Google Material Icons
class MconRadioButtonChecked extends MconBase {
  const MconRadioButtonChecked({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconRadioButtonChecked> createState() =>
      _MconRadioButtonCheckedState();
}

class _MconRadioButtonCheckedState
    extends MconBaseState<MconRadioButtonChecked> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconRadioButtonCheckedPainter(
      animation: animation,
...
class _MconRadioButtonCheckedPainter extends MconPainter {
  _MconRadioButtonCheckedPainter({
