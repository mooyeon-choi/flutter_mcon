...
/// Animated tab_close_inactive icon from Google Material Icons
class MconTabCloseInactive extends MconBase {
  const MconTabCloseInactive({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconTabCloseInactive> createState() =>
      _MconTabCloseInactiveState();
}

class _MconTabCloseInactiveState extends MconBaseState<MconTabCloseInactive> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTabCloseInactivePainter(
      animation: animation,
...
class _MconTabCloseInactivePainter extends MconPainter {
  _MconTabCloseInactivePainter({
