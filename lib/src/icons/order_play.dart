...
/// Animated order_play icon from Google Material Icons
class MconOrderPlay extends MconBase {
  const MconOrderPlay({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconOrderPlay> createState() => _MconOrderPlayState();
}

class _MconOrderPlayState extends MconBaseState<MconOrderPlay> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconOrderPlayPainter(
      animation: animation,
...
class _MconOrderPlayPainter extends MconPainter {
  _MconOrderPlayPainter({
