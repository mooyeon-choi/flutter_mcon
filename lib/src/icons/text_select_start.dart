...
/// Animated text_select_start icon from Google Material Icons
class MconTextSelectStart extends MconBase {
  const MconTextSelectStart({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconTextSelectStart> createState() =>
      _MconTextSelectStartState();
}

class _MconTextSelectStartState extends MconBaseState<MconTextSelectStart> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTextSelectStartPainter(
      animation: animation,
...
class _MconTextSelectStartPainter extends MconPainter {
  _MconTextSelectStartPainter({
