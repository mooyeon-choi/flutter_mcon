...
/// Animated mobile_arrow_right icon from Google Material Icons
class MconMobileArrowRight extends MconBase {
  const MconMobileArrowRight({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMobileArrowRight> createState() =>
      _MconMobileArrowRightState();
}

class _MconMobileArrowRightState extends MconBaseState<MconMobileArrowRight> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMobileArrowRightPainter(
      animation: animation,
...
class _MconMobileArrowRightPainter extends MconPainter {
  _MconMobileArrowRightPainter({
