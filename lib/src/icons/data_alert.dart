...
/// Animated data_alert icon from Google Material Icons
class MconDataAlert extends MconBase {
  const MconDataAlert({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconDataAlert> createState() => _MconDataAlertState();
}

class _MconDataAlertState extends MconBaseState<MconDataAlert> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDataAlertPainter(
      animation: animation,
...
class _MconDataAlertPainter extends MconPainter {
  _MconDataAlertPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(648.0), y(-520.0), x(654.0), y(-526.0));
    path.quadraticBezierTo(x(660.0), y(-532.0), x(660.0), y(-540.0));
    path.quadraticBezierTo(x(660.0), y(-548.0), x(654.0), y(-554.0));
    path.quadraticBezierTo(x(648.0), y(-560.0), x(640.0), y(-560.0));
    path.quadraticBezierTo(x(632.0), y(-560.0), x(626.0), y(-554.0));
    path.quadraticBezierTo(x(620.0), y(-548.0), x(620.0), y(-540.0));
    path.quadraticBezierTo(x(620.0), y(-532.0), x(626.0), y(-526.0));
    path.quadraticBezierTo(x(632.0), y(-520.0), x(640.0), y(-520.0));
    path.close();
