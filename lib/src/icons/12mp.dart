...
/// Animated 12mp icon from Google Material Icons
class Mcon12mp extends MconBase {
  const Mcon12mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon12mp> createState() => _Mcon12mpState();
}

class _Mcon12mpState extends MconBaseState<Mcon12mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon12mpPainter(
      animation: animation,
...
class _Mcon12mpPainter extends MconPainter {
  _Mcon12mpPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(660.0), y(-717.0), x(648.5), y(-728.5));
    path.quadraticBezierTo(x(637.0), y(-740.0), x(620.0), y(-740.0));
