...
/// Animated closed_caption icon from Google Material Icons
class MconClosedCaption extends MconBase {
  const MconClosedCaption({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconClosedCaption> createState() => _MconClosedCaptionState();
}

class _MconClosedCaptionState extends MconBaseState<MconClosedCaption> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconClosedCaptionPainter(
      animation: animation,
...
class _MconClosedCaptionPainter extends MconPainter {
  _MconClosedCaptionPainter({
