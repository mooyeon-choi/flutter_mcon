...
/// Animated outpatient icon from Google Material Icons
class MconOutpatient extends MconBase {
  const MconOutpatient({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconOutpatient> createState() => _MconOutpatientState();
}

class _MconOutpatientState extends MconBaseState<MconOutpatient> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconOutpatientPainter(
      animation: animation,
...
class _MconOutpatientPainter extends MconPainter {
  _MconOutpatientPainter({
