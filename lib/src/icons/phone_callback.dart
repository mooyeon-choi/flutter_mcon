...
/// Animated phone_callback icon from Google Material Icons
class MconPhoneCallback extends MconBase {
  const MconPhoneCallback({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPhoneCallback> createState() => _MconPhoneCallbackState();
}

class _MconPhoneCallbackState extends MconBaseState<MconPhoneCallback> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPhoneCallbackPainter(
      animation: animation,
...
class _MconPhoneCallbackPainter extends MconPainter {
  _MconPhoneCallbackPainter({
