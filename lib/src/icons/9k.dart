...
/// Animated 9k icon from Google Material Icons
class Mcon9k extends MconBase {
  const Mcon9k({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon9k> createState() => _Mcon9kState();
}

class _Mcon9kState extends MconBaseState<Mcon9k> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon9kPainter(
      animation: animation,
...
class _Mcon9kPainter extends MconPainter {
  _Mcon9kPainter({
