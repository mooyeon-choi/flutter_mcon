...
/// Animated battery_android_frame_3 icon from Google Material Icons
class MconBatteryAndroidFrame3 extends MconBase {
  const MconBatteryAndroidFrame3({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconBatteryAndroidFrame3Painter extends MconPainter {
  _MconBatteryAndroidFrame3Painter({
