...
/// Animated next_week icon from Google Material Icons
class MconNextWeek extends MconBase {
  const MconNextWeek({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconNextWeek> createState() => _MconNextWeekState();
}

class _MconNextWeekState extends MconBaseState<MconNextWeek> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconNextWeekPainter(
      animation: animation,
...
class _MconNextWeekPainter extends MconPainter {
  _MconNextWeekPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(384.0), y(-524.0));
    path.lineTo(x(488.0), y(-420.0));
    path.lineTo(x(384.0), y(-316.0));
