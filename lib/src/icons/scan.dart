...
/// Animated scan icon from Google Material Icons
class MconScan extends MconBase {
  const MconScan({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconScan> createState() => _MconScanState();
}

class _MconScanState extends MconBaseState<MconScan> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconScanPainter(
      animation: animation,
...
class _MconScanPainter extends MconPainter {
  _MconScanPainter({
