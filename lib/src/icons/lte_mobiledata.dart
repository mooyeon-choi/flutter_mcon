...
/// Animated lte_mobiledata icon from Google Material Icons
class MconLteMobiledata extends MconBase {
  const MconLteMobiledata({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconLteMobiledata> createState() => _MconLteMobiledataState();
}

class _MconLteMobiledataState extends MconBaseState<MconLteMobiledata> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLteMobiledataPainter(
      animation: animation,
...
class _MconLteMobiledataPainter extends MconPainter {
  _MconLteMobiledataPainter({
