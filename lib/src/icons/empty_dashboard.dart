...
/// Animated empty_dashboard icon from Google Material Icons
class MconEmptyDashboard extends MconBase {
  const MconEmptyDashboard({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconEmptyDashboard> createState() => _MconEmptyDashboardState();
}

class _MconEmptyDashboardState extends MconBaseState<MconEmptyDashboard> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconEmptyDashboardPainter(
      animation: animation,
...
class _MconEmptyDashboardPainter extends MconPainter {
  _MconEmptyDashboardPainter({
