...
/// Animated motion_photos_paused icon from Google Material Icons
class MconMotionPhotosPaused extends MconBase {
  const MconMotionPhotosPaused({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMotionPhotosPaused> createState() =>
      _MconMotionPhotosPausedState();
}

class _MconMotionPhotosPausedState
    extends MconBaseState<MconMotionPhotosPaused> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMotionPhotosPausedPainter(
      animation: animation,
...
class _MconMotionPhotosPausedPainter extends MconPainter {
  _MconMotionPhotosPausedPainter({
