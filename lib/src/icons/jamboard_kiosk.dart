...
/// Animated jamboard_kiosk icon from Google Material Icons
class MconJamboardKiosk extends MconBase {
  const MconJamboardKiosk({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconJamboardKiosk> createState() => _MconJamboardKioskState();
}

class _MconJamboardKioskState extends MconBaseState<MconJamboardKiosk> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconJamboardKioskPainter(
      animation: animation,
...
class _MconJamboardKioskPainter extends MconPainter {
  _MconJamboardKioskPainter({
