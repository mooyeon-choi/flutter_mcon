...
/// Animated sensor_window icon from Google Material Icons
class MconSensorWindow extends MconBase {
  const MconSensorWindow({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSensorWindow> createState() => _MconSensorWindowState();
}

class _MconSensorWindowState extends MconBaseState<MconSensorWindow> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSensorWindowPainter(
      animation: animation,
...
class _MconSensorWindowPainter extends MconPainter {
  _MconSensorWindowPainter({
