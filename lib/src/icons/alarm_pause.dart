...
/// Animated alarm_pause icon from Google Material Icons
class MconAlarmPause extends MconBase {
  const MconAlarmPause({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconAlarmPause> createState() => _MconAlarmPauseState();
}

class _MconAlarmPauseState extends MconBaseState<MconAlarmPause> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAlarmPausePainter(
      animation: animation,
...
class _MconAlarmPausePainter extends MconPainter {
  _MconAlarmPausePainter({
