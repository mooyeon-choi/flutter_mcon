...
/// Animated filter_1 icon from Google Material Icons
class MconFilter1 extends MconBase {
  const MconFilter1({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconFilter1> createState() => _MconFilter1State();
}

class _MconFilter1State extends MconBaseState<MconFilter1> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFilter1Painter(
      animation: animation,
...
class _MconFilter1Painter extends MconPainter {
  _MconFilter1Painter({
