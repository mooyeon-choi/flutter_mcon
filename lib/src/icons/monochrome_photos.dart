...
/// Animated monochrome_photos icon from Google Material Icons
class MconMonochromePhotos extends MconBase {
  const MconMonochromePhotos({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMonochromePhotos> createState() =>
      _MconMonochromePhotosState();
}

class _MconMonochromePhotosState extends MconBaseState<MconMonochromePhotos> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMonochromePhotosPainter(
      animation: animation,
...
class _MconMonochromePhotosPainter extends MconPainter {
  _MconMonochromePhotosPainter({
