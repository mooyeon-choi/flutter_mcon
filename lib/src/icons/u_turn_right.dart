...
/// Animated u_turn_right icon from Google Material Icons
class MconUTurnRight extends MconBase {
  const MconUTurnRight({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconUTurnRight> createState() => _MconUTurnRightState();
}

class _MconUTurnRightState extends MconBaseState<MconUTurnRight> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconUTurnRightPainter(
      animation: animation,
...
class _MconUTurnRightPainter extends MconPainter {
  _MconUTurnRightPainter({
