...
/// Animated car_fan_low_left icon from Google Material Icons
class MconCarFanLowLeft extends MconBase {
  const MconCarFanLowLeft({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCarFanLowLeft> createState() => _MconCarFanLowLeftState();
}

class _MconCarFanLowLeftState extends MconBaseState<MconCarFanLowLeft> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCarFanLowLeftPainter(
      animation: animation,
...
class _MconCarFanLowLeftPainter extends MconPainter {
  _MconCarFanLowLeftPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(576.0), y(-736.0));
    path.lineTo(x(640.0), y(-673.0));
    path.lineTo(x(640.0), y(-840.0));
    path.lineTo(x(720.0), y(-840.0));
    path.lineTo(x(720.0), y(-673.0));
    path.lineTo(x(784.0), y(-737.0));
