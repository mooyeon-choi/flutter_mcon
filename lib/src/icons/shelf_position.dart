...
/// Animated shelf_position icon from Google Material Icons
class MconShelfPosition extends MconBase {
  const MconShelfPosition({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconShelfPosition> createState() => _MconShelfPositionState();
}

class _MconShelfPositionState extends MconBaseState<MconShelfPosition> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconShelfPositionPainter(
      animation: animation,
...
class _MconShelfPositionPainter extends MconPainter {
  _MconShelfPositionPainter({
