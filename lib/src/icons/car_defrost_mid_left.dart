...
/// Animated car_defrost_mid_left icon from Google Material Icons
class MconCarDefrostMidLeft extends MconBase {
  const MconCarDefrostMidLeft({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconCarDefrostMidLeftState extends MconBaseState<MconCarDefrostMidLeft> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCarDefrostMidLeftPainter(
      animation: animation,
...
class _MconCarDefrostMidLeftPainter extends MconPainter {
  _MconCarDefrostMidLeftPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(842.0), y(-478.0));
    path.lineTo(x(795.0), y(-430.0));
    path.lineTo(x(920.0), y(-430.0));
    path.lineTo(x(920.0), y(-370.0));
    path.lineTo(x(795.0), y(-370.0));
    path.lineTo(x(842.0), y(-322.0));
