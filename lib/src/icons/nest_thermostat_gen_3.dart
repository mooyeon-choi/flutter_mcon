...
/// Animated nest_thermostat_gen_3 icon from Google Material Icons
class MconNestThermostatGen3 extends MconBase {
  const MconNestThermostatGen3({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconNestThermostatGen3> createState() =>
      _MconNestThermostatGen3State();
}

class _MconNestThermostatGen3State
    extends MconBaseState<MconNestThermostatGen3> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconNestThermostatGen3Painter(
      animation: animation,
...
class _MconNestThermostatGen3Painter extends MconPainter {
  _MconNestThermostatGen3Painter({
