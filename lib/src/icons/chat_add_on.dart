...
/// Animated chat_add_on icon from Google Material Icons
class MconChatAddOn extends MconBase {
  const MconChatAddOn({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconChatAddOn> createState() => _MconChatAddOnState();
}

class _MconChatAddOnState extends MconBaseState<MconChatAddOn> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconChatAddOnPainter(
      animation: animation,
...
class _MconChatAddOnPainter extends MconPainter {
  _MconChatAddOnPainter({
