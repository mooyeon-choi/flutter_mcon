...
/// Animated production_quantity_limits icon from Google Material Icons
class MconProductionQuantityLimits extends MconBase {
  const MconProductionQuantityLimits({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconProductionQuantityLimits> createState() =>
      _MconProductionQuantityLimitsState();
}

class _MconProductionQuantityLimitsState
    extends MconBaseState<MconProductionQuantityLimits> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconProductionQuantityLimitsPainter(
      animation: animation,
...
class _MconProductionQuantityLimitsPainter extends MconPainter {
  _MconProductionQuantityLimitsPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(463.0), y(-580.0), x(451.5), y(-591.5));
    path.quadraticBezierTo(x(440.0), y(-603.0), x(440.0), y(-620.0));
    ...
    path.quadraticBezierTo(x(520.0), y(-603.0), x(508.5), y(-591.5));
    path.quadraticBezierTo(x(497.0), y(-580.0), x(480.0), y(-580.0));
    path.close();
