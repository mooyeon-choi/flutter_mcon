...
/// Animated battery_alert icon from Google Material Icons
class MconBatteryAlert extends MconBase {
  const MconBatteryAlert({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryAlert> createState() => _MconBatteryAlertState();
}

class _MconBatteryAlertState extends MconBaseState<MconBatteryAlert> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryAlertPainter(
      animation: animation,
...
class _MconBatteryAlertPainter extends MconPainter {
  _MconBatteryAlertPainter({
