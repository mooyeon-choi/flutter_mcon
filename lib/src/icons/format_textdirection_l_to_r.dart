...
/// Animated format_textdirection_l_to_r icon from Google Material Icons
class MconFormatTextdirectionLToR extends MconBase {
  const MconFormatTextdirectionLToR({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconFormatTextdirectionLToR> createState() =>
      _MconFormatTextdirectionLToRState();
}

class _MconFormatTextdirectionLToRState
    extends MconBaseState<MconFormatTextdirectionLToR> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFormatTextdirectionLToRPainter(
      animation: animation,
...
class _MconFormatTextdirectionLToRPainter extends MconPainter {
  _MconFormatTextdirectionLToRPainter({
