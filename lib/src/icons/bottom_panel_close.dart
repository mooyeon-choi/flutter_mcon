...
/// Animated bottom_panel_close icon from Google Material Icons
class MconBottomPanelClose extends MconBase {
  const MconBottomPanelClose({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconBottomPanelCloseState extends MconBaseState<MconBottomPanelClose> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBottomPanelClosePainter(
      animation: animation,
...
class _MconBottomPanelClosePainter extends MconPainter {
  _MconBottomPanelClosePainter({
