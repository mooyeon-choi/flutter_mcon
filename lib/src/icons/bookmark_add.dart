...
/// Animated bookmark_add icon from Google Material Icons
class MconBookmarkAdd extends MconBase {
  const MconBookmarkAdd({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBookmarkAdd> createState() => _MconBookmarkAddState();
}

class _MconBookmarkAddState extends MconBaseState<MconBookmarkAdd> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBookmarkAddPainter(
      animation: animation,
...
class _MconBookmarkAddPainter extends MconPainter {
  _MconBookmarkAddPainter({
