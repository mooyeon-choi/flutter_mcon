...
/// Animated pinch_zoom_in icon from Google Material Icons
class MconPinchZoomIn extends MconBase {
  const MconPinchZoomIn({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPinchZoomIn> createState() => _MconPinchZoomInState();
}

class _MconPinchZoomInState extends MconBaseState<MconPinchZoomIn> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPinchZoomInPainter(
      animation: animation,
...
class _MconPinchZoomInPainter extends MconPainter {
  _MconPinchZoomInPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.moveTo(x(62.0), y(-460.0));
    path.lineTo(x(20.0), y(-502.0));
    path.lineTo(x(137.0), y(-620.0));
    ...
    path.lineTo(x(180.0), y(-577.0));
    path.lineTo(x(62.0), y(-460.0));
    path.close();
    path.moveTo(x(280.0), y(-720.0));
    path.lineTo(x(280.0), y(-920.0));
    path.lineTo(x(340.0), y(-920.0));
    path.lineTo(x(340.0), y(-822.0));
    path.lineTo(x(457.0), y(-940.0));
    path.lineTo(x(500.0), y(-897.0));
    path.lineTo(x(382.0), y(-780.0));
