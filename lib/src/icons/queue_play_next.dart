...
/// Animated queue_play_next icon from Google Material Icons
class MconQueuePlayNext extends MconBase {
  const MconQueuePlayNext({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconQueuePlayNext> createState() => _MconQueuePlayNextState();
}

class _MconQueuePlayNextState extends MconBaseState<MconQueuePlayNext> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconQueuePlayNextPainter(
      animation: animation,
...
class _MconQueuePlayNextPainter extends MconPainter {
  _MconQueuePlayNextPainter({
