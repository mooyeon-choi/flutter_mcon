...
/// Animated road icon from Google Material Icons
class MconRoad extends MconBase {
  const MconRoad({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconRoad> createState() => _MconRoadState();
}

class _MconRoadState extends MconBaseState<MconRoad> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconRoadPainter(
      animation: animation,
...
class _MconRoadPainter extends MconPainter {
  _MconRoadPainter({
