...
/// Animated text_compare icon from Google Material Icons
class MconTextCompare extends MconBase {
  const MconTextCompare({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconTextCompare> createState() => _MconTextCompareState();
}

class _MconTextCompareState extends MconBaseState<MconTextCompare> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTextComparePainter(
      animation: animation,
...
class _MconTextComparePainter extends MconPainter {
  _MconTextComparePainter({
