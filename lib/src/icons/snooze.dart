...
/// Animated snooze icon from Google Material Icons
class MconSnooze extends MconBase {
  const MconSnooze({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconSnooze> createState() => _MconSnoozeState();
}

class _MconSnoozeState extends MconBaseState<MconSnooze> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSnoozePainter(
      animation: animation,
...
class _MconSnoozePainter extends MconPainter {
  _MconSnoozePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.moveTo(x(380.0), y(-334.0));
    path.lineTo(x(580.0), y(-334.0));
    path.lineTo(x(580.0), y(-394.0));
    path.lineTo(x(468.0), y(-394.0));
    path.lineTo(x(580.0), y(-520.0));
    path.lineTo(x(580.0), y(-574.0));
    path.lineTo(x(380.0), y(-574.0));
    path.lineTo(x(380.0), y(-514.0));
    path.lineTo(x(494.0), y(-514.0));
    path.lineTo(x(380.0), y(-386.0));
    path.lineTo(x(380.0), y(-334.0));
    path.close();
