...
/// Animated screenshot_keyboard icon from Google Material Icons
class MconScreenshotKeyboard extends MconBase {
  const MconScreenshotKeyboard({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconScreenshotKeyboard> createState() =>
      _MconScreenshotKeyboardState();
}

class _MconScreenshotKeyboardState
    extends MconBaseState<MconScreenshotKeyboard> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconScreenshotKeyboardPainter(
      animation: animation,
...
class _MconScreenshotKeyboardPainter extends MconPainter {
  _MconScreenshotKeyboardPainter({
