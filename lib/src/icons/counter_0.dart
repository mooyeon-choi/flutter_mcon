...
/// Animated counter_0 icon from Google Material Icons
class MconCounter0 extends MconBase {
  const MconCounter0({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCounter0> createState() => _MconCounter0State();
}

class _MconCounter0State extends MconBaseState<MconCounter0> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCounter0Painter(
      animation: animation,
...
class _MconCounter0Painter extends MconPainter {
  _MconCounter0Painter({
