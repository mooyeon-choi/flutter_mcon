...
/// Animated two_pager icon from Google Material Icons
class MconTwoPager extends MconBase {
  const MconTwoPager({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconTwoPager> createState() => _MconTwoPagerState();
}

class _MconTwoPagerState extends MconBaseState<MconTwoPager> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTwoPagerPainter(
      animation: animation,
...
class _MconTwoPagerPainter extends MconPainter {
  _MconTwoPagerPainter({
