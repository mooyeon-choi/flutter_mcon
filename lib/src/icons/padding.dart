...
/// Animated padding icon from Google Material Icons
class MconPadding extends MconBase {
  const MconPadding({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconPadding> createState() => _MconPaddingState();
}

class _MconPaddingState extends MconBaseState<MconPadding> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPaddingPainter(
      animation: animation,
...
class _MconPaddingPainter extends MconPainter {
  _MconPaddingPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(657.0), y(-600.0), x(668.5), y(-611.5));
    path.quadraticBezierTo(x(680.0), y(-623.0), x(680.0), y(-640.0));
    path.quadraticBezierTo(x(680.0), y(-657.0), x(668.5), y(-668.5));
    path.quadraticBezierTo(x(657.0), y(-680.0), x(640.0), y(-680.0));
    path.quadraticBezierTo(x(623.0), y(-680.0), x(611.5), y(-668.5));
    path.quadraticBezierTo(x(600.0), y(-657.0), x(600.0), y(-640.0));
    path.quadraticBezierTo(x(600.0), y(-623.0), x(611.5), y(-611.5));
