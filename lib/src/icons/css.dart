...
/// Animated css icon from Google Material Icons
class MconCss extends MconBase {
  const MconCss({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCss> createState() => _MconCssState();
}

class _MconCssState extends MconBaseState<MconCss> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCssPainter(
      animation: animation,
...
class _MconCssPainter extends MconPainter {
  _MconCssPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(403.0), y(-460.0), x(391.5), y(-471.5));
    path.quadraticBezierTo(x(380.0), y(-483.0), x(380.0), y(-500.0));
    path.lineTo(x(380.0), y(-560.0));
    path.quadraticBezierTo(x(380.0), y(-577.0), x(391.5), y(-588.5));
    ...
    path.quadraticBezierTo(x(557.0), y(-500.0), x(568.5), y(-488.5));
    path.quadraticBezierTo(x(580.0), y(-477.0), x(580.0), y(-460.0));
    ...
    path.quadraticBezierTo(x(663.0), y(-460.0), x(651.5), y(-471.5));
    ...
    path.quadraticBezierTo(x(817.0), y(-500.0), x(828.5), y(-488.5));
