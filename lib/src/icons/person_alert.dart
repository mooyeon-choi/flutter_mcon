...
/// Animated person_alert icon from Google Material Icons
class MconPersonAlert extends MconBase {
  const MconPersonAlert({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPersonAlert> createState() => _MconPersonAlertState();
}

class _MconPersonAlertState extends MconBaseState<MconPersonAlert> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPersonAlertPainter(
      animation: animation,
...
class _MconPersonAlertPainter extends MconPainter {
  _MconPersonAlertPainter({
