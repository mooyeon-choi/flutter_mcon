...
/// Animated timer_arrow_down icon from Google Material Icons
class MconTimerArrowDown extends MconBase {
  const MconTimerArrowDown({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconTimerArrowDown> createState() => _MconTimerArrowDownState();
}

class _MconTimerArrowDownState extends MconBaseState<MconTimerArrowDown> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTimerArrowDownPainter(
      animation: animation,
...
class _MconTimerArrowDownPainter extends MconPainter {
  _MconTimerArrowDownPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(696.0), y(-356.0));
    path.lineTo(x(740.0), y(-312.0));
    path.lineTo(x(740.0), y(-800.0));
    path.lineTo(x(820.0), y(-800.0));
    path.lineTo(x(820.0), y(-313.0));
    path.lineTo(x(863.0), y(-356.0));
