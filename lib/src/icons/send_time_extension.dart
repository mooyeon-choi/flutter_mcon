...
/// Animated send_time_extension icon from Google Material Icons
class MconSendTimeExtension extends MconBase {
  const MconSendTimeExtension({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSendTimeExtension> createState() =>
      _MconSendTimeExtensionState();
}

class _MconSendTimeExtensionState extends MconBaseState<MconSendTimeExtension> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSendTimeExtensionPainter(
      animation: animation,
...
class _MconSendTimeExtensionPainter extends MconPainter {
  _MconSendTimeExtensionPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(302.0), y(-245.0), x(343.0), y(-278.5));
    path.quadraticBezierTo(x(384.0), y(-312.0), x(440.0), y(-318.0));
    path.lineTo(x(440.0), y(-238.0));
    path.quadraticBezierTo(x(400.0), y(-230.0), x(376.0), y(-200.5));
    path.quadraticBezierTo(x(352.0), y(-171.0), x(352.0), y(-120.0));
    path.lineTo(x(200.0), y(-120.0));
    path.close();
    path.moveTo(x(460.0), y(-510.0));
    path.close();
