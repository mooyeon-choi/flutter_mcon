...
/// Animated mp icon from Google Material Icons
class MconMp extends MconBase {
  const MconMp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconMp> createState() => _MconMpState();
}

class _MconMpState extends MconBaseState<MconMp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMpPainter(
      animation: animation,
...
class _MconMpPainter extends MconPainter {
  _MconMpPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(500.0), y(-577.0), x(488.5), y(-588.5));
    path.quadraticBezierTo(x(477.0), y(-600.0), x(460.0), y(-600.0));
    ...
    path.quadraticBezierTo(x(697.0), y(-420.0), x(708.5), y(-431.5));
    path.quadraticBezierTo(x(720.0), y(-443.0), x(720.0), y(-460.0));
