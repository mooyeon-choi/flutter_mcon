...
/// Animated error icon from Google Material Icons
class MconError extends MconBase {
  const MconError({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconError> createState() => _MconErrorState();
}

class _MconErrorState extends MconBaseState<MconError> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconErrorPainter(
      animation: animation,
...
class _MconErrorPainter extends MconPainter {
  _MconErrorPainter({
