...
/// Animated pinch icon from Google Material Icons
class MconPinch extends MconBase {
  const MconPinch({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconPinch> createState() => _MconPinchState();
}

class _MconPinchState extends MconBaseState<MconPinch> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPinchPainter(
      animation: animation,
...
class _MconPinchPainter extends MconPainter {
  _MconPinchPainter({
