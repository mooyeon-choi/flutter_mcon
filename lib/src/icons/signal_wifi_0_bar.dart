...
/// Animated signal_wifi_0_bar icon from Google Material Icons
class MconSignalWifi0Bar extends MconBase {
  const MconSignalWifi0Bar({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSignalWifi0Bar> createState() => _MconSignalWifi0BarState();
}

class _MconSignalWifi0BarState extends MconBaseState<MconSignalWifi0Bar> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSignalWifi0BarPainter(
      animation: animation,
...
class _MconSignalWifi0BarPainter extends MconPainter {
  _MconSignalWifi0BarPainter({
