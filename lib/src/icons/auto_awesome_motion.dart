...
/// Animated auto_awesome_motion icon from Google Material Icons
class MconAutoAwesomeMotion extends MconBase {
  const MconAutoAwesomeMotion({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconAutoAwesomeMotionState extends MconBaseState<MconAutoAwesomeMotion> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAutoAwesomeMotionPainter(
      animation: animation,
...
class _MconAutoAwesomeMotionPainter extends MconPainter {
  _MconAutoAwesomeMotionPainter({
