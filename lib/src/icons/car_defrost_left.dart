...
/// Animated car_defrost_left icon from Google Material Icons
class MconCarDefrostLeft extends MconBase {
  const MconCarDefrostLeft({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCarDefrostLeft> createState() => _MconCarDefrostLeftState();
}

class _MconCarDefrostLeftState extends MconBaseState<MconCarDefrostLeft> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCarDefrostLeftPainter(
      animation: animation,
...
class _MconCarDefrostLeftPainter extends MconPainter {
  _MconCarDefrostLeftPainter({
