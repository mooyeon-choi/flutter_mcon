...
/// Animated deployed_code_update icon from Google Material Icons
class MconDeployedCodeUpdate extends MconBase {
  const MconDeployedCodeUpdate({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDeployedCodeUpdate> createState() =>
      _MconDeployedCodeUpdateState();
}

class _MconDeployedCodeUpdateState
    extends MconBaseState<MconDeployedCodeUpdate> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDeployedCodeUpdatePainter(
      animation: animation,
...
class _MconDeployedCodeUpdatePainter extends MconPainter {
  _MconDeployedCodeUpdatePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(812.0), y(-228.0));
    path.lineTo(x(740.0), y(-156.0));
    path.lineTo(x(740.0), y(-320.0));
    path.lineTo(x(700.0), y(-320.0));
    path.lineTo(x(700.0), y(-156.0));
    path.lineTo(x(628.0), y(-228.0));
