...
/// Animated science icon from Google Material Icons
class MconScience extends MconBase {
  const MconScience({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconScience> createState() => _MconScienceState();
}

class _MconScienceState extends MconBaseState<MconScience> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSciencePainter(
      animation: animation,
...
class _MconSciencePainter extends MconPainter {
  _MconSciencePainter({
