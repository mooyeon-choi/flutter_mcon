...
/// Animated thermometer_add icon from Google Material Icons
class MconThermometerAdd extends MconBase {
  const MconThermometerAdd({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconThermometerAdd> createState() => _MconThermometerAddState();
}

class _MconThermometerAddState extends MconBaseState<MconThermometerAdd> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconThermometerAddPainter(
      animation: animation,
...
class _MconThermometerAddPainter extends MconPainter {
  _MconThermometerAddPainter({
