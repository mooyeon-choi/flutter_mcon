...
/// Animated battery_android_frame_full icon from Google Material Icons
class MconBatteryAndroidFrameFull extends MconBase {
  const MconBatteryAndroidFrameFull({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryAndroidFrameFull> createState() => _MconBatteryAndroidFrameFullState();
}

class _MconBatteryAndroidFrameFullState extends MconBaseState<MconBatteryAndroidFrameFull> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryAndroidFrameFullPainter(
      animation: animation,
...
class _MconBatteryAndroidFrameFullPainter extends MconPainter {
  _MconBatteryAndroidFrameFullPainter({
