...
/// Animated router_off icon from Google Material Icons
class MconRouterOff extends MconBase {
  const MconRouterOff({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconRouterOff> createState() => _MconRouterOffState();
}

class _MconRouterOffState extends MconBaseState<MconRouterOff> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconRouterOffPainter(
      animation: animation,
...
class _MconRouterOffPainter extends MconPainter {
  _MconRouterOffPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(263.0), y(-240.0), x(251.5), y(-251.5));
    path.quadraticBezierTo(x(240.0), y(-263.0), x(240.0), y(-280.0));
    path.quadraticBezierTo(x(240.0), y(-297.0), x(251.5), y(-308.5));
    path.quadraticBezierTo(x(263.0), y(-320.0), x(280.0), y(-320.0));
    path.quadraticBezierTo(x(297.0), y(-320.0), x(308.5), y(-308.5));
    path.quadraticBezierTo(x(320.0), y(-297.0), x(320.0), y(-280.0));
    path.quadraticBezierTo(x(320.0), y(-263.0), x(308.5), y(-251.5));
    path.quadraticBezierTo(x(297.0), y(-240.0), x(280.0), y(-240.0));
    path.close();
    path.moveTo(x(420.0), y(-240.0));
    path.quadraticBezierTo(x(403.0), y(-240.0), x(391.5), y(-251.5));
    path.quadraticBezierTo(x(380.0), y(-263.0), x(380.0), y(-280.0));
    path.quadraticBezierTo(x(380.0), y(-297.0), x(391.5), y(-308.5));
    path.quadraticBezierTo(x(403.0), y(-320.0), x(420.0), y(-320.0));
    path.quadraticBezierTo(x(437.0), y(-320.0), x(448.5), y(-308.5));
    path.quadraticBezierTo(x(460.0), y(-297.0), x(460.0), y(-280.0));
    path.quadraticBezierTo(x(460.0), y(-263.0), x(448.5), y(-251.5));
    path.quadraticBezierTo(x(437.0), y(-240.0), x(420.0), y(-240.0));
    path.close();
    path.moveTo(x(560.0), y(-240.0));
    path.quadraticBezierTo(x(543.0), y(-240.0), x(531.5), y(-251.5));
    ...
    path.quadraticBezierTo(x(600.0), y(-263.0), x(588.5), y(-251.5));
