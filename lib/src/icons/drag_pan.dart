...
/// Animated drag_pan icon from Google Material Icons
class MconDragPan extends MconBase {
  const MconDragPan({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconDragPan> createState() => _MconDragPanState();
}

class _MconDragPanState extends MconBaseState<MconDragPan> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDragPanPainter(
      animation: animation,
...
class _MconDragPanPainter extends MconPainter {
  _MconDragPanPainter({
