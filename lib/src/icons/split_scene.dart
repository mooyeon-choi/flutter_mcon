...
/// Animated split_scene icon from Google Material Icons
class MconSplitScene extends MconBase {
  const MconSplitScene({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSplitScene> createState() => _MconSplitSceneState();
}

class _MconSplitSceneState extends MconBaseState<MconSplitScene> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSplitScenePainter(
      animation: animation,
...
class _MconSplitScenePainter extends MconPainter {
  _MconSplitScenePainter({
