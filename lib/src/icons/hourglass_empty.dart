...
/// Animated hourglass_empty icon from Google Material Icons
class MconHourglassEmpty extends MconBase {
  const MconHourglassEmpty({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconHourglassEmpty> createState() => _MconHourglassEmptyState();
}

class _MconHourglassEmptyState extends MconBaseState<MconHourglassEmpty> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHourglassEmptyPainter(
      animation: animation,
...
class _MconHourglassEmptyPainter extends MconPainter {
  _MconHourglassEmptyPainter({
