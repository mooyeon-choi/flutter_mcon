...
/// Animated car_defrost_mid_right icon from Google Material Icons
class MconCarDefrostMidRight extends MconBase {
  const MconCarDefrostMidRight({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCarDefrostMidRight> createState() => _MconCarDefrostMidRightState();
}

class _MconCarDefrostMidRightState extends MconBaseState<MconCarDefrostMidRight> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCarDefrostMidRightPainter(
      animation: animation,
...
class _MconCarDefrostMidRightPainter extends MconPainter {
  _MconCarDefrostMidRightPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(118.0), y(-322.0));
    path.lineTo(x(165.0), y(-370.0));
    path.lineTo(x(40.0), y(-370.0));
    path.lineTo(x(40.0), y(-430.0));
    path.lineTo(x(165.0), y(-430.0));
    path.lineTo(x(118.0), y(-478.0));
