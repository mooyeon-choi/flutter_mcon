...
/// Animated fit_page icon from Google Material Icons
class MconFitPage extends MconBase {
  const MconFitPage({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconFitPage> createState() => _MconFitPageState();
}

class _MconFitPageState extends MconBaseState<MconFitPage> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFitPagePainter(
      animation: animation,
...
class _MconFitPagePainter extends MconPainter {
  _MconFitPagePainter({
