...
/// Animated 24mp icon from Google Material Icons
class Mcon24mp extends MconBase {
  const Mcon24mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon24mp> createState() => _Mcon24mpState();
}

class _Mcon24mpState extends MconBaseState<Mcon24mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon24mpPainter(
      animation: animation,
...
class _Mcon24mpPainter extends MconPainter {
  _Mcon24mpPainter({
