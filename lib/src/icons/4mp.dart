...
/// Animated 4mp icon from Google Material Icons
class Mcon4mp extends MconBase {
  const Mcon4mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon4mp> createState() => _Mcon4mpState();
}

class _Mcon4mpState extends MconBaseState<Mcon4mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon4mpPainter(
      animation: animation,
...
class _Mcon4mpPainter extends MconPainter {
  _Mcon4mpPainter({
