...
/// Animated add_shopping_cart icon from Google Material Icons
class MconAddShoppingCart extends MconBase {
  const MconAddShoppingCart({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconAddShoppingCartState extends MconBaseState<MconAddShoppingCart> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAddShoppingCartPainter(
      animation: animation,
...
class _MconAddShoppingCartPainter extends MconPainter {
  _MconAddShoppingCartPainter({
