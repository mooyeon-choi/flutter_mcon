...
/// Animated woman_2 icon from Google Material Icons
class MconWoman2 extends MconBase {
  const MconWoman2({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconWoman2> createState() => _MconWoman2State();
}

class _MconWoman2State extends MconBaseState<MconWoman2> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWoman2Painter(
      animation: animation,
...
class _MconWoman2Painter extends MconPainter {
  _MconWoman2Painter({
