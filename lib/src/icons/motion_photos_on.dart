...
/// Animated motion_photos_on icon from Google Material Icons
class MconMotionPhotosOn extends MconBase {
  const MconMotionPhotosOn({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMotionPhotosOn> createState() => _MconMotionPhotosOnState();
}

class _MconMotionPhotosOnState extends MconBaseState<MconMotionPhotosOn> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMotionPhotosOnPainter(
      animation: animation,
...
class _MconMotionPhotosOnPainter extends MconPainter {
  _MconMotionPhotosOnPainter({
