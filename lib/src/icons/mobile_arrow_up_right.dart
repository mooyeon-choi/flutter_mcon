...
/// Animated mobile_arrow_up_right icon from Google Material Icons
class MconMobileArrowUpRight extends MconBase {
  const MconMobileArrowUpRight({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMobileArrowUpRight> createState() =>
      _MconMobileArrowUpRightState();
}

class _MconMobileArrowUpRightState
    extends MconBaseState<MconMobileArrowUpRight> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMobileArrowUpRightPainter(
      animation: animation,
...
class _MconMobileArrowUpRightPainter extends MconPainter {
  _MconMobileArrowUpRightPainter({
