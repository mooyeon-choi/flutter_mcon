...
/// Animated video_call icon from Google Material Icons
class MconVideoCall extends MconBase {
  const MconVideoCall({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconVideoCall> createState() => _MconVideoCallState();
}

class _MconVideoCallState extends MconBaseState<MconVideoCall> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconVideoCallPainter(
      animation: animation,
...
class _MconVideoCallPainter extends MconPainter {
  _MconVideoCallPainter({
