...
/// Animated border_bottom icon from Google Material Icons
class MconBorderBottom extends MconBase {
  const MconBorderBottom({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBorderBottom> createState() => _MconBorderBottomState();
}

class _MconBorderBottomState extends MconBaseState<MconBorderBottom> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBorderBottomPainter(
      animation: animation,
...
class _MconBorderBottomPainter extends MconPainter {
  _MconBorderBottomPainter({
