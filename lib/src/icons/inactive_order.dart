...
/// Animated inactive_order icon from Google Material Icons
class MconInactiveOrder extends MconBase {
  const MconInactiveOrder({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconInactiveOrder> createState() => _MconInactiveOrderState();
}

class _MconInactiveOrderState extends MconBaseState<MconInactiveOrder> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconInactiveOrderPainter(
      animation: animation,
...
class _MconInactiveOrderPainter extends MconPainter {
  _MconInactiveOrderPainter({
