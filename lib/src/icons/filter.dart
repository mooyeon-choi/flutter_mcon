...
/// Animated filter icon from Google Material Icons
class MconFilter extends MconBase {
  const MconFilter({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconFilter> createState() => _MconFilterState();
}

class _MconFilterState extends MconBaseState<MconFilter> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFilterPainter(
      animation: animation,
...
class _MconFilterPainter extends MconPainter {
  _MconFilterPainter({
