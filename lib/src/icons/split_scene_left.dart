...
/// Animated split_scene_left icon from Google Material Icons
class MconSplitSceneLeft extends MconBase {
  const MconSplitSceneLeft({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSplitSceneLeft> createState() => _MconSplitSceneLeftState();
}

class _MconSplitSceneLeftState extends MconBaseState<MconSplitSceneLeft> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSplitSceneLeftPainter(
      animation: animation,
...
class _MconSplitSceneLeftPainter extends MconPainter {
  _MconSplitSceneLeftPainter({
