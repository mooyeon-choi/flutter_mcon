...
/// Animated screen_share icon from Google Material Icons
class MconScreenShare extends MconBase {
  const MconScreenShare({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconScreenShare> createState() => _MconScreenShareState();
}

class _MconScreenShareState extends MconBaseState<MconScreenShare> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconScreenSharePainter(
      animation: animation,
...
class _MconScreenSharePainter extends MconPainter {
  _MconScreenSharePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(390.0), y(-600.0), x(355.0), y(-565.0));
