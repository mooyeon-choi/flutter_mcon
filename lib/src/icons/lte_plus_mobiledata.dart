...
/// Animated lte_plus_mobiledata icon from Google Material Icons
class MconLtePlusMobiledata extends MconBase {
  const MconLtePlusMobiledata({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconLtePlusMobiledata> createState() =>
      _MconLtePlusMobiledataState();
}

class _MconLtePlusMobiledataState extends MconBaseState<MconLtePlusMobiledata> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLtePlusMobiledataPainter(
      animation: animation,
...
class _MconLtePlusMobiledataPainter extends MconPainter {
  _MconLtePlusMobiledataPainter({
