...
/// Animated mood_bad icon from Google Material Icons
class MconMoodBad extends MconBase {
  const MconMoodBad({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconMoodBad> createState() => _MconMoodBadState();
}

class _MconMoodBadState extends MconBaseState<MconMoodBad> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMoodBadPainter(
      animation: animation,
...
class _MconMoodBadPainter extends MconPainter {
  _MconMoodBadPainter({
