...
/// Animated auto_read_pause icon from Google Material Icons
class MconAutoReadPause extends MconBase {
  const MconAutoReadPause({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconAutoReadPause> createState() => _MconAutoReadPauseState();
}

class _MconAutoReadPauseState extends MconBaseState<MconAutoReadPause> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAutoReadPausePainter(
      animation: animation,
...
class _MconAutoReadPausePainter extends MconPainter {
  _MconAutoReadPausePainter({
