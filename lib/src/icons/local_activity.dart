...
/// Animated local_activity icon from Google Material Icons
class MconLocalActivity extends MconBase {
  const MconLocalActivity({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconLocalActivity> createState() => _MconLocalActivityState();
}

class _MconLocalActivityState extends MconBaseState<MconLocalActivity> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLocalActivityPainter(
      animation: animation,
...
class _MconLocalActivityPainter extends MconPainter {
  _MconLocalActivityPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.moveTo(x(368.0), y(-320.0));
    path.lineTo(x(480.0), y(-404.0));
    path.lineTo(x(590.0), y(-320.0));
    path.lineTo(x(548.0), y(-456.0));
    path.lineTo(x(660.0), y(-544.0));
    path.lineTo(x(524.0), y(-544.0));
    path.lineTo(x(480.0), y(-680.0));
    path.lineTo(x(436.0), y(-544.0));
    path.lineTo(x(300.0), y(-544.0));
    path.lineTo(x(410.0), y(-456.0));
    path.lineTo(x(368.0), y(-320.0));
    path.close();
