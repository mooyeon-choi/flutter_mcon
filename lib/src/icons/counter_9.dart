...
/// Animated counter_9 icon from Google Material Icons
class MconCounter9 extends MconBase {
  const MconCounter9({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCounter9> createState() => _MconCounter9State();
}

class _MconCounter9State extends MconBaseState<MconCounter9> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCounter9Painter(
      animation: animation,
...
class _MconCounter9Painter extends MconPainter {
  _MconCounter9Painter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(360.0), y(-487.0), x(383.5), y(-463.5));
    path.quadraticBezierTo(x(407.0), y(-440.0), x(440.0), y(-440.0));
