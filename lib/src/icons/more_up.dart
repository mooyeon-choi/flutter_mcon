...
/// Animated more_up icon from Google Material Icons
class MconMoreUp extends MconBase {
  const MconMoreUp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconMoreUp> createState() => _MconMoreUpState();
}

class _MconMoreUpState extends MconBaseState<MconMoreUp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMoreUpPainter(
      animation: animation,
...
class _MconMoreUpPainter extends MconPainter {
  _MconMoreUpPainter({
