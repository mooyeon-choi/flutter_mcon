...
/// Animated add_call icon from Google Material Icons
class MconAddCall extends MconBase {
  const MconAddCall({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconAddCall> createState() => _MconAddCallState();
}

class _MconAddCallState extends MconBaseState<MconAddCall> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAddCallPainter(
      animation: animation,
...
class _MconAddCallPainter extends MconPainter {
  _MconAddCallPainter({
