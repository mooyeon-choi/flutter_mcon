...
/// Animated contextual_token_add icon from Google Material Icons
class MconContextualTokenAdd extends MconBase {
  const MconContextualTokenAdd({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconContextualTokenAddPainter extends MconPainter {
  _MconContextualTokenAddPainter({
