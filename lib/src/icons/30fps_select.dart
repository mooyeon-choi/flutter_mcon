...
/// Animated 30fps_select icon from Google Material Icons
class Mcon30fpsSelect extends MconBase {
  const Mcon30fpsSelect({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<Mcon30fpsSelect> createState() => _Mcon30fpsSelectState();
}

class _Mcon30fpsSelectState extends MconBaseState<Mcon30fpsSelect> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon30fpsSelectPainter(
      animation: animation,
...
class _Mcon30fpsSelectPainter extends MconPainter {
  _Mcon30fpsSelectPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(440.0), y(-634.0), x(423.0), y(-617.0));
    path.quadraticBezierTo(x(406.0), y(-600.0), x(380.0), y(-600.0));
    path.quadraticBezierTo(x(406.0), y(-600.0), x(423.0), y(-583.0));
    path.quadraticBezierTo(x(440.0), y(-566.0), x(440.0), y(-540.0));
