...
/// Animated local_police icon from Google Material Icons
class MconLocalPolice extends MconBase {
  const MconLocalPolice({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconLocalPolice> createState() => _MconLocalPoliceState();
}

class _MconLocalPoliceState extends MconBaseState<MconLocalPolice> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLocalPolicePainter(
      animation: animation,
...
class _MconLocalPolicePainter extends MconPainter {
  _MconLocalPolicePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.moveTo(x(368.0), y(-336.0));
    path.lineTo(x(480.0), y(-420.0));
    path.lineTo(x(590.0), y(-336.0));
    path.lineTo(x(548.0), y(-472.0));
    path.lineTo(x(660.0), y(-560.0));
    path.lineTo(x(524.0), y(-560.0));
    path.lineTo(x(480.0), y(-696.0));
    path.lineTo(x(436.0), y(-560.0));
    path.lineTo(x(300.0), y(-560.0));
    path.lineTo(x(410.0), y(-472.0));
    path.lineTo(x(368.0), y(-336.0));
    path.close();
