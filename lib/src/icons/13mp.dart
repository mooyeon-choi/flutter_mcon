...
/// Animated 13mp icon from Google Material Icons
class Mcon13mp extends MconBase {
  const Mcon13mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon13mp> createState() => _Mcon13mpState();
}

class _Mcon13mpState extends MconBaseState<Mcon13mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon13mpPainter(
      animation: animation,
...
class _Mcon13mpPainter extends MconPainter {
  _Mcon13mpPainter({
