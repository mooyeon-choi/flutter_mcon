...
/// Animated filter_frames icon from Google Material Icons
class MconFilterFrames extends MconBase {
  const MconFilterFrames({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconFilterFrames> createState() => _MconFilterFramesState();
}

class _MconFilterFramesState extends MconBaseState<MconFilterFrames> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFilterFramesPainter(
      animation: animation,
...
class _MconFilterFramesPainter extends MconPainter {
  _MconFilterFramesPainter({
