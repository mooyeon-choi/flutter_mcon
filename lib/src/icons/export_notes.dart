...
/// Animated export_notes icon from Google Material Icons
class MconExportNotes extends MconBase {
  const MconExportNotes({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconExportNotes> createState() => _MconExportNotesState();
}

class _MconExportNotesState extends MconBaseState<MconExportNotes> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconExportNotesPainter(
      animation: animation,
...
class _MconExportNotesPainter extends MconPainter {
  _MconExportNotesPainter({
