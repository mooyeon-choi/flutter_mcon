...
/// Animated pinboard icon from Google Material Icons
class MconPinboard extends MconBase {
  const MconPinboard({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconPinboard> createState() => _MconPinboardState();
}

class _MconPinboardState extends MconBaseState<MconPinboard> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPinboardPainter(
      animation: animation,
...
class _MconPinboardPainter extends MconPainter {
  _MconPinboardPainter({
