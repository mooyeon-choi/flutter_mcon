...
/// Animated qr_code_2_add icon from Google Material Icons
class MconQrCode2Add extends MconBase {
  const MconQrCode2Add({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconQrCode2Add> createState() => _MconQrCode2AddState();
}

class _MconQrCode2AddState extends MconBaseState<MconQrCode2Add> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconQrCode2AddPainter(
      animation: animation,
...
class _MconQrCode2AddPainter extends MconPainter {
  _MconQrCode2AddPainter({
