...
/// Animated deployed_code_alert icon from Google Material Icons
class MconDeployedCodeAlert extends MconBase {
  const MconDeployedCodeAlert({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDeployedCodeAlert> createState() =>
      _MconDeployedCodeAlertState();
}

class _MconDeployedCodeAlertState extends MconBaseState<MconDeployedCodeAlert> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDeployedCodeAlertPainter(
      animation: animation,
...
class _MconDeployedCodeAlertPainter extends MconPainter {
  _MconDeployedCodeAlertPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(728.0), y(-80.0), x(734.0), y(-86.0));
    path.quadraticBezierTo(x(740.0), y(-92.0), x(740.0), y(-100.0));
    path.quadraticBezierTo(x(740.0), y(-108.0), x(734.0), y(-114.0));
    path.quadraticBezierTo(x(728.0), y(-120.0), x(720.0), y(-120.0));
    path.quadraticBezierTo(x(712.0), y(-120.0), x(706.0), y(-114.0));
    path.quadraticBezierTo(x(700.0), y(-108.0), x(700.0), y(-100.0));
    path.quadraticBezierTo(x(700.0), y(-92.0), x(706.0), y(-86.0));
    path.quadraticBezierTo(x(712.0), y(-80.0), x(720.0), y(-80.0));
    path.close();
