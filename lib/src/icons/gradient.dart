...
/// Animated gradient icon from Google Material Icons
class MconGradient extends MconBase {
  const MconGradient({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconGradient> createState() => _MconGradientState();
}

class _MconGradientState extends MconBaseState<MconGradient> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconGradientPainter(
      animation: animation,
...
class _MconGradientPainter extends MconPainter {
  _MconGradientPainter({
