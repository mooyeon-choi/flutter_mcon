...
/// Animated 18mp icon from Google Material Icons
class Mcon18mp extends MconBase {
  const Mcon18mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon18mp> createState() => _Mcon18mpState();
}

class _Mcon18mpState extends MconBaseState<Mcon18mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon18mpPainter(
      animation: animation,
...
class _Mcon18mpPainter extends MconPainter {
  _Mcon18mpPainter({
