...
/// Animated clear_day icon from Google Material Icons
class MconClearDay extends MconBase {
  const MconClearDay({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconClearDay> createState() => _MconClearDayState();
}

class _MconClearDayState extends MconBaseState<MconClearDay> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconClearDayPainter(
      animation: animation,
...
class _MconClearDayPainter extends MconPainter {
  _MconClearDayPainter({
