...
/// Animated 3k icon from Google Material Icons
class Mcon3k extends MconBase {
  const Mcon3k({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon3k> createState() => _Mcon3kState();
}

class _Mcon3kState extends MconBaseState<Mcon3k> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon3kPainter(
      animation: animation,
...
class _Mcon3kPainter extends MconPainter {
  _Mcon3kPainter({
