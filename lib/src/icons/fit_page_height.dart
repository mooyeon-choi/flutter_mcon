...
/// Animated fit_page_height icon from Google Material Icons
class MconFitPageHeight extends MconBase {
  const MconFitPageHeight({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconFitPageHeight> createState() => _MconFitPageHeightState();
}

class _MconFitPageHeightState extends MconBaseState<MconFitPageHeight> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFitPageHeightPainter(
      animation: animation,
...
class _MconFitPageHeightPainter extends MconPainter {
  _MconFitPageHeightPainter({
