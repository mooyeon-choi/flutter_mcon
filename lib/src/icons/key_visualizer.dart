...
/// Animated key_visualizer icon from Google Material Icons
class MconKeyVisualizer extends MconBase {
  const MconKeyVisualizer({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconKeyVisualizer> createState() => _MconKeyVisualizerState();
}

class _MconKeyVisualizerState extends MconBaseState<MconKeyVisualizer> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconKeyVisualizerPainter(
      animation: animation,
...
class _MconKeyVisualizerPainter extends MconPainter {
  _MconKeyVisualizerPainter({
