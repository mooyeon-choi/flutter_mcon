...
/// Animated do_not_disturb_on_total_silence icon from Google Material Icons
class MconDoNotDisturbOnTotalSilence extends MconBase {
  const MconDoNotDisturbOnTotalSilence({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDoNotDisturbOnTotalSilence> createState() =>
      _MconDoNotDisturbOnTotalSilenceState();
}

class _MconDoNotDisturbOnTotalSilenceState
    extends MconBaseState<MconDoNotDisturbOnTotalSilence> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDoNotDisturbOnTotalSilencePainter(
      animation: animation,
...
class _MconDoNotDisturbOnTotalSilencePainter extends MconPainter {
  _MconDoNotDisturbOnTotalSilencePainter({
