...
/// Animated trip icon from Google Material Icons
class MconTrip extends MconBase {
  const MconTrip({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconTrip> createState() => _MconTripState();
}

class _MconTripState extends MconBaseState<MconTrip> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTripPainter(
      animation: animation,
...
class _MconTripPainter extends MconPainter {
  _MconTripPainter({
