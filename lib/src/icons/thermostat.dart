...
/// Animated thermostat icon from Google Material Icons
class MconThermostat extends MconBase {
  const MconThermostat({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconThermostat> createState() => _MconThermostatState();
}

class _MconThermostatState extends MconBaseState<MconThermostat> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconThermostatPainter(
      animation: animation,
...
class _MconThermostatPainter extends MconPainter {
  _MconThermostatPainter({
