...
/// Animated 8mp icon from Google Material Icons
class Mcon8mp extends MconBase {
  const Mcon8mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon8mp> createState() => _Mcon8mpState();
}

class _Mcon8mpState extends MconBaseState<Mcon8mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon8mpPainter(
      animation: animation,
...
class _Mcon8mpPainter extends MconPainter {
  _Mcon8mpPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.moveTo(x(440.0), y(-500.0));
    path.lineTo(x(540.0), y(-500.0));
    path.quadraticBezierTo(x(557.0), y(-500.0), x(568.5), y(-511.5));
    path.quadraticBezierTo(x(580.0), y(-523.0), x(580.0), y(-540.0));
    path.lineTo(x(580.0), y(-700.0));
    path.quadraticBezierTo(x(580.0), y(-717.0), x(568.5), y(-728.5));
    path.quadraticBezierTo(x(557.0), y(-740.0), x(540.0), y(-740.0));
    path.lineTo(x(440.0), y(-740.0));
    path.quadraticBezierTo(x(423.0), y(-740.0), x(411.5), y(-728.5));
    path.quadraticBezierTo(x(400.0), y(-717.0), x(400.0), y(-700.0));
    path.lineTo(x(400.0), y(-540.0));
    path.quadraticBezierTo(x(400.0), y(-523.0), x(411.5), y(-511.5));
    path.quadraticBezierTo(x(423.0), y(-500.0), x(440.0), y(-500.0));
    path.close();
    path.moveTo(x(460.0), y(-640.0));
    path.lineTo(x(460.0), y(-700.0));
