...
/// Animated combine_columns icon from Google Material Icons
class MconCombineColumns extends MconBase {
  const MconCombineColumns({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCombineColumns> createState() => _MconCombineColumnsState();
}

class _MconCombineColumnsState extends MconBaseState<MconCombineColumns> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCombineColumnsPainter(
      animation: animation,
...
class _MconCombineColumnsPainter extends MconPainter {
  _MconCombineColumnsPainter({
