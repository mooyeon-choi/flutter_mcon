...
/// Animated nest_thermostat_e_eu icon from Google Material Icons
class MconNestThermostatEEu extends MconBase {
  const MconNestThermostatEEu({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconNestThermostatEEu> createState() =>
      _MconNestThermostatEEuState();
}

class _MconNestThermostatEEuState extends MconBaseState<MconNestThermostatEEu> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconNestThermostatEEuPainter(
      animation: animation,
...
class _MconNestThermostatEEuPainter extends MconPainter {
  _MconNestThermostatEEuPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(311.0), y(-160.0));
    path.quadraticBezierTo(x(217.0), y(-207.0), x(158.5), y(-297.5));
    path.quadraticBezierTo(x(100.0), y(-388.0), x(100.0), y(-500.0));
    path.quadraticBezierTo(x(100.0), y(-579.0), x(130.0), y(-648.0));
    path.quadraticBezierTo(x(160.0), y(-717.0), x(211.5), y(-768.5));
    path.quadraticBezierTo(x(263.0), y(-820.0), x(332.0), y(-850.0));
    path.quadraticBezierTo(x(401.0), y(-880.0), x(480.0), y(-880.0));
    path.quadraticBezierTo(x(559.0), y(-880.0), x(628.0), y(-850.0));
    path.quadraticBezierTo(x(697.0), y(-820.0), x(748.5), y(-768.5));
    path.quadraticBezierTo(x(800.0), y(-717.0), x(830.0), y(-648.0));
    path.quadraticBezierTo(x(860.0), y(-579.0), x(860.0), y(-500.0));
    path.quadraticBezierTo(x(860.0), y(-388.0), x(801.5), y(-297.5));
    path.quadraticBezierTo(x(743.0), y(-207.0), x(649.0), y(-160.0));
    ...
    path.quadraticBezierTo(x(605.0), y(-200.0), x(692.5), y(-287.5));
    path.quadraticBezierTo(x(780.0), y(-375.0), x(780.0), y(-500.0));
    path.quadraticBezierTo(x(780.0), y(-625.0), x(692.5), y(-712.5));
    path.quadraticBezierTo(x(605.0), y(-800.0), x(480.0), y(-800.0));
    path.quadraticBezierTo(x(355.0), y(-800.0), x(267.5), y(-712.5));
    path.quadraticBezierTo(x(180.0), y(-625.0), x(180.0), y(-500.0));
    path.quadraticBezierTo(x(180.0), y(-375.0), x(267.5), y(-287.5));
    path.quadraticBezierTo(x(355.0), y(-200.0), x(480.0), y(-200.0));
    path.close();
