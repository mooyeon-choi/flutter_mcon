...
/// Animated group_add icon from Google Material Icons
class MconGroupAdd extends MconBase {
  const MconGroupAdd({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconGroupAdd> createState() => _MconGroupAddState();
}

class _MconGroupAddState extends MconBaseState<MconGroupAdd> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconGroupAddPainter(
      animation: animation,
...
class _MconGroupAddPainter extends MconPainter {
  _MconGroupAddPainter({
