...
/// Animated settings_video_camera icon from Google Material Icons
class MconSettingsVideoCamera extends MconBase {
  const MconSettingsVideoCamera({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSettingsVideoCamera> createState() =>
      _MconSettingsVideoCameraState();
}

class _MconSettingsVideoCameraState
    extends MconBaseState<MconSettingsVideoCamera> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSettingsVideoCameraPainter(
      animation: animation,
...
class _MconSettingsVideoCameraPainter extends MconPainter {
  _MconSettingsVideoCameraPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(543.0), y(-80.0), x(531.5), y(-91.5));
    path.quadraticBezierTo(x(520.0), y(-103.0), x(520.0), y(-120.0));
    ...
    path.quadraticBezierTo(x(817.0), y(-400.0), x(828.5), y(-388.5));
    path.quadraticBezierTo(x(840.0), y(-377.0), x(840.0), y(-360.0));
    ...
    path.quadraticBezierTo(x(507.0), y(-540.0), x(524.0), y(-522.5));
    path.quadraticBezierTo(x(541.0), y(-505.0), x(541.0), y(-480.0));
    path.lineTo(x(622.0), y(-480.0));
