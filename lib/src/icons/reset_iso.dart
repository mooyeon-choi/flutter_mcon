...
/// Animated reset_iso icon from Google Material Icons
class MconResetIso extends MconBase {
  const MconResetIso({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconResetIso> createState() => _MconResetIsoState();
}

class _MconResetIsoState extends MconBaseState<MconResetIso> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconResetIsoPainter(
      animation: animation,
...
class _MconResetIsoPainter extends MconPainter {
  _MconResetIsoPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.close();
    path.moveTo(x(480.0), y(-199.0));
    path.lineTo(x(480.0), y(-284.0));
    path.lineTo(x(676.0), y(-480.0));
    path.lineTo(x(761.0), y(-480.0));
    path.lineTo(x(480.0), y(-199.0));
    path.close();
    path.moveTo(x(482.0), y(-124.0));
    path.lineTo(x(835.0), y(-478.0));
    path.quadraticBezierTo(x(851.0), y(-474.0), x(862.5), y(-462.5));
    path.quadraticBezierTo(x(874.0), y(-451.0), x(878.0), y(-435.0));
    path.lineTo(x(524.0), y(-82.0));
    path.quadraticBezierTo(x(508.0), y(-87.0), x(497.5), y(-97.5));
    path.quadraticBezierTo(x(487.0), y(-108.0), x(482.0), y(-124.0));
    path.close();
    path.moveTo(x(599.0), y(-80.0));
    path.lineTo(x(880.0), y(-361.0));
    path.lineTo(x(880.0), y(-276.0));
    path.lineTo(x(684.0), y(-80.0));
