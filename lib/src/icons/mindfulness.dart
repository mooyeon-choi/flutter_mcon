...
/// Animated mindfulness icon from Google Material Icons
class MconMindfulness extends MconBase {
  const MconMindfulness({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMindfulness> createState() => _MconMindfulnessState();
}

class _MconMindfulnessState extends MconBaseState<MconMindfulness> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMindfulnessPainter(
      animation: animation,
...
class _MconMindfulnessPainter extends MconPainter {
  _MconMindfulnessPainter({
