...
/// Animated shelves icon from Google Material Icons
class MconShelves extends MconBase {
  const MconShelves({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconShelves> createState() => _MconShelvesState();
}

class _MconShelvesState extends MconBaseState<MconShelves> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconShelvesPainter(
      animation: animation,
...
class _MconShelvesPainter extends MconPainter {
  _MconShelvesPainter({
