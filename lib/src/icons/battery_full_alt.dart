...
/// Animated battery_full_alt icon from Google Material Icons
class MconBatteryFullAlt extends MconBase {
  const MconBatteryFullAlt({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryFullAlt> createState() => _MconBatteryFullAltState();
}

class _MconBatteryFullAltState extends MconBaseState<MconBatteryFullAlt> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryFullAltPainter(
      animation: animation,
...
class _MconBatteryFullAltPainter extends MconPainter {
  _MconBatteryFullAltPainter({
