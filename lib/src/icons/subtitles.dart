...
/// Animated subtitles icon from Google Material Icons
class MconSubtitles extends MconBase {
  const MconSubtitles({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconSubtitles> createState() => _MconSubtitlesState();
}

class _MconSubtitlesState extends MconBaseState<MconSubtitles> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSubtitlesPainter(
      animation: animation,
...
class _MconSubtitlesPainter extends MconPainter {
  _MconSubtitlesPainter({
