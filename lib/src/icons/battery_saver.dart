...
/// Animated battery_saver icon from Google Material Icons
class MconBatterySaver extends MconBase {
  const MconBatterySaver({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatterySaver> createState() => _MconBatterySaverState();
}

class _MconBatterySaverState extends MconBaseState<MconBatterySaver> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatterySaverPainter(
      animation: animation,
...
class _MconBatterySaverPainter extends MconPainter {
  _MconBatterySaverPainter({
