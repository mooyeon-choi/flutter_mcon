...
/// Animated switch_camera icon from Google Material Icons
class MconSwitchCamera extends MconBase {
  const MconSwitchCamera({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSwitchCamera> createState() => _MconSwitchCameraState();
}

class _MconSwitchCameraState extends MconBaseState<MconSwitchCamera> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSwitchCameraPainter(
      animation: animation,
...
class _MconSwitchCameraPainter extends MconPainter {
  _MconSwitchCameraPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(416.0), y(-336.0));
    path.lineTo(x(354.0), y(-398.0));
    path.lineTo(x(606.0), y(-398.0));
    path.lineTo(x(544.0), y(-336.0));
    path.lineTo(x(600.0), y(-280.0));
    path.lineTo(x(760.0), y(-440.0));
    path.lineTo(x(600.0), y(-600.0));
    path.lineTo(x(544.0), y(-544.0));
    path.lineTo(x(608.0), y(-478.0));
    path.lineTo(x(352.0), y(-478.0));
    path.lineTo(x(416.0), y(-544.0));
