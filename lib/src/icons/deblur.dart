...
/// Animated deblur icon from Google Material Icons
class MconDeblur extends MconBase {
  const MconDeblur({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconDeblur> createState() => _MconDeblurState();
}

class _MconDeblurState extends MconBaseState<MconDeblur> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDeblurPainter(
      animation: animation,
...
class _MconDeblurPainter extends MconPainter {
  _MconDeblurPainter({
