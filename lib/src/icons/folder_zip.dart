...
/// Animated folder_zip icon from Google Material Icons
class MconFolderZip extends MconBase {
  const MconFolderZip({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconFolderZip> createState() => _MconFolderZipState();
}

class _MconFolderZipState extends MconBaseState<MconFolderZip> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFolderZipPainter(
      animation: animation,
...
class _MconFolderZipPainter extends MconPainter {
  _MconFolderZipPainter({
