...
/// Animated content_paste_off icon from Google Material Icons
class MconContentPasteOff extends MconBase {
  const MconContentPasteOff({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconContentPasteOffState extends MconBaseState<MconContentPasteOff> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconContentPasteOffPainter(
      animation: animation,
...
class _MconContentPasteOffPainter extends MconPainter {
  _MconContentPasteOffPainter({
