...
/// Animated replay_10 icon from Google Material Icons
class MconReplay10 extends MconBase {
  const MconReplay10({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconReplay10> createState() => _MconReplay10State();
}

class _MconReplay10State extends MconBaseState<MconReplay10> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconReplay10Painter(
      animation: animation,
...
class _MconReplay10Painter extends MconPainter {
  _MconReplay10Painter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.close();
    path.moveTo(x(500.0), y(-320.0));
    path.quadraticBezierTo(x(483.0), y(-320.0), x(471.5), y(-331.5));
    path.quadraticBezierTo(x(460.0), y(-343.0), x(460.0), y(-360.0));
    path.lineTo(x(460.0), y(-520.0));
    path.quadraticBezierTo(x(460.0), y(-537.0), x(471.5), y(-548.5));
    path.quadraticBezierTo(x(483.0), y(-560.0), x(500.0), y(-560.0));
    ...
    path.quadraticBezierTo(x(620.0), y(-343.0), x(608.5), y(-331.5));
    path.quadraticBezierTo(x(597.0), y(-320.0), x(580.0), y(-320.0));
