...
/// Animated cloud_alert icon from Google Material Icons
class MconCloudAlert extends MconBase {
  const MconCloudAlert({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCloudAlert> createState() => _MconCloudAlertState();
}

class _MconCloudAlertState extends MconBaseState<MconCloudAlert> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCloudAlertPainter(
      animation: animation,
...
class _MconCloudAlertPainter extends MconPainter {
  _MconCloudAlertPainter({
