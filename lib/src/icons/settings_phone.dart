...
/// Animated settings_phone icon from Google Material Icons
class MconSettingsPhone extends MconBase {
  const MconSettingsPhone({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSettingsPhone> createState() => _MconSettingsPhoneState();
}

class _MconSettingsPhoneState extends MconBaseState<MconSettingsPhone> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSettingsPhonePainter(
      animation: animation,
...
class _MconSettingsPhonePainter extends MconPainter {
  _MconSettingsPhonePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(680.0), y(-543.0), x(668.5), y(-531.5));
