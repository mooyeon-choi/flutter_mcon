...
/// Animated align_items_stretch icon from Google Material Icons
class MconAlignItemsStretch extends MconBase {
  const MconAlignItemsStretch({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconAlignItemsStretchState extends MconBaseState<MconAlignItemsStretch> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAlignItemsStretchPainter(
      animation: animation,
...
class _MconAlignItemsStretchPainter extends MconPainter {
  _MconAlignItemsStretchPainter({
