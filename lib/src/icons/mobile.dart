...
/// Animated mobile icon from Google Material Icons
class MconMobile extends MconBase {
  const MconMobile({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconMobile> createState() => _MconMobileState();
}

class _MconMobileState extends MconBaseState<MconMobile> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMobilePainter(
      animation: animation,
...
class _MconMobilePainter extends MconPainter {
  _MconMobilePainter({
