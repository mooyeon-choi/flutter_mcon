...
/// Animated border_left icon from Google Material Icons
class MconBorderLeft extends MconBase {
  const MconBorderLeft({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBorderLeft> createState() => _MconBorderLeftState();
}

class _MconBorderLeftState extends MconBaseState<MconBorderLeft> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBorderLeftPainter(
      animation: animation,
...
class _MconBorderLeftPainter extends MconPainter {
  _MconBorderLeftPainter({
