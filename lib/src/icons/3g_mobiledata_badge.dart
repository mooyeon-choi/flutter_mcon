...
/// Animated 3g_mobiledata_badge icon from Google Material Icons
class Mcon3gMobiledataBadge extends MconBase {
  const Mcon3gMobiledataBadge({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<Mcon3gMobiledataBadge> createState() => _Mcon3gMobiledataBadgeState();
}

class _Mcon3gMobiledataBadgeState extends MconBaseState<Mcon3gMobiledataBadge> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon3gMobiledataBadgePainter(
      animation: animation,
...
class _Mcon3gMobiledataBadgePainter extends MconPainter {
  _Mcon3gMobiledataBadgePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(440.0), y(-445.0), x(422.5), y(-462.5));
    path.quadraticBezierTo(x(405.0), y(-480.0), x(380.0), y(-480.0));
