...
/// Animated print icon from Google Material Icons
class MconPrint extends MconBase {
  const MconPrint({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconPrint> createState() => _MconPrintState();
}

class _MconPrintState extends MconBaseState<MconPrint> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPrintPainter(
      animation: animation,
...
class _MconPrintPainter extends MconPainter {
  _MconPrintPainter({
