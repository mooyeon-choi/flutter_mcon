...
/// Animated forward_30 icon from Google Material Icons
class MconForward30 extends MconBase {
  const MconForward30({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconForward30> createState() => _MconForward30State();
}

class _MconForward30State extends MconBaseState<MconForward30> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconForward30Painter(
      animation: animation,
...
class _MconForward30Painter extends MconPainter {
  _MconForward30Painter({
