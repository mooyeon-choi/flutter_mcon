...
/// Animated splitscreen icon from Google Material Icons
class MconSplitscreen extends MconBase {
  const MconSplitscreen({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSplitscreen> createState() => _MconSplitscreenState();
}

class _MconSplitscreenState extends MconBaseState<MconSplitscreen> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSplitscreenPainter(
      animation: animation,
...
class _MconSplitscreenPainter extends MconPainter {
  _MconSplitscreenPainter({
