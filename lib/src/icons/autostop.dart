...
/// Animated autostop icon from Google Material Icons
class MconAutostop extends MconBase {
  const MconAutostop({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconAutostop> createState() => _MconAutostopState();
}

class _MconAutostopState extends MconBaseState<MconAutostop> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAutostopPainter(
      animation: animation,
...
class _MconAutostopPainter extends MconPainter {
  _MconAutostopPainter({
