...
/// Animated filter_tilt_shift icon from Google Material Icons
class MconFilterTiltShift extends MconBase {
  const MconFilterTiltShift({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconFilterTiltShift> createState() =>
      _MconFilterTiltShiftState();
}

class _MconFilterTiltShiftState extends MconBaseState<MconFilterTiltShift> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFilterTiltShiftPainter(
      animation: animation,
...
class _MconFilterTiltShiftPainter extends MconPainter {
  _MconFilterTiltShiftPainter({
