...
/// Animated 3g_mobiledata icon from Google Material Icons
class Mcon3gMobiledata extends MconBase {
  const Mcon3gMobiledata({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<Mcon3gMobiledata> createState() => _Mcon3gMobiledataState();
}

class _Mcon3gMobiledataState extends MconBaseState<Mcon3gMobiledata> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon3gMobiledataPainter(
      animation: animation,
...
class _Mcon3gMobiledataPainter extends MconPainter {
  _Mcon3gMobiledataPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(400.0), y(-515.0), x(382.5), y(-497.5));
