...
/// Animated photo_size_select_small icon from Google Material Icons
class MconPhotoSizeSelectSmall extends MconBase {
  const MconPhotoSizeSelectSmall({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPhotoSizeSelectSmall> createState() =>
      _MconPhotoSizeSelectSmallState();
}

class _MconPhotoSizeSelectSmallState
    extends MconBaseState<MconPhotoSizeSelectSmall> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPhotoSizeSelectSmallPainter(
      animation: animation,
...
class _MconPhotoSizeSelectSmallPainter extends MconPainter {
  _MconPhotoSizeSelectSmallPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(376.0), y(-340.0));
    path.lineTo(x(300.0), y(-240.0));
    path.lineTo(x(244.0), y(-314.0));
