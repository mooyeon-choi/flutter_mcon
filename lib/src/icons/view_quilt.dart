...
/// Animated view_quilt icon from Google Material Icons
class MconViewQuilt extends MconBase {
  const MconViewQuilt({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconViewQuilt> createState() => _MconViewQuiltState();
}

class _MconViewQuiltState extends MconBaseState<MconViewQuilt> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconViewQuiltPainter(
      animation: animation,
...
class _MconViewQuiltPainter extends MconPainter {
  _MconViewQuiltPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(547.0), y(-280.0));
    path.lineTo(x(547.0), y(-440.0));
