...
/// Animated border_horizontal icon from Google Material Icons
class MconBorderHorizontal extends MconBase {
  const MconBorderHorizontal({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconBorderHorizontalState extends MconBaseState<MconBorderHorizontal> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBorderHorizontalPainter(
      animation: animation,
...
class _MconBorderHorizontalPainter extends MconPainter {
  _MconBorderHorizontalPainter({
