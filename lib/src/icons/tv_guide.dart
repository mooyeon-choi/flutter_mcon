...
/// Animated tv_guide icon from Google Material Icons
class MconTvGuide extends MconBase {
  const MconTvGuide({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconTvGuide> createState() => _MconTvGuideState();
}

class _MconTvGuideState extends MconBaseState<MconTvGuide> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTvGuidePainter(
      animation: animation,
...
class _MconTvGuidePainter extends MconPainter {
  _MconTvGuidePainter({
