...
/// Animated settings_alert icon from Google Material Icons
class MconSettingsAlert extends MconBase {
  const MconSettingsAlert({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSettingsAlert> createState() => _MconSettingsAlertState();
}

class _MconSettingsAlertState extends MconBaseState<MconSettingsAlert> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSettingsAlertPainter(
      animation: animation,
...
class _MconSettingsAlertPainter extends MconPainter {
  _MconSettingsAlertPainter({
