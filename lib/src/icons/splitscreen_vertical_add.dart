...
/// Animated splitscreen_vertical_add icon from Google Material Icons
class MconSplitscreenVerticalAdd extends MconBase {
  const MconSplitscreenVerticalAdd({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSplitscreenVerticalAdd> createState() =>
      _MconSplitscreenVerticalAddState();
}

class _MconSplitscreenVerticalAddState
    extends MconBaseState<MconSplitscreenVerticalAdd> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSplitscreenVerticalAddPainter(
      animation: animation,
...
class _MconSplitscreenVerticalAddPainter extends MconPainter {
  _MconSplitscreenVerticalAddPainter({
