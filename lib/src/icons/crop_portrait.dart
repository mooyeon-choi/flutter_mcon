...
/// Animated crop_portrait icon from Google Material Icons
class MconCropPortrait extends MconBase {
  const MconCropPortrait({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCropPortrait> createState() => _MconCropPortraitState();
}

class _MconCropPortraitState extends MconBaseState<MconCropPortrait> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCropPortraitPainter(
      animation: animation,
...
class _MconCropPortraitPainter extends MconPainter {
  _MconCropPortraitPainter({
