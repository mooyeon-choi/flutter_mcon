...
/// Animated event_upcoming icon from Google Material Icons
class MconEventUpcoming extends MconBase {
  const MconEventUpcoming({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconEventUpcoming> createState() => _MconEventUpcomingState();
}

class _MconEventUpcomingState extends MconBaseState<MconEventUpcoming> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconEventUpcomingPainter(
      animation: animation,
...
class _MconEventUpcomingPainter extends MconPainter {
  _MconEventUpcomingPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(264.0), y(-56.0));
    path.lineTo(x(367.0), y(-160.0));
    path.lineTo(x(40.0), y(-160.0));
    path.lineTo(x(40.0), y(-240.0));
    path.lineTo(x(367.0), y(-240.0));
    path.lineTo(x(264.0), y(-344.0));
    path.lineTo(x(320.0), y(-400.0));
    path.lineTo(x(520.0), y(-200.0));
    path.lineTo(x(320.0), y(0.0));
    path.close();
