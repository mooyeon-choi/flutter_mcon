...
/// Animated battery_charging_20 icon from Google Material Icons
class MconBatteryCharging20 extends MconBase {
  const MconBatteryCharging20({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryCharging20> createState() => _MconBatteryCharging20State();
}

class _MconBatteryCharging20State extends MconBaseState<MconBatteryCharging20> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryCharging20Painter(
      animation: animation,
...
class _MconBatteryCharging20Painter extends MconPainter {
  _MconBatteryCharging20Painter({
