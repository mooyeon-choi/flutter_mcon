...
/// Animated watch_check icon from Google Material Icons
class MconWatchCheck extends MconBase {
  const MconWatchCheck({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconWatchCheck> createState() => _MconWatchCheckState();
}

class _MconWatchCheckState extends MconBaseState<MconWatchCheck> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWatchCheckPainter(
      animation: animation,
...
class _MconWatchCheckPainter extends MconPainter {
  _MconWatchCheckPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(420.0), y(-160.0));
    path.close();
    path.moveTo(x(438.0), y(-353.0));
    path.lineTo(x(324.0), y(-466.0));
    path.lineTo(x(381.0), y(-522.0));
    path.lineTo(x(438.0), y(-466.0));
    path.lineTo(x(579.0), y(-607.0));
    path.lineTo(x(636.0), y(-551.0));
    path.lineTo(x(438.0), y(-353.0));
    path.close();
