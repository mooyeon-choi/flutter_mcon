...
/// Animated keyboard_keys icon from Google Material Icons
class MconKeyboardKeys extends MconBase {
  const MconKeyboardKeys({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconKeyboardKeys> createState() => _MconKeyboardKeysState();
}

class _MconKeyboardKeysState extends MconBaseState<MconKeyboardKeys> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconKeyboardKeysPainter(
      animation: animation,
...
class _MconKeyboardKeysPainter extends MconPainter {
  _MconKeyboardKeysPainter({
