...
/// Animated flip icon from Google Material Icons
class MconFlip extends MconBase {
  const MconFlip({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconFlip> createState() => _MconFlipState();
}

class _MconFlipState extends MconBaseState<MconFlip> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFlipPainter(
      animation: animation,
...
class _MconFlipPainter extends MconPainter {
  _MconFlipPainter({
