...
/// Animated tag icon from Google Material Icons
class MconTag extends MconBase {
  const MconTag({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconTag> createState() => _MconTagState();
}

class _MconTagState extends MconBaseState<MconTag> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTagPainter(
      animation: animation,
...
class _MconTagPainter extends MconPainter {
  _MconTagPainter({
