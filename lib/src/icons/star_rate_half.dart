...
/// Animated star_rate_half icon from Google Material Icons
class MconStarRateHalf extends MconBase {
  const MconStarRateHalf({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconStarRateHalf> createState() => _MconStarRateHalfState();
}

class _MconStarRateHalfState extends MconBaseState<MconStarRateHalf> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconStarRateHalfPainter(
      animation: animation,
...
class _MconStarRateHalfPainter extends MconPainter {
  _MconStarRateHalfPainter({
