...
/// Animated wysiwyg icon from Google Material Icons
class MconWysiwyg extends MconBase {
  const MconWysiwyg({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconWysiwyg> createState() => _MconWysiwygState();
}

class _MconWysiwygState extends MconBaseState<MconWysiwyg> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWysiwygPainter(
      animation: animation,
...
class _MconWysiwygPainter extends MconPainter {
  _MconWysiwygPainter({
