...
/// Animated counter_5 icon from Google Material Icons
class MconCounter5 extends MconBase {
  const MconCounter5({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCounter5> createState() => _MconCounter5State();
}

class _MconCounter5State extends MconBaseState<MconCounter5> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCounter5Painter(
      animation: animation,
...
class _MconCounter5Painter extends MconPainter {
  _MconCounter5Painter({
