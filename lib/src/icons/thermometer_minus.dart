...
/// Animated thermometer_minus icon from Google Material Icons
class MconThermometerMinus extends MconBase {
  const MconThermometerMinus({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconThermometerMinus> createState() =>
      _MconThermometerMinusState();
}

class _MconThermometerMinusState extends MconBaseState<MconThermometerMinus> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconThermometerMinusPainter(
      animation: animation,
...
class _MconThermometerMinusPainter extends MconPainter {
  _MconThermometerMinusPainter({
