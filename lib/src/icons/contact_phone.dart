...
/// Animated contact_phone icon from Google Material Icons
class MconContactPhone extends MconBase {
  const MconContactPhone({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconContactPhone> createState() => _MconContactPhoneState();
}

class _MconContactPhoneState extends MconBaseState<MconContactPhone> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconContactPhonePainter(
      animation: animation,
...
class _MconContactPhonePainter extends MconPainter {
  _MconContactPhonePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(714.0), y(-400.0));
    path.quadraticBezierTo(x(708.0), y(-418.0), x(704.0), y(-438.5));
    path.quadraticBezierTo(x(700.0), y(-459.0), x(700.0), y(-480.0));
    path.quadraticBezierTo(x(700.0), y(-501.0), x(704.0), y(-520.5));
    path.quadraticBezierTo(x(708.0), y(-540.0), x(714.0), y(-560.0));
    path.lineTo(x(780.0), y(-560.0));
    path.lineTo(x(840.0), y(-640.0));
    path.lineTo(x(760.0), y(-720.0));
    path.quadraticBezierTo(x(706.0), y(-678.0), x(673.0), y(-613.5));
    path.quadraticBezierTo(x(640.0), y(-549.0), x(640.0), y(-480.0));
    path.quadraticBezierTo(x(640.0), y(-411.0), x(673.0), y(-346.5));
    path.quadraticBezierTo(x(706.0), y(-282.0), x(760.0), y(-240.0));
    path.close();
