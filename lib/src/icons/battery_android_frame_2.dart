...
/// Animated battery_android_frame_2 icon from Google Material Icons
class MconBatteryAndroidFrame2 extends MconBase {
  const MconBatteryAndroidFrame2({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryAndroidFrame2> createState() => _MconBatteryAndroidFrame2State();
}

class _MconBatteryAndroidFrame2State extends MconBaseState<MconBatteryAndroidFrame2> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryAndroidFrame2Painter(
      animation: animation,
...
class _MconBatteryAndroidFrame2Painter extends MconPainter {
  _MconBatteryAndroidFrame2Painter({
