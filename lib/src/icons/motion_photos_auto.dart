...
/// Animated motion_photos_auto icon from Google Material Icons
class MconMotionPhotosAuto extends MconBase {
  const MconMotionPhotosAuto({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMotionPhotosAuto> createState() =>
      _MconMotionPhotosAutoState();
}

class _MconMotionPhotosAutoState extends MconBaseState<MconMotionPhotosAuto> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMotionPhotosAutoPainter(
      animation: animation,
...
class _MconMotionPhotosAutoPainter extends MconPainter {
  _MconMotionPhotosAutoPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.moveTo(x(332.0), y(-340.0));
    path.lineTo(x(386.0), y(-340.0));
    path.lineTo(x(416.0), y(-422.0));
    path.lineTo(x(544.0), y(-422.0));
    path.lineTo(x(574.0), y(-340.0));
    path.lineTo(x(630.0), y(-340.0));
    path.lineTo(x(508.0), y(-660.0));
    path.lineTo(x(452.0), y(-660.0));
    path.lineTo(x(332.0), y(-340.0));
    path.close();
    path.moveTo(x(432.0), y(-468.0));
    path.lineTo(x(478.0), y(-600.0));
    path.lineTo(x(482.0), y(-600.0));
    path.lineTo(x(528.0), y(-468.0));
    path.lineTo(x(432.0), y(-468.0));
    path.close();
