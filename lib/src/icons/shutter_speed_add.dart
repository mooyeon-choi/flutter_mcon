...
/// Animated shutter_speed_add icon from Google Material Icons
class MconShutterSpeedAdd extends MconBase {
  const MconShutterSpeedAdd({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconShutterSpeedAdd> createState() =>
      _MconShutterSpeedAddState();
}

class _MconShutterSpeedAddState extends MconBaseState<MconShutterSpeedAdd> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconShutterSpeedAddPainter(
      animation: animation,
...
class _MconShutterSpeedAddPainter extends MconPainter {
  _MconShutterSpeedAddPainter({
