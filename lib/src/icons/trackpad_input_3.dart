...
/// Animated trackpad_input_3 icon from Google Material Icons
class MconTrackpadInput3 extends MconBase {
  const MconTrackpadInput3({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconTrackpadInput3> createState() => _MconTrackpadInput3State();
}

class _MconTrackpadInput3State extends MconBaseState<MconTrackpadInput3> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTrackpadInput3Painter(
      animation: animation,
...
class _MconTrackpadInput3Painter extends MconPainter {
  _MconTrackpadInput3Painter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(720.0), y(-617.0), x(731.5), y(-628.5));
    path.quadraticBezierTo(x(743.0), y(-640.0), x(760.0), y(-640.0));
    path.quadraticBezierTo(x(777.0), y(-640.0), x(788.5), y(-628.5));
