...
/// Animated line_weight icon from Google Material Icons
class MconLineWeight extends MconBase {
  const MconLineWeight({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconLineWeight> createState() => _MconLineWeightState();
}

class _MconLineWeightState extends MconBaseState<MconLineWeight> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLineWeightPainter(
      animation: animation,
...
class _MconLineWeightPainter extends MconPainter {
  _MconLineWeightPainter({
