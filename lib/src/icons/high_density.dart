...
/// Animated high_density icon from Google Material Icons
class MconHighDensity extends MconBase {
  const MconHighDensity({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconHighDensity> createState() => _MconHighDensityState();
}

class _MconHighDensityState extends MconBaseState<MconHighDensity> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHighDensityPainter(
      animation: animation,
...
class _MconHighDensityPainter extends MconPainter {
  _MconHighDensityPainter({
