...
/// Animated data_saver_on icon from Google Material Icons
class MconDataSaverOn extends MconBase {
  const MconDataSaverOn({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDataSaverOn> createState() => _MconDataSaverOnState();
}

class _MconDataSaverOnState extends MconBaseState<MconDataSaverOn> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDataSaverOnPainter(
      animation: animation,
...
class _MconDataSaverOnPainter extends MconPainter {
  _MconDataSaverOnPainter({
