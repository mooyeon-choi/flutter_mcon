...
/// Animated motion_blur icon from Google Material Icons
class MconMotionBlur extends MconBase {
  const MconMotionBlur({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMotionBlur> createState() => _MconMotionBlurState();
}

class _MconMotionBlurState extends MconBaseState<MconMotionBlur> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMotionBlurPainter(
      animation: animation,
...
class _MconMotionBlurPainter extends MconPainter {
  _MconMotionBlurPainter({
