...
/// Animated signal_cellular_connected_no_internet_4_bar icon from Google Material Icons
class MconSignalCellularConnectedNoInternet4Bar extends MconBase {
  const MconSignalCellularConnectedNoInternet4Bar({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSignalCellularConnectedNoInternet4Bar> createState() =>
      _MconSignalCellularConnectedNoInternet4BarState();
}

class _MconSignalCellularConnectedNoInternet4BarState
    extends MconBaseState<MconSignalCellularConnectedNoInternet4Bar> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSignalCellularConnectedNoInternet4BarPainter(
      animation: animation,
...
class _MconSignalCellularConnectedNoInternet4BarPainter extends MconPainter {
  _MconSignalCellularConnectedNoInternet4BarPainter({
