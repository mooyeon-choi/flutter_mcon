...
/// Animated alarm_smart_wake icon from Google Material Icons
class MconAlarmSmartWake extends MconBase {
  const MconAlarmSmartWake({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconAlarmSmartWake> createState() => _MconAlarmSmartWakeState();
}

class _MconAlarmSmartWakeState extends MconBaseState<MconAlarmSmartWake> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAlarmSmartWakePainter(
      animation: animation,
...
class _MconAlarmSmartWakePainter extends MconPainter {
  _MconAlarmSmartWakePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(360.0), y(-457.0), x(348.5), y(-468.5));
    path.quadraticBezierTo(x(337.0), y(-480.0), x(320.0), y(-480.0));
    path.quadraticBezierTo(x(303.0), y(-480.0), x(291.5), y(-468.5));
    ...
    path.quadraticBezierTo(x(680.0), y(-457.0), x(668.5), y(-468.5));
    path.quadraticBezierTo(x(657.0), y(-480.0), x(640.0), y(-480.0));
    path.quadraticBezierTo(x(623.0), y(-480.0), x(611.5), y(-468.5));
