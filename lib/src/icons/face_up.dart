...
/// Animated face_up icon from Google Material Icons
class MconFaceUp extends MconBase {
  const MconFaceUp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconFaceUp> createState() => _MconFaceUpState();
}

class _MconFaceUpState extends MconBaseState<MconFaceUp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFaceUpPainter(
      animation: animation,
...
class _MconFaceUpPainter extends MconPainter {
  _MconFaceUpPainter({
