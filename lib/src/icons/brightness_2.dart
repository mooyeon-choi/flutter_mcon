...
/// Animated brightness_2 icon from Google Material Icons
class MconBrightness2 extends MconBase {
  const MconBrightness2({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBrightness2> createState() => _MconBrightness2State();
}

class _MconBrightness2State extends MconBaseState<MconBrightness2> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBrightness2Painter(
      animation: animation,
...
class _MconBrightness2Painter extends MconPainter {
  _MconBrightness2Painter({
