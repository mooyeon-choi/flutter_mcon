...
/// Animated memory_alt icon from Google Material Icons
class MconMemoryAlt extends MconBase {
  const MconMemoryAlt({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconMemoryAlt> createState() => _MconMemoryAltState();
}

class _MconMemoryAltState extends MconBaseState<MconMemoryAlt> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMemoryAltPainter(
      animation: animation,
...
class _MconMemoryAltPainter extends MconPainter {
  _MconMemoryAltPainter({
