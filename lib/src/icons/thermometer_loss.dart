...
/// Animated thermometer_loss icon from Google Material Icons
class MconThermometerLoss extends MconBase {
  const MconThermometerLoss({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconThermometerLoss> createState() =>
      _MconThermometerLossState();
}

class _MconThermometerLossState extends MconBaseState<MconThermometerLoss> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconThermometerLossPainter(
      animation: animation,
...
class _MconThermometerLossPainter extends MconPainter {
  _MconThermometerLossPainter({
