...
/// Animated background_grid_small icon from Google Material Icons
class MconBackgroundGridSmall extends MconBase {
  const MconBackgroundGridSmall({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconBackgroundGridSmallPainter extends MconPainter {
  _MconBackgroundGridSmallPainter({
