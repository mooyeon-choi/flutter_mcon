...
/// Animated shadow icon from Google Material Icons
class MconShadow extends MconBase {
  const MconShadow({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconShadow> createState() => _MconShadowState();
}

class _MconShadowState extends MconBaseState<MconShadow> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconShadowPainter(
      animation: animation,
...
class _MconShadowPainter extends MconPainter {
  _MconShadowPainter({
