...
/// Animated help_clinic icon from Google Material Icons
class MconHelpClinic extends MconBase {
  const MconHelpClinic({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconHelpClinic> createState() => _MconHelpClinicState();
}

class _MconHelpClinicState extends MconBaseState<MconHelpClinic> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHelpClinicPainter(
      animation: animation,
...
class _MconHelpClinicPainter extends MconPainter {
  _MconHelpClinicPainter({
