...
/// Animated heap_snapshot_thumbnail icon from Google Material Icons
class MconHeapSnapshotThumbnail extends MconBase {
  const MconHeapSnapshotThumbnail({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconHeapSnapshotThumbnail> createState() =>
      _MconHeapSnapshotThumbnailState();
}

class _MconHeapSnapshotThumbnailState
    extends MconBaseState<MconHeapSnapshotThumbnail> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHeapSnapshotThumbnailPainter(
      animation: animation,
...
class _MconHeapSnapshotThumbnailPainter extends MconPainter {
  _MconHeapSnapshotThumbnailPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(445.0), y(-320.0), x(462.5), y(-337.5));
    path.quadraticBezierTo(x(480.0), y(-355.0), x(480.0), y(-380.0));
    path.quadraticBezierTo(x(480.0), y(-405.0), x(462.5), y(-422.5));
    path.quadraticBezierTo(x(445.0), y(-440.0), x(420.0), y(-440.0));
    path.quadraticBezierTo(x(395.0), y(-440.0), x(377.5), y(-422.5));
    path.quadraticBezierTo(x(360.0), y(-405.0), x(360.0), y(-380.0));
    path.quadraticBezierTo(x(360.0), y(-355.0), x(377.5), y(-337.5));
    path.quadraticBezierTo(x(395.0), y(-320.0), x(420.0), y(-320.0));
    path.close();
    path.moveTo(x(218.0), y(-322.0));
    path.lineTo(x(478.0), y(-582.0));
    path.lineTo(x(422.0), y(-638.0));
    path.lineTo(x(162.0), y(-378.0));
    path.lineTo(x(218.0), y(-322.0));
    path.close();
    path.moveTo(x(220.0), y(-520.0));
    path.quadraticBezierTo(x(245.0), y(-520.0), x(262.5), y(-537.5));
    path.quadraticBezierTo(x(280.0), y(-555.0), x(280.0), y(-580.0));
    path.quadraticBezierTo(x(280.0), y(-605.0), x(262.5), y(-622.5));
    path.quadraticBezierTo(x(245.0), y(-640.0), x(220.0), y(-640.0));
    path.quadraticBezierTo(x(195.0), y(-640.0), x(177.5), y(-622.5));
    path.quadraticBezierTo(x(160.0), y(-605.0), x(160.0), y(-580.0));
    path.quadraticBezierTo(x(160.0), y(-555.0), x(177.5), y(-537.5));
    path.quadraticBezierTo(x(195.0), y(-520.0), x(220.0), y(-520.0));
    path.close();
