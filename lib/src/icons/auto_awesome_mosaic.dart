...
/// Animated auto_awesome_mosaic icon from Google Material Icons
class MconAutoAwesomeMosaic extends MconBase {
  const MconAutoAwesomeMosaic({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconAutoAwesomeMosaicState extends MconBaseState<MconAutoAwesomeMosaic> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAutoAwesomeMosaicPainter(
      animation: animation,
...
class _MconAutoAwesomeMosaicPainter extends MconPainter {
  _MconAutoAwesomeMosaicPainter({
