...
/// Animated collections_bookmark icon from Google Material Icons
class MconCollectionsBookmark extends MconBase {
  const MconCollectionsBookmark({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconCollectionsBookmarkPainter extends MconPainter {
  _MconCollectionsBookmarkPainter({
