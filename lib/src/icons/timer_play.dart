...
/// Animated timer_play icon from Google Material Icons
class MconTimerPlay extends MconBase {
  const MconTimerPlay({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconTimerPlay> createState() => _MconTimerPlayState();
}

class _MconTimerPlayState extends MconBaseState<MconTimerPlay> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTimerPlayPainter(
      animation: animation,
...
class _MconTimerPlayPainter extends MconPainter {
  _MconTimerPlayPainter({
