...
/// Animated ods icon from Google Material Icons
class MconOds extends MconBase {
  const MconOds({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconOds> createState() => _MconOdsState();
}

class _MconOdsState extends MconBaseState<MconOds> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconOdsPainter(
      animation: animation,
...
class _MconOdsPainter extends MconPainter {
  _MconOdsPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(737.0), y(-360.0), x(748.5), y(-371.5));
    path.quadraticBezierTo(x(760.0), y(-383.0), x(760.0), y(-400.0));
    path.lineTo(x(760.0), y(-460.0));
    path.quadraticBezierTo(x(760.0), y(-477.0), x(748.5), y(-491.5));
    path.quadraticBezierTo(x(737.0), y(-506.0), x(720.0), y(-506.0));
    path.lineTo(x(660.0), y(-506.0));
    ...
    path.quadraticBezierTo(x(600.0), y(-483.0), x(611.5), y(-469.5));
    path.quadraticBezierTo(x(623.0), y(-456.0), x(640.0), y(-456.0));
    path.lineTo(x(700.0), y(-456.0));
