...
/// Animated border_vertical icon from Google Material Icons
class MconBorderVertical extends MconBase {
  const MconBorderVertical({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBorderVertical> createState() => _MconBorderVerticalState();
}

class _MconBorderVerticalState extends MconBaseState<MconBorderVertical> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBorderVerticalPainter(
      animation: animation,
...
class _MconBorderVerticalPainter extends MconPainter {
  _MconBorderVerticalPainter({
