...
/// Animated brightness_7 icon from Google Material Icons
class MconBrightness7 extends MconBase {
  const MconBrightness7({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBrightness7> createState() => _MconBrightness7State();
}

class _MconBrightness7State extends MconBaseState<MconBrightness7> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBrightness7Painter(
      animation: animation,
...
class _MconBrightness7Painter extends MconPainter {
  _MconBrightness7Painter({
