...
/// Animated tile_small icon from Google Material Icons
class MconTileSmall extends MconBase {
  const MconTileSmall({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconTileSmall> createState() => _MconTileSmallState();
}

class _MconTileSmallState extends MconBaseState<MconTileSmall> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTileSmallPainter(
      animation: animation,
...
class _MconTileSmallPainter extends MconPainter {
  _MconTileSmallPainter({
