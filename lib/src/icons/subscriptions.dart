...
/// Animated subscriptions icon from Google Material Icons
class MconSubscriptions extends MconBase {
  const MconSubscriptions({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSubscriptions> createState() => _MconSubscriptionsState();
}

class _MconSubscriptionsState extends MconBaseState<MconSubscriptions> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSubscriptionsPainter(
      animation: animation,
...
class _MconSubscriptionsPainter extends MconPainter {
  _MconSubscriptionsPainter({
