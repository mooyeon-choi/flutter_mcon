...
/// Animated post icon from Google Material Icons
class MconPost extends MconBase {
  const MconPost({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconPost> createState() => _MconPostState();
}

class _MconPostState extends MconBaseState<MconPost> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPostPainter(
      animation: animation,
...
class _MconPostPainter extends MconPainter {
  _MconPostPainter({
