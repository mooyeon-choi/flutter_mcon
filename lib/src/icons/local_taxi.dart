...
/// Animated local_taxi icon from Google Material Icons
class MconLocalTaxi extends MconBase {
  const MconLocalTaxi({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconLocalTaxi> createState() => _MconLocalTaxiState();
}

class _MconLocalTaxiState extends MconBaseState<MconLocalTaxi> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLocalTaxiPainter(
      animation: animation,
...
class _MconLocalTaxiPainter extends MconPainter {
  _MconLocalTaxiPainter({
