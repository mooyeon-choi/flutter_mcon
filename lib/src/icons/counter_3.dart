...
/// Animated counter_3 icon from Google Material Icons
class MconCounter3 extends MconBase {
  const MconCounter3({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCounter3> createState() => _MconCounter3State();
}

class _MconCounter3State extends MconBaseState<MconCounter3> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCounter3Painter(
      animation: animation,
...
class _MconCounter3Painter extends MconPainter {
  _MconCounter3Painter({
