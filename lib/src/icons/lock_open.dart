...
/// Animated lock_open icon from Google Material Icons
class MconLockOpen extends MconBase {
  const MconLockOpen({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconLockOpen> createState() => _MconLockOpenState();
}

class _MconLockOpenState extends MconBaseState<MconLockOpen> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLockOpenPainter(
      animation: animation,
...
class _MconLockOpenPainter extends MconPainter {
  _MconLockOpenPainter({
