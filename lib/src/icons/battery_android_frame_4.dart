...
/// Animated battery_android_frame_4 icon from Google Material Icons
class MconBatteryAndroidFrame4 extends MconBase {
  const MconBatteryAndroidFrame4({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryAndroidFrame4> createState() => _MconBatteryAndroidFrame4State();
}

class _MconBatteryAndroidFrame4State extends MconBaseState<MconBatteryAndroidFrame4> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryAndroidFrame4Painter(
      animation: animation,
...
class _MconBatteryAndroidFrame4Painter extends MconPainter {
  _MconBatteryAndroidFrame4Painter({
