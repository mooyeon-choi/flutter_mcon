...
/// Animated mobile_arrow_down icon from Google Material Icons
class MconMobileArrowDown extends MconBase {
  const MconMobileArrowDown({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMobileArrowDown> createState() =>
      _MconMobileArrowDownState();
}

class _MconMobileArrowDownState extends MconBaseState<MconMobileArrowDown> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMobileArrowDownPainter(
      animation: animation,
...
class _MconMobileArrowDownPainter extends MconPainter {
  _MconMobileArrowDownPainter({
