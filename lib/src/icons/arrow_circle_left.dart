...
/// Animated arrow_circle_left icon from Google Material Icons
class MconArrowCircleLeft extends MconBase {
  const MconArrowCircleLeft({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconArrowCircleLeftState extends MconBaseState<MconArrowCircleLeft> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconArrowCircleLeftPainter(
      animation: animation,
...
class _MconArrowCircleLeftPainter extends MconPainter {
  _MconArrowCircleLeftPainter({
