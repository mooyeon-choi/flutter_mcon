...
/// Animated note_add icon from Google Material Icons
class MconNoteAdd extends MconBase {
  const MconNoteAdd({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconNoteAdd> createState() => _MconNoteAddState();
}

class _MconNoteAddState extends MconBaseState<MconNoteAdd> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconNoteAddPainter(
      animation: animation,
...
class _MconNoteAddPainter extends MconPainter {
  _MconNoteAddPainter({
