...
/// Animated format_h4 icon from Google Material Icons
class MconFormatH4 extends MconBase {
  const MconFormatH4({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconFormatH4> createState() => _MconFormatH4State();
}

class _MconFormatH4State extends MconBaseState<MconFormatH4> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFormatH4Painter(
      animation: animation,
...
class _MconFormatH4Painter extends MconPainter {
  _MconFormatH4Painter({
