...
/// Animated speed_0_25 icon from Google Material Icons
class MconSpeed025 extends MconBase {
  const MconSpeed025({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconSpeed025> createState() => _MconSpeed025State();
}

class _MconSpeed025State extends MconBaseState<MconSpeed025> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSpeed025Painter(
      animation: animation,
...
class _MconSpeed025Painter extends MconPainter {
  _MconSpeed025Painter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(280.0), y(-473.0), x(303.5), y(-496.5));
    ...
    path.quadraticBezierTo(x(473.0), y(-680.0), x(496.5), y(-656.5));
    path.quadraticBezierTo(x(520.0), y(-633.0), x(520.0), y(-600.0));
    path.lineTo(x(520.0), y(-520.0));
    path.quadraticBezierTo(x(520.0), y(-487.0), x(496.5), y(-463.5));
    path.quadraticBezierTo(x(473.0), y(-440.0), x(440.0), y(-440.0));
