...
/// Animated payment_arrow_down icon from Google Material Icons
class MconPaymentArrowDown extends MconBase {
  const MconPaymentArrowDown({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPaymentArrowDown> createState() =>
      _MconPaymentArrowDownState();
}

class _MconPaymentArrowDownState extends MconBaseState<MconPaymentArrowDown> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPaymentArrowDownPainter(
      animation: animation,
...
class _MconPaymentArrowDownPainter extends MconPainter {
  _MconPaymentArrowDownPainter({
