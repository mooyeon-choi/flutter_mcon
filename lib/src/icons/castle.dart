...
/// Animated castle icon from Google Material Icons
class MconCastle extends MconBase {
  const MconCastle({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCastle> createState() => _MconCastleState();
}

class _MconCastleState extends MconBaseState<MconCastle> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCastlePainter(
      animation: animation,
...
class _MconCastlePainter extends MconPainter {
  _MconCastlePainter({
