...
/// Animated flowchart icon from Google Material Icons
class MconFlowchart extends MconBase {
  const MconFlowchart({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconFlowchart> createState() => _MconFlowchartState();
}

class _MconFlowchartState extends MconBaseState<MconFlowchart> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFlowchartPainter(
      animation: animation,
...
class _MconFlowchartPainter extends MconPainter {
  _MconFlowchartPainter({
