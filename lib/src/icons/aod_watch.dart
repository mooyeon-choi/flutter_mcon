...
/// Animated aod_watch icon from Google Material Icons
class MconAodWatch extends MconBase {
  const MconAodWatch({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconAodWatch> createState() => _MconAodWatchState();
}

class _MconAodWatchState extends MconBaseState<MconAodWatch> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAodWatchPainter(
      animation: animation,
...
class _MconAodWatchPainter extends MconPainter {
  _MconAodWatchPainter({
