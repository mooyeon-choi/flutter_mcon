...
/// Animated corporate_fare icon from Google Material Icons
class MconCorporateFare extends MconBase {
  const MconCorporateFare({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCorporateFare> createState() => _MconCorporateFareState();
}

class _MconCorporateFareState extends MconBaseState<MconCorporateFare> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCorporateFarePainter(
      animation: animation,
...
class _MconCorporateFarePainter extends MconPainter {
  _MconCorporateFarePainter({
