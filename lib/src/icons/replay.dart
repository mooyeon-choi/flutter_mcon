...
/// Animated replay icon from Google Material Icons
class MconReplay extends MconBase {
  const MconReplay({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconReplay> createState() => _MconReplayState();
}

class _MconReplayState extends MconBaseState<MconReplay> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconReplayPainter(
      animation: animation,
...
class _MconReplayPainter extends MconPainter {
  _MconReplayPainter({
