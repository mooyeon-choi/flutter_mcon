...
/// Animated planner_banner_ad_pt icon from Google Material Icons
class MconPlannerBannerAdPt extends MconBase {
  const MconPlannerBannerAdPt({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPlannerBannerAdPt> createState() =>
      _MconPlannerBannerAdPtState();
}

class _MconPlannerBannerAdPtState extends MconBaseState<MconPlannerBannerAdPt> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPlannerBannerAdPtPainter(
      animation: animation,
...
class _MconPlannerBannerAdPtPainter extends MconPainter {
  _MconPlannerBannerAdPtPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(542.0), y(-420.0));
    path.lineTo(x(450.0), y(-300.0));
    path.lineTo(x(388.0), y(-380.0));
