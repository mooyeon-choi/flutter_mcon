...
/// Animated arrows_input icon from Google Material Icons
class MconArrowsInput extends MconBase {
  const MconArrowsInput({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconArrowsInput> createState() => _MconArrowsInputState();
}

class _MconArrowsInputState extends MconBaseState<MconArrowsInput> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconArrowsInputPainter(
      animation: animation,
...
class _MconArrowsInputPainter extends MconPainter {
  _MconArrowsInputPainter({
