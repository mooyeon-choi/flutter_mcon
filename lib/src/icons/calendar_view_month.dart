...
/// Animated calendar_view_month icon from Google Material Icons
class MconCalendarViewMonth extends MconBase {
  const MconCalendarViewMonth({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconCalendarViewMonthState extends MconBaseState<MconCalendarViewMonth> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCalendarViewMonthPainter(
      animation: animation,
...
class _MconCalendarViewMonthPainter extends MconPainter {
  _MconCalendarViewMonthPainter({
