...
/// Animated widget_medium icon from Google Material Icons
class MconWidgetMedium extends MconBase {
  const MconWidgetMedium({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconWidgetMedium> createState() => _MconWidgetMediumState();
}

class _MconWidgetMediumState extends MconBaseState<MconWidgetMedium> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWidgetMediumPainter(
      animation: animation,
...
class _MconWidgetMediumPainter extends MconPainter {
  _MconWidgetMediumPainter({
