...
/// Animated reset_tv icon from Google Material Icons
class MconResetTv extends MconBase {
  const MconResetTv({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconResetTv> createState() => _MconResetTvState();
}

class _MconResetTvState extends MconBaseState<MconResetTv> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconResetTvPainter(
      animation: animation,
...
class _MconResetTvPainter extends MconPainter {
  _MconResetTvPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(512.0), y(-480.0));
    path.lineTo(x(586.0), y(-406.0));
    path.lineTo(x(530.0), y(-350.0));
    path.lineTo(x(360.0), y(-520.0));
    path.lineTo(x(530.0), y(-690.0));
    path.lineTo(x(586.0), y(-634.0));
