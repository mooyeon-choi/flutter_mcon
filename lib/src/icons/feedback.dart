...
/// Animated feedback icon from Google Material Icons
class MconFeedback extends MconBase {
  const MconFeedback({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconFeedback> createState() => _MconFeedbackState();
}

class _MconFeedbackState extends MconBaseState<MconFeedback> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFeedbackPainter(
      animation: animation,
...
class _MconFeedbackPainter extends MconPainter {
  _MconFeedbackPainter({
