...
/// Animated auto_read_play icon from Google Material Icons
class MconAutoReadPlay extends MconBase {
  const MconAutoReadPlay({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconAutoReadPlay> createState() => _MconAutoReadPlayState();
}

class _MconAutoReadPlayState extends MconBaseState<MconAutoReadPlay> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAutoReadPlayPainter(
      animation: animation,
...
class _MconAutoReadPlayPainter extends MconPainter {
  _MconAutoReadPlayPainter({
