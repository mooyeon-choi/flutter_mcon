...
/// Animated valve icon from Google Material Icons
class MconValve extends MconBase {
  const MconValve({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconValve> createState() => _MconValveState();
}

class _MconValveState extends MconBaseState<MconValve> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconValvePainter(
      animation: animation,
...
class _MconValvePainter extends MconPainter {
  _MconValvePainter({
