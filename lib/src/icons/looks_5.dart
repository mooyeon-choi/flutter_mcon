...
/// Animated looks_5 icon from Google Material Icons
class MconLooks5 extends MconBase {
  const MconLooks5({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconLooks5> createState() => _MconLooks5State();
}

class _MconLooks5State extends MconBaseState<MconLooks5> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLooks5Painter(
      animation: animation,
...
class _MconLooks5Painter extends MconPainter {
  _MconLooks5Painter({
