...
/// Animated backup_table icon from Google Material Icons
class MconBackupTable extends MconBase {
  const MconBackupTable({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBackupTable> createState() => _MconBackupTableState();
}

class _MconBackupTableState extends MconBaseState<MconBackupTable> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBackupTablePainter(
      animation: animation,
...
class _MconBackupTablePainter extends MconPainter {
  _MconBackupTablePainter({
