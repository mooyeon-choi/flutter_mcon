...
/// Animated link icon from Google Material Icons
class MconLink extends MconBase {
  const MconLink({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconLink> createState() => _MconLinkState();
}

class _MconLinkState extends MconBaseState<MconLink> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLinkPainter(
      animation: animation,
...
class _MconLinkPainter extends MconPainter {
  _MconLinkPainter({
