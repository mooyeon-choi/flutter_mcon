...
/// Animated watch_arrow icon from Google Material Icons
class MconWatchArrow extends MconBase {
  const MconWatchArrow({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconWatchArrow> createState() => _MconWatchArrowState();
}

class _MconWatchArrowState extends MconBaseState<MconWatchArrow> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWatchArrowPainter(
      animation: animation,
...
class _MconWatchArrowPainter extends MconPainter {
  _MconWatchArrowPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(424.0), y(-396.0));
    path.lineTo(x(466.0), y(-440.0));
    path.lineTo(x(340.0), y(-440.0));
    path.lineTo(x(340.0), y(-520.0));
    path.lineTo(x(466.0), y(-520.0));
    path.lineTo(x(424.0), y(-564.0));
