...
/// Animated add_location icon from Google Material Icons
class MconAddLocation extends MconBase {
  const MconAddLocation({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconAddLocation> createState() => _MconAddLocationState();
}

class _MconAddLocationState extends MconBaseState<MconAddLocation> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAddLocationPainter(
      animation: animation,
...
class _MconAddLocationPainter extends MconPainter {
  _MconAddLocationPainter({
