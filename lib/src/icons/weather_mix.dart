...
/// Animated weather_mix icon from Google Material Icons
class MconWeatherMix extends MconBase {
  const MconWeatherMix({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconWeatherMix> createState() => _MconWeatherMixState();
}

class _MconWeatherMixState extends MconBaseState<MconWeatherMix> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWeatherMixPainter(
      animation: animation,
...
class _MconWeatherMixPainter extends MconPainter {
  _MconWeatherMixPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(475.0), y(-40.0), x(457.5), y(-57.0));
    path.quadraticBezierTo(x(440.0), y(-74.0), x(440.0), y(-99.0));
    path.quadraticBezierTo(x(440.0), y(-111.0), x(444.5), y(-122.0));
    path.quadraticBezierTo(x(449.0), y(-133.0), x(458.0), y(-141.0));
    path.lineTo(x(500.0), y(-180.0));
    path.lineTo(x(542.0), y(-141.0));
    path.quadraticBezierTo(x(551.0), y(-133.0), x(555.5), y(-122.0));
    path.quadraticBezierTo(x(560.0), y(-111.0), x(560.0), y(-99.0));
    path.quadraticBezierTo(x(560.0), y(-74.0), x(542.5), y(-57.0));
    path.quadraticBezierTo(x(525.0), y(-40.0), x(500.0), y(-40.0));
    path.close();
    path.moveTo(x(362.0), y(-100.0));
    path.lineTo(x(320.0), y(-142.0));
    path.lineTo(x(438.0), y(-260.0));
    path.lineTo(x(480.0), y(-218.0));
    path.lineTo(x(362.0), y(-100.0));
    path.close();
