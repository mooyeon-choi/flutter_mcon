...
/// Animated view_comfy_alt icon from Google Material Icons
class MconViewComfyAlt extends MconBase {
  const MconViewComfyAlt({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconViewComfyAlt> createState() => _MconViewComfyAltState();
}

class _MconViewComfyAltState extends MconBaseState<MconViewComfyAlt> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconViewComfyAltPainter(
      animation: animation,
...
class _MconViewComfyAltPainter extends MconPainter {
  _MconViewComfyAltPainter({
