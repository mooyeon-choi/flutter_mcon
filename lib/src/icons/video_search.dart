...
/// Animated video_search icon from Google Material Icons
class MconVideoSearch extends MconBase {
  const MconVideoSearch({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconVideoSearch> createState() => _MconVideoSearchState();
}

class _MconVideoSearchState extends MconBaseState<MconVideoSearch> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconVideoSearchPainter(
      animation: animation,
...
class _MconVideoSearchPainter extends MconPainter {
  _MconVideoSearchPainter({
