...
/// Animated battery_android_frame_5 icon from Google Material Icons
class MconBatteryAndroidFrame5 extends MconBase {
  const MconBatteryAndroidFrame5({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBatteryAndroidFrame5> createState() => _MconBatteryAndroidFrame5State();
}

class _MconBatteryAndroidFrame5State extends MconBaseState<MconBatteryAndroidFrame5> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryAndroidFrame5Painter(
      animation: animation,
...
class _MconBatteryAndroidFrame5Painter extends MconPainter {
  _MconBatteryAndroidFrame5Painter({
