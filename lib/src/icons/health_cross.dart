...
/// Animated health_cross icon from Google Material Icons
class MconHealthCross extends MconBase {
  const MconHealthCross({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconHealthCross> createState() => _MconHealthCrossState();
}

class _MconHealthCrossState extends MconBaseState<MconHealthCross> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHealthCrossPainter(
      animation: animation,
...
class _MconHealthCrossPainter extends MconPainter {
  _MconHealthCrossPainter({
