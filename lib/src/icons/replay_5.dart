...
/// Animated replay_5 icon from Google Material Icons
class MconReplay5 extends MconBase {
  const MconReplay5({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconReplay5> createState() => _MconReplay5State();
}

class _MconReplay5State extends MconBaseState<MconReplay5> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconReplay5Painter(
      animation: animation,
...
class _MconReplay5Painter extends MconPainter {
  _MconReplay5Painter({
