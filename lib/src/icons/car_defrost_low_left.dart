...
/// Animated car_defrost_low_left icon from Google Material Icons
class MconCarDefrostLowLeft extends MconBase {
  const MconCarDefrostLowLeft({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCarDefrostLowLeft> createState() => _MconCarDefrostLowLeftState();
}

class _MconCarDefrostLowLeftState extends MconBaseState<MconCarDefrostLowLeft> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCarDefrostLowLeftPainter(
      animation: animation,
...
class _MconCarDefrostLowLeftPainter extends MconPainter {
  _MconCarDefrostLowLeftPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(722.0), y(-442.0));
    path.lineTo(x(770.0), y(-395.0));
    path.lineTo(x(770.0), y(-520.0));
    path.lineTo(x(830.0), y(-520.0));
    path.lineTo(x(830.0), y(-395.0));
    path.lineTo(x(878.0), y(-442.0));
