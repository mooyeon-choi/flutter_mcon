...
/// Animated filter_4 icon from Google Material Icons
class MconFilter4 extends MconBase {
  const MconFilter4({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconFilter4> createState() => _MconFilter4State();
}

class _MconFilter4State extends MconBaseState<MconFilter4> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFilter4Painter(
      animation: animation,
...
class _MconFilter4Painter extends MconPainter {
  _MconFilter4Painter({
