...
/// Animated 7mp icon from Google Material Icons
class Mcon7mp extends MconBase {
  const Mcon7mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon7mp> createState() => _Mcon7mpState();
}

class _Mcon7mpState extends MconBaseState<Mcon7mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon7mpPainter(
      animation: animation,
...
class _Mcon7mpPainter extends MconPainter {
  _Mcon7mpPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(578.0), y(-688.0));
    path.quadraticBezierTo(x(584.0), y(-708.0), x(572.0), y(-724.0));
    path.quadraticBezierTo(x(560.0), y(-740.0), x(540.0), y(-740.0));
    path.lineTo(x(400.0), y(-740.0));
    path.lineTo(x(400.0), y(-680.0));
    path.lineTo(x(504.0), y(-680.0));
    path.lineTo(x(450.0), y(-500.0));
    path.close();
