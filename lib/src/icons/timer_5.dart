...
/// Animated timer_5 icon from Google Material Icons
class MconTimer5 extends MconBase {
  const MconTimer5({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconTimer5> createState() => _MconTimer5State();
}

class _MconTimer5State extends MconBaseState<MconTimer5> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTimer5Painter(
      animation: animation,
...
class _MconTimer5Painter extends MconPainter {
  _MconTimer5Painter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(553.0), y(-270.0), x(576.5), y(-293.5));
    path.quadraticBezierTo(x(600.0), y(-317.0), x(600.0), y(-350.0));
    path.lineTo(x(600.0), y(-400.0));
    path.quadraticBezierTo(x(600.0), y(-433.0), x(576.5), y(-456.5));
    path.quadraticBezierTo(x(553.0), y(-480.0), x(520.0), y(-480.0));
    path.lineTo(x(440.0), y(-480.0));
    path.lineTo(x(440.0), y(-530.0));
    path.lineTo(x(600.0), y(-530.0));
    path.lineTo(x(600.0), y(-610.0));
