...
/// Animated explore_off icon from Google Material Icons
class MconExploreOff extends MconBase {
  const MconExploreOff({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconExploreOff> createState() => _MconExploreOffState();
}

class _MconExploreOffState extends MconBaseState<MconExploreOff> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconExploreOffPainter(
      animation: animation,
...
class _MconExploreOffPainter extends MconPainter {
  _MconExploreOffPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(605.0), y(-469.0));
    path.lineTo(x(469.0), y(-605.0));
    ...
    path.lineTo(x(491.0), y(-355.0));
    path.lineTo(x(300.0), y(-300.0));
    path.lineTo(x(355.0), y(-491.0));
