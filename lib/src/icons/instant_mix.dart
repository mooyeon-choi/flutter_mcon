...
/// Animated instant_mix icon from Google Material Icons
class MconInstantMix extends MconBase {
  const MconInstantMix({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconInstantMix> createState() => _MconInstantMixState();
}

class _MconInstantMixState extends MconBaseState<MconInstantMix> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconInstantMixPainter(
      animation: animation,
...
class _MconInstantMixPainter extends MconPainter {
  _MconInstantMixPainter({
