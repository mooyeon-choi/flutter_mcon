...
/// Animated tab_inactive icon from Google Material Icons
class MconTabInactive extends MconBase {
  const MconTabInactive({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconTabInactive> createState() => _MconTabInactiveState();
}

class _MconTabInactiveState extends MconBaseState<MconTabInactive> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTabInactivePainter(
      animation: animation,
...
class _MconTabInactivePainter extends MconPainter {
  _MconTabInactivePainter({
