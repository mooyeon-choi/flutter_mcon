...
/// Animated margin icon from Google Material Icons
class MconMargin extends MconBase {
  const MconMargin({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconMargin> createState() => _MconMarginState();
}

class _MconMarginState extends MconBaseState<MconMargin> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMarginPainter(
      animation: animation,
...
class _MconMarginPainter extends MconPainter {
  _MconMarginPainter({
