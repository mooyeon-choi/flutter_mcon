...
/// Animated monitor icon from Google Material Icons
class MconMonitor extends MconBase {
  const MconMonitor({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconMonitor> createState() => _MconMonitorState();
}

class _MconMonitorState extends MconBaseState<MconMonitor> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMonitorPainter(
      animation: animation,
...
class _MconMonitorPainter extends MconPainter {
  _MconMonitorPainter({
