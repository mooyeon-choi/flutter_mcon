...
/// Animated table_chart icon from Google Material Icons
class MconTableChart extends MconBase {
  const MconTableChart({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconTableChart> createState() => _MconTableChartState();
}

class _MconTableChartState extends MconBaseState<MconTableChart> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTableChartPainter(
      animation: animation,
...
class _MconTableChartPainter extends MconPainter {
  _MconTableChartPainter({
