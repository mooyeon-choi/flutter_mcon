...
/// Animated group_work icon from Google Material Icons
class MconGroupWork extends MconBase {
  const MconGroupWork({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconGroupWork> createState() => _MconGroupWorkState();
}

class _MconGroupWorkState extends MconBaseState<MconGroupWork> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconGroupWorkPainter(
      animation: animation,
...
class _MconGroupWorkPainter extends MconPainter {
  _MconGroupWorkPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(353.0), y(-320.0), x(376.5), y(-343.5));
    path.quadraticBezierTo(x(400.0), y(-367.0), x(400.0), y(-400.0));
    path.quadraticBezierTo(x(400.0), y(-433.0), x(376.5), y(-456.5));
    path.quadraticBezierTo(x(353.0), y(-480.0), x(320.0), y(-480.0));
    path.quadraticBezierTo(x(287.0), y(-480.0), x(263.5), y(-456.5));
    path.quadraticBezierTo(x(240.0), y(-433.0), x(240.0), y(-400.0));
    path.quadraticBezierTo(x(240.0), y(-367.0), x(263.5), y(-343.5));
    path.quadraticBezierTo(x(287.0), y(-320.0), x(320.0), y(-320.0));
    path.close();
    path.moveTo(x(640.0), y(-320.0));
    path.quadraticBezierTo(x(673.0), y(-320.0), x(696.5), y(-343.5));
    path.quadraticBezierTo(x(720.0), y(-367.0), x(720.0), y(-400.0));
    path.quadraticBezierTo(x(720.0), y(-433.0), x(696.5), y(-456.5));
    path.quadraticBezierTo(x(673.0), y(-480.0), x(640.0), y(-480.0));
    path.quadraticBezierTo(x(607.0), y(-480.0), x(583.5), y(-456.5));
    path.quadraticBezierTo(x(560.0), y(-433.0), x(560.0), y(-400.0));
    path.quadraticBezierTo(x(560.0), y(-367.0), x(583.5), y(-343.5));
