...
/// Animated library_books icon from Google Material Icons
class MconLibraryBooks extends MconBase {
  const MconLibraryBooks({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconLibraryBooks> createState() => _MconLibraryBooksState();
}

class _MconLibraryBooksState extends MconBaseState<MconLibraryBooks> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLibraryBooksPainter(
      animation: animation,
...
class _MconLibraryBooksPainter extends MconPainter {
  _MconLibraryBooksPainter({
