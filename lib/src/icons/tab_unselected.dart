...
/// Animated tab_unselected icon from Google Material Icons
class MconTabUnselected extends MconBase {
  const MconTabUnselected({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconTabUnselected> createState() => _MconTabUnselectedState();
}

class _MconTabUnselectedState extends MconBaseState<MconTabUnselected> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTabUnselectedPainter(
      animation: animation,
...
class _MconTabUnselectedPainter extends MconPainter {
  _MconTabUnselectedPainter({
