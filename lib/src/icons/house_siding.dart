...
/// Animated house_siding icon from Google Material Icons
class MconHouseSiding extends MconBase {
  const MconHouseSiding({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconHouseSiding> createState() => _MconHouseSidingState();
}

class _MconHouseSidingState extends MconBaseState<MconHouseSiding> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHouseSidingPainter(
      animation: animation,
...
class _MconHouseSidingPainter extends MconPainter {
  _MconHouseSidingPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.close();
    path.moveTo(x(350.0), y(-640.0));
    path.lineTo(x(610.0), y(-640.0));
