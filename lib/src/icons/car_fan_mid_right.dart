...
/// Animated car_fan_mid_right icon from Google Material Icons
class MconCarFanMidRight extends MconBase {
  const MconCarFanMidRight({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCarFanMidRight> createState() => _MconCarFanMidRightState();
}

class _MconCarFanMidRightState extends MconBaseState<MconCarFanMidRight> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCarFanMidRightPainter(
      animation: animation,
...
class _MconCarFanMidRightPainter extends MconPainter {
  _MconCarFanMidRightPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(223.0), y(-576.0));
    path.lineTo(x(287.0), y(-640.0));
    path.lineTo(x(120.0), y(-640.0));
    path.lineTo(x(120.0), y(-720.0));
    path.lineTo(x(287.0), y(-720.0));
