...
/// Animated trophy icon from Google Material Icons
class MconTrophy extends MconBase {
  const MconTrophy({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconTrophy> createState() => _MconTrophyState();
}

class _MconTrophyState extends MconBaseState<MconTrophy> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTrophyPainter(
      animation: animation,
...
class _MconTrophyPainter extends MconPainter {
  _MconTrophyPainter({
