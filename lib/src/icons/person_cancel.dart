...
/// Animated person_cancel icon from Google Material Icons
class MconPersonCancel extends MconBase {
  const MconPersonCancel({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPersonCancel> createState() => _MconPersonCancelState();
}

class _MconPersonCancelState extends MconBaseState<MconPersonCancel> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPersonCancelPainter(
      animation: animation,
...
class _MconPersonCancelPainter extends MconPainter {
  _MconPersonCancelPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.moveTo(x(696.0), y(-440.0));
    path.lineTo(x(640.0), y(-496.0));
    path.lineTo(x(723.0), y(-580.0));
    path.lineTo(x(640.0), y(-663.0));
    path.lineTo(x(696.0), y(-720.0));
    path.lineTo(x(780.0), y(-636.0));
    path.lineTo(x(863.0), y(-720.0));
    path.lineTo(x(920.0), y(-663.0));
    path.lineTo(x(836.0), y(-580.0));
    path.lineTo(x(920.0), y(-496.0));
    path.lineTo(x(863.0), y(-440.0));
    path.lineTo(x(780.0), y(-523.0));
