...
/// Animated moon_stars icon from Google Material Icons
class MconMoonStars extends MconBase {
  const MconMoonStars({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconMoonStars> createState() => _MconMoonStarsState();
}

class _MconMoonStarsState extends MconBaseState<MconMoonStars> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMoonStarsPainter(
      animation: animation,
...
class _MconMoonStarsPainter extends MconPainter {
  _MconMoonStarsPainter({
