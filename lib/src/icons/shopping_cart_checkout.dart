...
/// Animated shopping_cart_checkout icon from Google Material Icons
class MconShoppingCartCheckout extends MconBase {
  const MconShoppingCartCheckout({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconShoppingCartCheckout> createState() =>
      _MconShoppingCartCheckoutState();
}

class _MconShoppingCartCheckoutState
    extends MconBaseState<MconShoppingCartCheckout> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconShoppingCartCheckoutPainter(
      animation: animation,
...
class _MconShoppingCartCheckoutPainter extends MconPainter {
  _MconShoppingCartCheckoutPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(424.0), y(-616.0));
    path.lineTo(x(487.0), y(-680.0));
    path.lineTo(x(320.0), y(-680.0));
    path.lineTo(x(320.0), y(-760.0));
    path.lineTo(x(487.0), y(-760.0));
    path.lineTo(x(423.0), y(-824.0));
