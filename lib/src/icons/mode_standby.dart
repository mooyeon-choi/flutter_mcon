...
/// Animated mode_standby icon from Google Material Icons
class MconModeStandby extends MconBase {
  const MconModeStandby({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconModeStandby> createState() => _MconModeStandbyState();
}

class _MconModeStandbyState extends MconBaseState<MconModeStandby> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconModeStandbyPainter(
      animation: animation,
...
class _MconModeStandbyPainter extends MconPainter {
  _MconModeStandbyPainter({
