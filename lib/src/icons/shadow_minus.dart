...
/// Animated shadow_minus icon from Google Material Icons
class MconShadowMinus extends MconBase {
  const MconShadowMinus({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconShadowMinus> createState() => _MconShadowMinusState();
}

class _MconShadowMinusState extends MconBaseState<MconShadowMinus> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconShadowMinusPainter(
      animation: animation,
...
class _MconShadowMinusPainter extends MconPainter {
  _MconShadowMinusPainter({
