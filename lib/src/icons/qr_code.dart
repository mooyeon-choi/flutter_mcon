...
/// Animated qr_code icon from Google Material Icons
class MconQrCode extends MconBase {
  const MconQrCode({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconQrCode> createState() => _MconQrCodeState();
}

class _MconQrCodeState extends MconBaseState<MconQrCode> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconQrCodePainter(
      animation: animation,
...
class _MconQrCodePainter extends MconPainter {
  _MconQrCodePainter({
