...
/// Animated hdr_auto icon from Google Material Icons
class MconHdrAuto extends MconBase {
  const MconHdrAuto({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconHdrAuto> createState() => _MconHdrAutoState();
}

class _MconHdrAutoState extends MconBaseState<MconHdrAuto> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHdrAutoPainter(
      animation: animation,
...
class _MconHdrAutoPainter extends MconPainter {
  _MconHdrAutoPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.moveTo(x(276.0), y(-280.0));
    path.lineTo(x(352.0), y(-280.0));
    path.lineTo(x(392.0), y(-392.0));
    path.lineTo(x(568.0), y(-392.0));
    path.lineTo(x(608.0), y(-280.0));
    path.lineTo(x(684.0), y(-280.0));
    path.lineTo(x(520.0), y(-720.0));
    path.lineTo(x(440.0), y(-720.0));
    path.lineTo(x(276.0), y(-280.0));
    path.close();
    path.moveTo(x(414.0), y(-456.0));
    path.lineTo(x(478.0), y(-638.0));
    path.lineTo(x(482.0), y(-638.0));
    path.lineTo(x(546.0), y(-456.0));
    path.lineTo(x(414.0), y(-456.0));
    path.close();
