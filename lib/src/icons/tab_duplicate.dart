...
/// Animated tab_duplicate icon from Google Material Icons
class MconTabDuplicate extends MconBase {
  const MconTabDuplicate({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconTabDuplicate> createState() => _MconTabDuplicateState();
}

class _MconTabDuplicateState extends MconBaseState<MconTabDuplicate> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTabDuplicatePainter(
      animation: animation,
...
class _MconTabDuplicatePainter extends MconPainter {
  _MconTabDuplicatePainter({
