...
/// Animated content_copy icon from Google Material Icons
class MconContentCopy extends MconBase {
  const MconContentCopy({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconContentCopy> createState() => _MconContentCopyState();
}

class _MconContentCopyState extends MconBaseState<MconContentCopy> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconContentCopyPainter(
      animation: animation,
...
class _MconContentCopyPainter extends MconPainter {
  _MconContentCopyPainter({
