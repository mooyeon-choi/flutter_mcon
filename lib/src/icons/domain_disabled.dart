...
/// Animated domain_disabled icon from Google Material Icons
class MconDomainDisabled extends MconBase {
  const MconDomainDisabled({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDomainDisabled> createState() => _MconDomainDisabledState();
}

class _MconDomainDisabledState extends MconBaseState<MconDomainDisabled> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDomainDisabledPainter(
      animation: animation,
...
class _MconDomainDisabledPainter extends MconPainter {
  _MconDomainDisabledPainter({
