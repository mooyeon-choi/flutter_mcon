...
/// Animated departure_board icon from Google Material Icons
class MconDepartureBoard extends MconBase {
  const MconDepartureBoard({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDepartureBoard> createState() => _MconDepartureBoardState();
}

class _MconDepartureBoardState extends MconBaseState<MconDepartureBoard> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDepartureBoardPainter(
      animation: animation,
...
class _MconDepartureBoardPainter extends MconPainter {
  _MconDepartureBoardPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.moveTo(x(746.0), y(-584.0));
    path.lineTo(x(776.0), y(-614.0));
    path.lineTo(x(700.0), y(-688.0));
    path.lineTo(x(700.0), y(-800.0));
    path.lineTo(x(660.0), y(-800.0));
    path.lineTo(x(660.0), y(-672.0));
    path.lineTo(x(746.0), y(-584.0));
    path.close();
