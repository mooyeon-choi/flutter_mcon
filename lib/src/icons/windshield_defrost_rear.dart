...
/// Animated windshield_defrost_rear icon from Google Material Icons
class MconWindshieldDefrostRear extends MconBase {
  const MconWindshieldDefrostRear({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconWindshieldDefrostRear> createState() =>
      _MconWindshieldDefrostRearState();
}

class _MconWindshieldDefrostRearState
    extends MconBaseState<MconWindshieldDefrostRear> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWindshieldDefrostRearPainter(
      animation: animation,
...
class _MconWindshieldDefrostRearPainter extends MconPainter {
  _MconWindshieldDefrostRearPainter({
