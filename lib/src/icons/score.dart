...
/// Animated score icon from Google Material Icons
class MconScore extends MconBase {
  const MconScore({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconScore> createState() => _MconScoreState();
}

class _MconScoreState extends MconBaseState<MconScore> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconScorePainter(
      animation: animation,
...
class _MconScorePainter extends MconPainter {
  _MconScorePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(688.0), y(-720.0));
    path.lineTo(x(608.0), y(-600.0));
    path.lineTo(x(688.0), y(-480.0));
    path.lineTo(x(620.0), y(-480.0));
    path.close();
    path.moveTo(x(280.0), y(-480.0));
    path.lineTo(x(280.0), y(-630.0));
    path.lineTo(x(380.0), y(-630.0));
    path.lineTo(x(380.0), y(-660.0));
    path.lineTo(x(280.0), y(-660.0));
    path.lineTo(x(280.0), y(-720.0));
    path.lineTo(x(440.0), y(-720.0));
    path.lineTo(x(440.0), y(-570.0));
    path.lineTo(x(340.0), y(-570.0));
