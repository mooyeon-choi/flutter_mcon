...
/// Animated activity_zone icon from Google Material Icons
class MconActivityZone extends MconBase {
  const MconActivityZone({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconActivityZone> createState() => _MconActivityZoneState();
}

class _MconActivityZoneState extends MconBaseState<MconActivityZone> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconActivityZonePainter(
      animation: animation,
...
class _MconActivityZonePainter extends MconPainter {
  _MconActivityZonePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(647.0), y(-800.0));
    path.quadraticBezierTo(x(659.0), y(-835.0), x(689.5), y(-857.5));
    path.quadraticBezierTo(x(720.0), y(-880.0), x(760.0), y(-880.0));
    ...
    path.quadraticBezierTo(x(721.0), y(-80.0), x(690.5), y(-102.5));
    path.quadraticBezierTo(x(660.0), y(-125.0), x(647.0), y(-160.0));
    ...
    path.close();
    path.moveTo(x(313.0), y(-240.0));
    path.lineTo(x(647.0), y(-240.0));
    path.quadraticBezierTo(x(656.0), y(-266.0), x(675.0), y(-285.0));
    path.quadraticBezierTo(x(694.0), y(-304.0), x(720.0), y(-313.0));
    path.lineTo(x(720.0), y(-647.0));
    path.quadraticBezierTo(x(694.0), y(-656.0), x(675.0), y(-675.0));
    path.quadraticBezierTo(x(656.0), y(-694.0), x(647.0), y(-720.0));
