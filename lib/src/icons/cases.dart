...
/// Animated cases icon from Google Material Icons
class MconCases extends MconBase {
  const MconCases({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCases> createState() => _MconCasesState();
}

class _MconCasesState extends MconBaseState<MconCases> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCasesPainter(
      animation: animation,
...
class _MconCasesPainter extends MconPainter {
  _MconCasesPainter({
