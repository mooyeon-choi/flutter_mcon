...
/// Animated 15mp icon from Google Material Icons
class Mcon15mp extends MconBase {
  const Mcon15mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon15mp> createState() => _Mcon15mpState();
}

class _Mcon15mpState extends MconBaseState<Mcon15mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon15mpPainter(
      animation: animation,
...
class _Mcon15mpPainter extends MconPainter {
  _Mcon15mpPainter({
