...
/// Animated display_settings icon from Google Material Icons
class MconDisplaySettings extends MconBase {
  const MconDisplaySettings({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDisplaySettings> createState() =>
      _MconDisplaySettingsState();
}

class _MconDisplaySettingsState extends MconBaseState<MconDisplaySettings> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDisplaySettingsPainter(
      animation: animation,
...
class _MconDisplaySettingsPainter extends MconPainter {
  _MconDisplaySettingsPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(300.0), y(-470.0));
    path.lineTo(x(240.0), y(-470.0));
    path.lineTo(x(240.0), y(-410.0));
    path.lineTo(x(300.0), y(-410.0));
    path.lineTo(x(300.0), y(-360.0));
    path.close();
    path.moveTo(x(400.0), y(-410.0));
    ...
    path.lineTo(x(720.0), y(-570.0));
    path.lineTo(x(720.0), y(-630.0));
    path.lineTo(x(660.0), y(-630.0));
    path.lineTo(x(660.0), y(-680.0));
    path.lineTo(x(600.0), y(-680.0));
    path.lineTo(x(600.0), y(-520.0));
    path.close();
    path.moveTo(x(240.0), y(-570.0));
    path.lineTo(x(560.0), y(-570.0));
    path.lineTo(x(560.0), y(-630.0));
    path.lineTo(x(240.0), y(-630.0));
