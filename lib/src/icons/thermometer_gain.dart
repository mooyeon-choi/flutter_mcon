...
/// Animated thermometer_gain icon from Google Material Icons
class MconThermometerGain extends MconBase {
  const MconThermometerGain({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconThermometerGain> createState() =>
      _MconThermometerGainState();
}

class _MconThermometerGainState extends MconBaseState<MconThermometerGain> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconThermometerGainPainter(
      animation: animation,
...
class _MconThermometerGainPainter extends MconPainter {
  _MconThermometerGainPainter({
