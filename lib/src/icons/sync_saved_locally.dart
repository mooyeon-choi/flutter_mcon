...
/// Animated sync_saved_locally icon from Google Material Icons
class MconSyncSavedLocally extends MconBase {
  const MconSyncSavedLocally({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSyncSavedLocally> createState() =>
      _MconSyncSavedLocallyState();
}

class _MconSyncSavedLocallyState extends MconBaseState<MconSyncSavedLocally> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSyncSavedLocallyPainter(
      animation: animation,
...
class _MconSyncSavedLocallyPainter extends MconPainter {
  _MconSyncSavedLocallyPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.moveTo(x(437.0), y(-398.0));
    path.lineTo(x(664.0), y(-624.0));
    path.lineTo(x(607.0), y(-681.0));
    path.lineTo(x(437.0), y(-511.0));
    path.lineTo(x(352.0), y(-596.0));
    path.lineTo(x(296.0), y(-540.0));
    path.lineTo(x(437.0), y(-398.0));
    path.close();
