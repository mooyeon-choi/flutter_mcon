...
/// Animated live_tv icon from Google Material Icons
class MconLiveTv extends MconBase {
  const MconLiveTv({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconLiveTv> createState() => _MconLiveTvState();
}

class _MconLiveTvState extends MconBaseState<MconLiveTv> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLiveTvPainter(
      animation: animation,
...
class _MconLiveTvPainter extends MconPainter {
  _MconLiveTvPainter({
