...
/// Animated counter_2 icon from Google Material Icons
class MconCounter2 extends MconBase {
  const MconCounter2({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCounter2> createState() => _MconCounter2State();
}

class _MconCounter2State extends MconBaseState<MconCounter2> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCounter2Painter(
      animation: animation,
...
class _MconCounter2Painter extends MconPainter {
  _MconCounter2Painter({
