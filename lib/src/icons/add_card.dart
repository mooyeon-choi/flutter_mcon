...
/// Animated add_card icon from Google Material Icons
class MconAddCard extends MconBase {
  const MconAddCard({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconAddCard> createState() => _MconAddCardState();
}

class _MconAddCardState extends MconBaseState<MconAddCard> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAddCardPainter(
      animation: animation,
...
class _MconAddCardPainter extends MconPainter {
  _MconAddCardPainter({
