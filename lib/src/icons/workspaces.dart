...
/// Animated workspaces icon from Google Material Icons
class MconWorkspaces extends MconBase {
  const MconWorkspaces({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconWorkspaces> createState() => _MconWorkspacesState();
}

class _MconWorkspacesState extends MconBaseState<MconWorkspaces> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWorkspacesPainter(
      animation: animation,
...
class _MconWorkspacesPainter extends MconPainter {
  _MconWorkspacesPainter({
