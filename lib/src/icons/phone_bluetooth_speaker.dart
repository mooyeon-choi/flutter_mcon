...
/// Animated phone_bluetooth_speaker icon from Google Material Icons
class MconPhoneBluetoothSpeaker extends MconBase {
  const MconPhoneBluetoothSpeaker({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPhoneBluetoothSpeaker> createState() =>
      _MconPhoneBluetoothSpeakerState();
}

class _MconPhoneBluetoothSpeakerState
    extends MconBaseState<MconPhoneBluetoothSpeaker> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPhoneBluetoothSpeakerPainter(
      animation: animation,
...
class _MconPhoneBluetoothSpeakerPainter extends MconPainter {
  _MconPhoneBluetoothSpeakerPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(680.0), y(-632.0));
    path.lineTo(x(588.0), y(-540.0));
    path.lineTo(x(560.0), y(-568.0));
    path.lineTo(x(672.0), y(-680.0));
    path.lineTo(x(560.0), y(-792.0));
    path.lineTo(x(588.0), y(-820.0));
    path.lineTo(x(680.0), y(-728.0));
    path.lineTo(x(680.0), y(-880.0));
    path.lineTo(x(700.0), y(-880.0));
    path.lineTo(x(814.0), y(-764.0));
    path.lineTo(x(728.0), y(-680.0));
    path.lineTo(x(814.0), y(-594.0));
    path.lineTo(x(700.0), y(-480.0));
    path.lineTo(x(680.0), y(-480.0));
    path.close();
    path.moveTo(x(720.0), y(-556.0));
    path.lineTo(x(758.0), y(-594.0));
    path.lineTo(x(720.0), y(-632.0));
    path.lineTo(x(720.0), y(-556.0));
    path.close();
    path.moveTo(x(720.0), y(-728.0));
    path.lineTo(x(758.0), y(-764.0));
    path.lineTo(x(720.0), y(-802.0));
    path.lineTo(x(720.0), y(-728.0));
    path.close();
