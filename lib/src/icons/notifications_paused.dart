...
/// Animated notifications_paused icon from Google Material Icons
class MconNotificationsPaused extends MconBase {
  const MconNotificationsPaused({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconNotificationsPaused> createState() =>
      _MconNotificationsPausedState();
}

class _MconNotificationsPausedState
    extends MconBaseState<MconNotificationsPaused> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconNotificationsPausedPainter(
      animation: animation,
...
class _MconNotificationsPausedPainter extends MconPainter {
  _MconNotificationsPausedPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.moveTo(x(370.0), y(-320.0));
    path.lineTo(x(590.0), y(-320.0));
    path.lineTo(x(590.0), y(-392.0));
    path.lineTo(x(480.0), y(-392.0));
    path.lineTo(x(590.0), y(-528.0));
    path.lineTo(x(590.0), y(-600.0));
    path.lineTo(x(370.0), y(-600.0));
    path.lineTo(x(370.0), y(-528.0));
    path.lineTo(x(480.0), y(-528.0));
    path.lineTo(x(370.0), y(-392.0));
