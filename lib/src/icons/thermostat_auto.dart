...
/// Animated thermostat_auto icon from Google Material Icons
class MconThermostatAuto extends MconBase {
  const MconThermostatAuto({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconThermostatAuto> createState() => _MconThermostatAutoState();
}

class _MconThermostatAutoState extends MconBaseState<MconThermostatAuto> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconThermostatAutoPainter(
      animation: animation,
...
class _MconThermostatAutoPainter extends MconPainter {
  _MconThermostatAutoPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.moveTo(x(545.0), y(-440.0));
    path.lineTo(x(680.0), y(-800.0));
    path.lineTo(x(744.0), y(-800.0));
    path.lineTo(x(881.0), y(-440.0));
    path.lineTo(x(819.0), y(-440.0));
    path.lineTo(x(787.0), y(-532.0));
    path.lineTo(x(639.0), y(-532.0));
    path.lineTo(x(607.0), y(-440.0));
    path.lineTo(x(545.0), y(-440.0));
    path.close();
    path.moveTo(x(657.0), y(-584.0));
    path.lineTo(x(767.0), y(-584.0));
    path.lineTo(x(714.0), y(-734.0));
    path.lineTo(x(712.0), y(-734.0));
    path.lineTo(x(657.0), y(-584.0));
    path.close();
