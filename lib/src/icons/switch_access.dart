...
/// Animated switch_access icon from Google Material Icons
class MconSwitchAccess extends MconBase {
  const MconSwitchAccess({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSwitchAccess> createState() => _MconSwitchAccessState();
}

class _MconSwitchAccessState extends MconBaseState<MconSwitchAccess> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSwitchAccessPainter(
      animation: animation,
...
class _MconSwitchAccessPainter extends MconPainter {
  _MconSwitchAccessPainter({
