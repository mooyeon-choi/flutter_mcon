...
/// Animated wifi_tethering_off icon from Google Material Icons
class MconWifiTetheringOff extends MconBase {
  const MconWifiTetheringOff({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconWifiTetheringOff> createState() =>
      _MconWifiTetheringOffState();
}

class _MconWifiTetheringOffState extends MconBaseState<MconWifiTetheringOff> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWifiTetheringOffPainter(
      animation: animation,
...
class _MconWifiTetheringOffPainter extends MconPainter {
  _MconWifiTetheringOffPainter({
