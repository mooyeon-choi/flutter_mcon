...
/// Animated background_dot_small icon from Google Material Icons
class MconBackgroundDotSmall extends MconBase {
  const MconBackgroundDotSmall({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconBackgroundDotSmallPainter extends MconPainter {
  _MconBackgroundDotSmallPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(325.0), y(-420.0), x(342.5), y(-437.5));
    path.quadraticBezierTo(x(360.0), y(-455.0), x(360.0), y(-480.0));
    path.quadraticBezierTo(x(360.0), y(-505.0), x(342.5), y(-522.5));
    path.quadraticBezierTo(x(325.0), y(-540.0), x(300.0), y(-540.0));
    path.quadraticBezierTo(x(275.0), y(-540.0), x(257.5), y(-522.5));
    path.quadraticBezierTo(x(240.0), y(-505.0), x(240.0), y(-480.0));
    path.quadraticBezierTo(x(240.0), y(-455.0), x(257.5), y(-437.5));
    path.quadraticBezierTo(x(275.0), y(-420.0), x(300.0), y(-420.0));
    path.close();
    ...
    path.quadraticBezierTo(x(685.0), y(-420.0), x(702.5), y(-437.5));
    path.quadraticBezierTo(x(720.0), y(-455.0), x(720.0), y(-480.0));
    path.quadraticBezierTo(x(720.0), y(-505.0), x(702.5), y(-522.5));
    path.quadraticBezierTo(x(685.0), y(-540.0), x(660.0), y(-540.0));
    path.quadraticBezierTo(x(635.0), y(-540.0), x(617.5), y(-522.5));
    path.quadraticBezierTo(x(600.0), y(-505.0), x(600.0), y(-480.0));
    path.quadraticBezierTo(x(600.0), y(-455.0), x(617.5), y(-437.5));
    path.quadraticBezierTo(x(635.0), y(-420.0), x(660.0), y(-420.0));
    path.close();
    path.moveTo(x(480.0), y(-600.0));
    path.quadraticBezierTo(x(505.0), y(-600.0), x(522.5), y(-617.5));
    path.quadraticBezierTo(x(540.0), y(-635.0), x(540.0), y(-660.0));
    ...
    path.quadraticBezierTo(x(420.0), y(-635.0), x(437.5), y(-617.5));
