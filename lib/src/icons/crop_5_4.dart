...
/// Animated crop_5_4 icon from Google Material Icons
class MconCrop54 extends MconBase {
  const MconCrop54({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCrop54> createState() => _MconCrop54State();
}

class _MconCrop54State extends MconBaseState<MconCrop54> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCrop54Painter(
      animation: animation,
...
class _MconCrop54Painter extends MconPainter {
  _MconCrop54Painter({
