...
/// Animated straighten icon from Google Material Icons
class MconStraighten extends MconBase {
  const MconStraighten({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconStraighten> createState() => _MconStraightenState();
}

class _MconStraightenState extends MconBaseState<MconStraighten> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconStraightenPainter(
      animation: animation,
...
class _MconStraightenPainter extends MconPainter {
  _MconStraightenPainter({
