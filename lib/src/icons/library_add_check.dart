...
/// Animated library_add_check icon from Google Material Icons
class MconLibraryAddCheck extends MconBase {
  const MconLibraryAddCheck({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconLibraryAddCheck> createState() =>
      _MconLibraryAddCheckState();
}

class _MconLibraryAddCheckState extends MconBaseState<MconLibraryAddCheck> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLibraryAddCheckPainter(
      animation: animation,
...
class _MconLibraryAddCheckPainter extends MconPainter {
  _MconLibraryAddCheckPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.moveTo(x(508.0), y(-398.0));
    path.lineTo(x(734.0), y(-624.0));
    path.lineTo(x(678.0), y(-682.0));
    path.lineTo(x(508.0), y(-512.0));
    path.lineTo(x(422.0), y(-596.0));
    path.lineTo(x(366.0), y(-540.0));
    path.lineTo(x(508.0), y(-398.0));
    path.close();
