...
/// Animated summarize icon from Google Material Icons
class MconSummarize extends MconBase {
  const MconSummarize({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconSummarize> createState() => _MconSummarizeState();
}

class _MconSummarizeState extends MconBaseState<MconSummarize> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSummarizePainter(
      animation: animation,
...
class _MconSummarizePainter extends MconPainter {
  _MconSummarizePainter({
