...
/// Animated text_select_jump_to_end icon from Google Material Icons
class MconTextSelectJumpToEnd extends MconBase {
  const MconTextSelectJumpToEnd({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconTextSelectJumpToEnd> createState() =>
      _MconTextSelectJumpToEndState();
}

class _MconTextSelectJumpToEndState
    extends MconBaseState<MconTextSelectJumpToEnd> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTextSelectJumpToEndPainter(
      animation: animation,
...
class _MconTextSelectJumpToEndPainter extends MconPainter {
  _MconTextSelectJumpToEndPainter({
