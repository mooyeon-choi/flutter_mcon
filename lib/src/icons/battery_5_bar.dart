...
/// Animated battery_5_bar icon from Google Material Icons
class MconBattery5Bar extends MconBase {
  const MconBattery5Bar({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBattery5Bar> createState() => _MconBattery5BarState();
}

class _MconBattery5BarState extends MconBaseState<MconBattery5Bar> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBattery5BarPainter(
      animation: animation,
...
class _MconBattery5BarPainter extends MconPainter {
  _MconBattery5BarPainter({
