...
/// Animated monitor_weight_loss icon from Google Material Icons
class MconMonitorWeightLoss extends MconBase {
  const MconMonitorWeightLoss({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMonitorWeightLoss> createState() =>
      _MconMonitorWeightLossState();
}

class _MconMonitorWeightLossState extends MconBaseState<MconMonitorWeightLoss> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMonitorWeightLossPainter(
      animation: animation,
...
class _MconMonitorWeightLossPainter extends MconPainter {
  _MconMonitorWeightLossPainter({
