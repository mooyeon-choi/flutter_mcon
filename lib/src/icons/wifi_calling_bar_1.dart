...
/// Animated wifi_calling_bar_1 icon from Google Material Icons
class MconWifiCallingBar1 extends MconBase {
  const MconWifiCallingBar1({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconWifiCallingBar1> createState() =>
      _MconWifiCallingBar1State();
}

class _MconWifiCallingBar1State extends MconBaseState<MconWifiCallingBar1> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWifiCallingBar1Painter(
      animation: animation,
...
class _MconWifiCallingBar1Painter extends MconPainter {
  _MconWifiCallingBar1Painter({
