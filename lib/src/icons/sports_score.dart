...
/// Animated sports_score icon from Google Material Icons
class MconSportsScore extends MconBase {
  const MconSportsScore({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSportsScore> createState() => _MconSportsScoreState();
}

class _MconSportsScoreState extends MconBaseState<MconSportsScore> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSportsScorePainter(
      animation: animation,
...
class _MconSportsScorePainter extends MconPainter {
  _MconSportsScorePainter({
