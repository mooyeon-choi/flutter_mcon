...
/// Animated call_log icon from Google Material Icons
class MconCallLog extends MconBase {
  const MconCallLog({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCallLog> createState() => _MconCallLogState();
}

class _MconCallLogState extends MconBaseState<MconCallLog> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCallLogPainter(
      animation: animation,
...
class _MconCallLogPainter extends MconPainter {
  _MconCallLogPainter({
