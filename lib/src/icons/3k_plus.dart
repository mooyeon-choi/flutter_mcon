...
/// Animated 3k_plus icon from Google Material Icons
class Mcon3kPlus extends MconBase {
  const Mcon3kPlus({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon3kPlus> createState() => _Mcon3kPlusState();
}

class _Mcon3kPlusState extends MconBaseState<Mcon3kPlus> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon3kPlusPainter(
      animation: animation,
...
class _Mcon3kPlusPainter extends MconPainter {
  _Mcon3kPlusPainter({
