...
/// Animated 3mp icon from Google Material Icons
class Mcon3mp extends MconBase {
  const Mcon3mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon3mp> createState() => _Mcon3mpState();
}

class _Mcon3mpState extends MconBaseState<Mcon3mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon3mpPainter(
      animation: animation,
...
class _Mcon3mpPainter extends MconPainter {
  _Mcon3mpPainter({
