...
/// Animated developer_board icon from Google Material Icons
class MconDeveloperBoard extends MconBase {
  const MconDeveloperBoard({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDeveloperBoard> createState() => _MconDeveloperBoardState();
}

class _MconDeveloperBoardState extends MconBaseState<MconDeveloperBoard> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDeveloperBoardPainter(
      animation: animation,
...
class _MconDeveloperBoardPainter extends MconPainter {
  _MconDeveloperBoardPainter({
