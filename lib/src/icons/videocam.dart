...
/// Animated videocam icon from Google Material Icons
class MconVideocam extends MconBase {
  const MconVideocam({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconVideocam> createState() => _MconVideocamState();
}

class _MconVideocamState extends MconBaseState<MconVideocam> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconVideocamPainter(
      animation: animation,
...
class _MconVideocamPainter extends MconPainter {
  _MconVideocamPainter({
