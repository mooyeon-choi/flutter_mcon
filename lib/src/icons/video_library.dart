...
/// Animated video_library icon from Google Material Icons
class MconVideoLibrary extends MconBase {
  const MconVideoLibrary({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconVideoLibrary> createState() => _MconVideoLibraryState();
}

class _MconVideoLibraryState extends MconBaseState<MconVideoLibrary> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconVideoLibraryPainter(
      animation: animation,
...
class _MconVideoLibraryPainter extends MconPainter {
  _MconVideoLibraryPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.moveTo(x(460.0), y(-380.0));
    path.lineTo(x(740.0), y(-560.0));
    path.lineTo(x(460.0), y(-740.0));
