...
/// Animated forward_10 icon from Google Material Icons
class MconForward10 extends MconBase {
  const MconForward10({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconForward10> createState() => _MconForward10State();
}

class _MconForward10State extends MconBaseState<MconForward10> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconForward10Painter(
      animation: animation,
...
class _MconForward10Painter extends MconPainter {
  _MconForward10Painter({
