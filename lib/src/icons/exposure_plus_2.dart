...
/// Animated exposure_plus_2 icon from Google Material Icons
class MconExposurePlus2 extends MconBase {
  const MconExposurePlus2({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconExposurePlus2> createState() => _MconExposurePlus2State();
}

class _MconExposurePlus2State extends MconBaseState<MconExposurePlus2> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconExposurePlus2Painter(
      animation: animation,
...
class _MconExposurePlus2Painter extends MconPainter {
  _MconExposurePlus2Painter({
