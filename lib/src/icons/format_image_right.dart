...
/// Animated format_image_right icon from Google Material Icons
class MconFormatImageRight extends MconBase {
  const MconFormatImageRight({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconFormatImageRight> createState() =>
      _MconFormatImageRightState();
}

class _MconFormatImageRightState extends MconBaseState<MconFormatImageRight> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFormatImageRightPainter(
      animation: animation,
...
class _MconFormatImageRightPainter extends MconPainter {
  _MconFormatImageRightPainter({
