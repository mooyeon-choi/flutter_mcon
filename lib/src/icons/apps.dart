...
/// Animated apps icon from Google Material Icons
class MconApps extends MconBase {
  const MconApps({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconApps> createState() => _MconAppsState();
}

class _MconAppsState extends MconBaseState<MconApps> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAppsPainter(
      animation: animation,
...
class _MconAppsPainter extends MconPainter {
  _MconAppsPainter({
