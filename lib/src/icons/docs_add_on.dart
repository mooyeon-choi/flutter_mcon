...
/// Animated docs_add_on icon from Google Material Icons
class MconDocsAddOn extends MconBase {
  const MconDocsAddOn({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconDocsAddOn> createState() => _MconDocsAddOnState();
}

class _MconDocsAddOnState extends MconBaseState<MconDocsAddOn> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDocsAddOnPainter(
      animation: animation,
...
class _MconDocsAddOnPainter extends MconPainter {
  _MconDocsAddOnPainter({
