...
/// Animated overview icon from Google Material Icons
class MconOverview extends MconBase {
  const MconOverview({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconOverview> createState() => _MconOverviewState();
}

class _MconOverviewState extends MconBaseState<MconOverview> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconOverviewPainter(
      animation: animation,
...
class _MconOverviewPainter extends MconPainter {
  _MconOverviewPainter({
