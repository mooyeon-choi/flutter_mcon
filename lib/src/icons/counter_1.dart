...
/// Animated counter_1 icon from Google Material Icons
class MconCounter1 extends MconBase {
  const MconCounter1({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCounter1> createState() => _MconCounter1State();
}

class _MconCounter1State extends MconBaseState<MconCounter1> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCounter1Painter(
      animation: animation,
...
class _MconCounter1Painter extends MconPainter {
  _MconCounter1Painter({
