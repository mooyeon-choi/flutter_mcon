...
/// Animated desktop_portrait icon from Google Material Icons
class MconDesktopPortrait extends MconBase {
  const MconDesktopPortrait({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDesktopPortrait> createState() =>
      _MconDesktopPortraitState();
}

class _MconDesktopPortraitState extends MconBaseState<MconDesktopPortrait> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDesktopPortraitPainter(
      animation: animation,
...
class _MconDesktopPortraitPainter extends MconPainter {
  _MconDesktopPortraitPainter({
