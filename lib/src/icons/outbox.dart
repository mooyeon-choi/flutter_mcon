...
/// Animated outbox icon from Google Material Icons
class MconOutbox extends MconBase {
  const MconOutbox({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconOutbox> createState() => _MconOutboxState();
}

class _MconOutboxState extends MconBaseState<MconOutbox> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconOutboxPainter(
      animation: animation,
...
class _MconOutboxPainter extends MconPainter {
  _MconOutboxPainter({
