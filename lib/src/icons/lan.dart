...
/// Animated lan icon from Google Material Icons
class MconLan extends MconBase {
  const MconLan({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconLan> createState() => _MconLanState();
}

class _MconLanState extends MconBaseState<MconLan> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLanPainter(
      animation: animation,
...
class _MconLanPainter extends MconPainter {
  _MconLanPainter({
