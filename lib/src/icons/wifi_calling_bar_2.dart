...
/// Animated wifi_calling_bar_2 icon from Google Material Icons
class MconWifiCallingBar2 extends MconBase {
  const MconWifiCallingBar2({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconWifiCallingBar2> createState() =>
      _MconWifiCallingBar2State();
}

class _MconWifiCallingBar2State extends MconBaseState<MconWifiCallingBar2> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWifiCallingBar2Painter(
      animation: animation,
...
class _MconWifiCallingBar2Painter extends MconPainter {
  _MconWifiCallingBar2Painter({
