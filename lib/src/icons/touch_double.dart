...
/// Animated touch_double icon from Google Material Icons
class MconTouchDouble extends MconBase {
  const MconTouchDouble({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconTouchDouble> createState() => _MconTouchDoubleState();
}

class _MconTouchDoubleState extends MconBaseState<MconTouchDouble> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTouchDoublePainter(
      animation: animation,
...
class _MconTouchDoublePainter extends MconPainter {
  _MconTouchDoublePainter({
