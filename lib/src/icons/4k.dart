...
/// Animated 4k icon from Google Material Icons
class Mcon4k extends MconBase {
  const Mcon4k({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon4k> createState() => _Mcon4kState();
}

class _Mcon4kState extends MconBaseState<Mcon4k> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon4kPainter(
      animation: animation,
...
class _Mcon4kPainter extends MconPainter {
  _Mcon4kPainter({
