...
/// Animated cottage icon from Google Material Icons
class MconCottage extends MconBase {
  const MconCottage({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCottage> createState() => _MconCottageState();
}

class _MconCottageState extends MconBaseState<MconCottage> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCottagePainter(
      animation: animation,
...
class _MconCottagePainter extends MconPainter {
  _MconCottagePainter({
