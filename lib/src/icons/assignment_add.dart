...
/// Animated assignment_add icon from Google Material Icons
class MconAssignmentAdd extends MconBase {
  const MconAssignmentAdd({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconAssignmentAdd> createState() => _MconAssignmentAddState();
}

class _MconAssignmentAddState extends MconBaseState<MconAssignmentAdd> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAssignmentAddPainter(
      animation: animation,
...
class _MconAssignmentAddPainter extends MconPainter {
  _MconAssignmentAddPainter({
