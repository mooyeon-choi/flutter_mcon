...
/// Animated shelf_auto_hide icon from Google Material Icons
class MconShelfAutoHide extends MconBase {
  const MconShelfAutoHide({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconShelfAutoHide> createState() => _MconShelfAutoHideState();
}

class _MconShelfAutoHideState extends MconBaseState<MconShelfAutoHide> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconShelfAutoHidePainter(
      animation: animation,
...
class _MconShelfAutoHidePainter extends MconPainter {
  _MconShelfAutoHidePainter({
