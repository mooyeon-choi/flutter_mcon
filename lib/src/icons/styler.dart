...
/// Animated styler icon from Google Material Icons
class MconStyler extends MconBase {
  const MconStyler({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconStyler> createState() => _MconStylerState();
}

class _MconStylerState extends MconBaseState<MconStyler> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconStylerPainter(
      animation: animation,
...
class _MconStylerPainter extends MconPainter {
  _MconStylerPainter({
