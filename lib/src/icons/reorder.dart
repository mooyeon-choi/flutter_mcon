...
/// Animated reorder icon from Google Material Icons
class MconReorder extends MconBase {
  const MconReorder({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconReorder> createState() => _MconReorderState();
}

class _MconReorderState extends MconBaseState<MconReorder> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconReorderPainter(
      animation: animation,
...
class _MconReorderPainter extends MconPainter {
  _MconReorderPainter({
