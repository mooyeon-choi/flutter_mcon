...
/// Animated reset_focus icon from Google Material Icons
class MconResetFocus extends MconBase {
  const MconResetFocus({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconResetFocus> createState() => _MconResetFocusState();
}

class _MconResetFocusState extends MconBaseState<MconResetFocus> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconResetFocusPainter(
      animation: animation,
...
class _MconResetFocusPainter extends MconPainter {
  _MconResetFocusPainter({
