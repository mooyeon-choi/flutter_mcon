...
/// Animated join_right icon from Google Material Icons
class MconJoinRight extends MconBase {
  const MconJoinRight({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconJoinRight> createState() => _MconJoinRightState();
}

class _MconJoinRightState extends MconBaseState<MconJoinRight> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconJoinRightPainter(
      animation: animation,
...
class _MconJoinRightPainter extends MconPainter {
  _MconJoinRightPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(596.0), y(-268.0), x(628.0), y(-336.0));
    path.quadraticBezierTo(x(660.0), y(-404.0), x(660.0), y(-480.0));
    path.quadraticBezierTo(x(660.0), y(-556.0), x(628.0), y(-624.0));
    path.quadraticBezierTo(x(596.0), y(-692.0), x(538.0), y(-741.0));
