...
/// Animated graphic_eq icon from Google Material Icons
class MconGraphicEq extends MconBase {
  const MconGraphicEq({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconGraphicEq> createState() => _MconGraphicEqState();
}

class _MconGraphicEqState extends MconBaseState<MconGraphicEq> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconGraphicEqPainter(
      animation: animation,
...
class _MconGraphicEqPainter extends MconPainter {
  _MconGraphicEqPainter({
