...
/// Animated fluorescent icon from Google Material Icons
class MconFluorescent extends MconBase {
  const MconFluorescent({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconFluorescent> createState() => _MconFluorescentState();
}

class _MconFluorescentState extends MconBaseState<MconFluorescent> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFluorescentPainter(
      animation: animation,
...
class _MconFluorescentPainter extends MconPainter {
  _MconFluorescentPainter({
