...
/// Animated dehaze icon from Google Material Icons
class MconDehaze extends MconBase {
  const MconDehaze({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconDehaze> createState() => _MconDehazeState();
}

class _MconDehazeState extends MconBaseState<MconDehaze> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDehazePainter(
      animation: animation,
...
class _MconDehazePainter extends MconPainter {
  _MconDehazePainter({
