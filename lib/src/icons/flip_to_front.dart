...
/// Animated flip_to_front icon from Google Material Icons
class MconFlipToFront extends MconBase {
  const MconFlipToFront({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconFlipToFront> createState() => _MconFlipToFrontState();
}

class _MconFlipToFrontState extends MconBaseState<MconFlipToFront> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFlipToFrontPainter(
      animation: animation,
...
class _MconFlipToFrontPainter extends MconPainter {
  _MconFlipToFrontPainter({
