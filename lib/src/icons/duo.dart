...
/// Animated duo icon from Google Material Icons
class MconDuo extends MconBase {
  const MconDuo({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconDuo> createState() => _MconDuoState();
}

class _MconDuoState extends MconBaseState<MconDuo> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDuoPainter(
      animation: animation,
...
class _MconDuoPainter extends MconPainter {
  _MconDuoPainter({
