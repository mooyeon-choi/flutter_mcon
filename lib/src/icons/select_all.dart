...
/// Animated select_all icon from Google Material Icons
class MconSelectAll extends MconBase {
  const MconSelectAll({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconSelectAll> createState() => _MconSelectAllState();
}

class _MconSelectAllState extends MconBaseState<MconSelectAll> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSelectAllPainter(
      animation: animation,
...
class _MconSelectAllPainter extends MconPainter {
  _MconSelectAllPainter({
