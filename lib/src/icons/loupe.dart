...
/// Animated loupe icon from Google Material Icons
class MconLoupe extends MconBase {
  const MconLoupe({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconLoupe> createState() => _MconLoupeState();
}

class _MconLoupeState extends MconBaseState<MconLoupe> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconLoupePainter(
      animation: animation,
...
class _MconLoupePainter extends MconPainter {
  _MconLoupePainter({
