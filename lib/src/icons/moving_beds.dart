...
/// Animated moving_beds icon from Google Material Icons
class MconMovingBeds extends MconBase {
  const MconMovingBeds({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMovingBeds> createState() => _MconMovingBedsState();
}

class _MconMovingBedsState extends MconBaseState<MconMovingBeds> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMovingBedsPainter(
      animation: animation,
...
class _MconMovingBedsPainter extends MconPainter {
  _MconMovingBedsPainter({
