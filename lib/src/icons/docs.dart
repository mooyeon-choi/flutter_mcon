...
/// Animated docs icon from Google Material Icons
class MconDocs extends MconBase {
  const MconDocs({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconDocs> createState() => _MconDocsState();
}

class _MconDocsState extends MconBaseState<MconDocs> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDocsPainter(
      animation: animation,
...
class _MconDocsPainter extends MconPainter {
  _MconDocsPainter({
