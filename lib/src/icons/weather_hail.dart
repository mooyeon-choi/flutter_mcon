...
/// Animated weather_hail icon from Google Material Icons
class MconWeatherHail extends MconBase {
  const MconWeatherHail({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconWeatherHail> createState() => _MconWeatherHailState();
}

class _MconWeatherHailState extends MconBaseState<MconWeatherHail> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWeatherHailPainter(
      animation: animation,
...
class _MconWeatherHailPainter extends MconPainter {
  _MconWeatherHailPainter({
