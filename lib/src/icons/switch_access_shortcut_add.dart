...
/// Animated switch_access_shortcut_add icon from Google Material Icons
class MconSwitchAccessShortcutAdd extends MconBase {
  const MconSwitchAccessShortcutAdd({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSwitchAccessShortcutAdd> createState() =>
      _MconSwitchAccessShortcutAddState();
}

class _MconSwitchAccessShortcutAddState
    extends MconBaseState<MconSwitchAccessShortcutAdd> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSwitchAccessShortcutAddPainter(
      animation: animation,
...
class _MconSwitchAccessShortcutAddPainter extends MconPainter {
  _MconSwitchAccessShortcutAddPainter({
