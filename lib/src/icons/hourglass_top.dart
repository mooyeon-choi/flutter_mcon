...
/// Animated hourglass_top icon from Google Material Icons
class MconHourglassTop extends MconBase {
  const MconHourglassTop({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconHourglassTop> createState() => _MconHourglassTopState();
}

class _MconHourglassTopState extends MconBaseState<MconHourglassTop> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHourglassTopPainter(
      animation: animation,
...
class _MconHourglassTopPainter extends MconPainter {
  _MconHourglassTopPainter({
