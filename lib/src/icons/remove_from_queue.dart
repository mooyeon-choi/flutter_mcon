...
/// Animated remove_from_queue icon from Google Material Icons
class MconRemoveFromQueue extends MconBase {
  const MconRemoveFromQueue({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconRemoveFromQueue> createState() =>
      _MconRemoveFromQueueState();
}

class _MconRemoveFromQueueState extends MconBaseState<MconRemoveFromQueue> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconRemoveFromQueuePainter(
      animation: animation,
...
class _MconRemoveFromQueuePainter extends MconPainter {
  _MconRemoveFromQueuePainter({
