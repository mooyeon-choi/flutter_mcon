...
/// Animated add_alert icon from Google Material Icons
class MconAddAlert extends MconBase {
  const MconAddAlert({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconAddAlert> createState() => _MconAddAlertState();
}

class _MconAddAlertState extends MconBaseState<MconAddAlert> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAddAlertPainter(
      animation: animation,
...
class _MconAddAlertPainter extends MconPainter {
  _MconAddAlertPainter({
