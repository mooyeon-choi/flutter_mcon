...
/// Animated remove_selection icon from Google Material Icons
class MconRemoveSelection extends MconBase {
  const MconRemoveSelection({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconRemoveSelection> createState() =>
      _MconRemoveSelectionState();
}

class _MconRemoveSelectionState extends MconBaseState<MconRemoveSelection> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconRemoveSelectionPainter(
      animation: animation,
...
class _MconRemoveSelectionPainter extends MconPainter {
  _MconRemoveSelectionPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(444.0), y(-176.0));
    path.lineTo(x(586.0), y(-318.0));
    path.lineTo(x(444.0), y(-460.0));
    path.lineTo(x(500.0), y(-516.0));
    path.lineTo(x(642.0), y(-374.0));
    path.lineTo(x(784.0), y(-516.0));
    path.lineTo(x(840.0), y(-460.0));
    path.lineTo(x(698.0), y(-318.0));
    path.lineTo(x(840.0), y(-176.0));
    path.lineTo(x(784.0), y(-120.0));
    path.lineTo(x(642.0), y(-262.0));
