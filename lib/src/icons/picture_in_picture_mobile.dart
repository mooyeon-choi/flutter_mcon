...
/// Animated picture_in_picture_mobile icon from Google Material Icons
class MconPictureInPictureMobile extends MconBase {
  const MconPictureInPictureMobile({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPictureInPictureMobile> createState() =>
      _MconPictureInPictureMobileState();
}

class _MconPictureInPictureMobileState
    extends MconBaseState<MconPictureInPictureMobile> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPictureInPictureMobilePainter(
      animation: animation,
...
class _MconPictureInPictureMobilePainter extends MconPainter {
  _MconPictureInPictureMobilePainter({
