...
/// Animated 22mp icon from Google Material Icons
class Mcon22mp extends MconBase {
  const Mcon22mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon22mp> createState() => _Mcon22mpState();
}

class _Mcon22mpState extends MconBaseState<Mcon22mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon22mpPainter(
      animation: animation,
...
class _Mcon22mpPainter extends MconPainter {
  _Mcon22mpPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(677.0), y(-600.0), x(688.5), y(-611.5));
    path.quadraticBezierTo(x(700.0), y(-623.0), x(700.0), y(-640.0));
    ...
    path.quadraticBezierTo(x(543.0), y(-640.0), x(531.5), y(-628.5));
    path.quadraticBezierTo(x(520.0), y(-617.0), x(520.0), y(-600.0));
