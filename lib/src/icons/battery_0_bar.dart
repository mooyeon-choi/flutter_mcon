...
/// Animated battery_0_bar icon from Google Material Icons
class MconBattery0Bar extends MconBase {
  const MconBattery0Bar({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBattery0Bar> createState() => _MconBattery0BarState();
}

class _MconBattery0BarState extends MconBaseState<MconBattery0Bar> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBattery0BarPainter(
      animation: animation,
...
class _MconBattery0BarPainter extends MconPainter {
  _MconBattery0BarPainter({
