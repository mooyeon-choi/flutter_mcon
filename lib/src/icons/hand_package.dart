...
/// Animated hand_package icon from Google Material Icons
class MconHandPackage extends MconBase {
  const MconHandPackage({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconHandPackage> createState() => _MconHandPackageState();
}

class _MconHandPackageState extends MconBaseState<MconHandPackage> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHandPackagePainter(
      animation: animation,
...
class _MconHandPackagePainter extends MconPainter {
  _MconHandPackagePainter({
