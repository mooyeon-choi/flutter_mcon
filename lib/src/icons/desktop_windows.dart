...
/// Animated desktop_windows icon from Google Material Icons
class MconDesktopWindows extends MconBase {
  const MconDesktopWindows({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDesktopWindows> createState() => _MconDesktopWindowsState();
}

class _MconDesktopWindowsState extends MconBaseState<MconDesktopWindows> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDesktopWindowsPainter(
      animation: animation,
...
class _MconDesktopWindowsPainter extends MconPainter {
  _MconDesktopWindowsPainter({
