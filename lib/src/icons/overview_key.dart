...
/// Animated overview_key icon from Google Material Icons
class MconOverviewKey extends MconBase {
  const MconOverviewKey({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconOverviewKey> createState() => _MconOverviewKeyState();
}

class _MconOverviewKeyState extends MconBaseState<MconOverviewKey> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconOverviewKeyPainter(
      animation: animation,
...
class _MconOverviewKeyPainter extends MconPainter {
  _MconOverviewKeyPainter({
