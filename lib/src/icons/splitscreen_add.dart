...
/// Animated splitscreen_add icon from Google Material Icons
class MconSplitscreenAdd extends MconBase {
  const MconSplitscreenAdd({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconSplitscreenAdd> createState() => _MconSplitscreenAddState();
}

class _MconSplitscreenAddState extends MconBaseState<MconSplitscreenAdd> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSplitscreenAddPainter(
      animation: animation,
...
class _MconSplitscreenAddPainter extends MconPainter {
  _MconSplitscreenAddPainter({
