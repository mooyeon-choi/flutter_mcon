...
/// Animated move_selection_right icon from Google Material Icons
class MconMoveSelectionRight extends MconBase {
  const MconMoveSelectionRight({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMoveSelectionRight> createState() =>
      _MconMoveSelectionRightState();
}

class _MconMoveSelectionRightState
    extends MconBaseState<MconMoveSelectionRight> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMoveSelectionRightPainter(
      animation: animation,
...
class _MconMoveSelectionRightPainter extends MconPainter {
  _MconMoveSelectionRightPainter({
