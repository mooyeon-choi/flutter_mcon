...
/// Animated computer icon from Google Material Icons
class MconComputer extends MconBase {
  const MconComputer({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconComputer> createState() => _MconComputerState();
}

class _MconComputerState extends MconBaseState<MconComputer> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconComputerPainter(
      animation: animation,
...
class _MconComputerPainter extends MconPainter {
  _MconComputerPainter({
