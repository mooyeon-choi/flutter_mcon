...
/// Animated assignment_return icon from Google Material Icons
class MconAssignmentReturn extends MconBase {
  const MconAssignmentReturn({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconAssignmentReturnState extends MconBaseState<MconAssignmentReturn> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAssignmentReturnPainter(
      animation: animation,
...
class _MconAssignmentReturnPainter extends MconPainter {
  _MconAssignmentReturnPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(536.0), y(-376.0));
    path.lineTo(x(473.0), y(-440.0));
    path.lineTo(x(640.0), y(-440.0));
    path.lineTo(x(640.0), y(-520.0));
    path.lineTo(x(473.0), y(-520.0));
    path.lineTo(x(536.0), y(-584.0));
