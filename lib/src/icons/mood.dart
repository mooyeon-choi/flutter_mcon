...
/// Animated mood icon from Google Material Icons
class MconMood extends MconBase {
  const MconMood({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconMood> createState() => _MconMoodState();
}

class _MconMoodState extends MconBaseState<MconMood> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMoodPainter(
      animation: animation,
...
class _MconMoodPainter extends MconPainter {
  _MconMoodPainter({
