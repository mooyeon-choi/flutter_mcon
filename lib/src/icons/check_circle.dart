...
/// Animated check_circle icon from Google Material Icons
class MconCheckCircle extends MconBase {
  const MconCheckCircle({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCheckCircle> createState() => _MconCheckCircleState();
}

class _MconCheckCircleState extends MconBaseState<MconCheckCircle> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCheckCirclePainter(
      animation: animation,
...
class _MconCheckCirclePainter extends MconPainter {
  _MconCheckCirclePainter({
