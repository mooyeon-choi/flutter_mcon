...
/// Animated iframe_off icon from Google Material Icons
class MconIframeOff extends MconBase {
  const MconIframeOff({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconIframeOff> createState() => _MconIframeOffState();
}

class _MconIframeOffState extends MconBaseState<MconIframeOff> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconIframeOffPainter(
      animation: animation,
...
class _MconIframeOffPainter extends MconPainter {
  _MconIframeOffPainter({
