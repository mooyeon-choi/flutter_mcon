...
/// Animated widget_width icon from Google Material Icons
class MconWidgetWidth extends MconBase {
  const MconWidgetWidth({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconWidgetWidth> createState() => _MconWidgetWidthState();
}

class _MconWidgetWidthState extends MconBaseState<MconWidgetWidth> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWidgetWidthPainter(
      animation: animation,
...
class _MconWidgetWidthPainter extends MconPainter {
  _MconWidgetWidthPainter({
