...
/// Animated forward_media icon from Google Material Icons
class MconForwardMedia extends MconBase {
  const MconForwardMedia({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconForwardMedia> createState() => _MconForwardMediaState();
}

class _MconForwardMediaState extends MconBaseState<MconForwardMedia> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconForwardMediaPainter(
      animation: animation,
...
class _MconForwardMediaPainter extends MconPainter {
  _MconForwardMediaPainter({
