...
/// Animated discover_tune icon from Google Material Icons
class MconDiscoverTune extends MconBase {
  const MconDiscoverTune({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDiscoverTune> createState() => _MconDiscoverTuneState();
}

class _MconDiscoverTuneState extends MconBaseState<MconDiscoverTune> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDiscoverTunePainter(
      animation: animation,
...
class _MconDiscoverTunePainter extends MconPainter {
  _MconDiscoverTunePainter({
