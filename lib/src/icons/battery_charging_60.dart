...
/// Animated battery_charging_60 icon from Google Material Icons
class MconBatteryCharging60 extends MconBase {
  const MconBatteryCharging60({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconBatteryCharging60State extends MconBaseState<MconBatteryCharging60> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryCharging60Painter(
      animation: animation,
...
class _MconBatteryCharging60Painter extends MconPainter {
  _MconBatteryCharging60Painter({
