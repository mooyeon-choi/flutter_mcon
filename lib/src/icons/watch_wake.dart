...
/// Animated watch_wake icon from Google Material Icons
class MconWatchWake extends MconBase {
  const MconWatchWake({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconWatchWake> createState() => _MconWatchWakeState();
}

class _MconWatchWakeState extends MconBaseState<MconWatchWake> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWatchWakePainter(
      animation: animation,
...
class _MconWatchWakePainter extends MconPainter {
  _MconWatchWakePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(760.0), y(-681.0));
    path.lineTo(x(920.0), y(-681.0));
