...
/// Animated difference icon from Google Material Icons
class MconDifference extends MconBase {
  const MconDifference({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconDifference> createState() => _MconDifferenceState();
}

class _MconDifferenceState extends MconBaseState<MconDifference> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDifferencePainter(
      animation: animation,
...
class _MconDifferencePainter extends MconPainter {
  _MconDifferencePainter({
