...
/// Animated filter_2 icon from Google Material Icons
class MconFilter2 extends MconBase {
  const MconFilter2({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconFilter2> createState() => _MconFilter2State();
}

class _MconFilter2State extends MconBaseState<MconFilter2> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFilter2Painter(
      animation: animation,
...
class _MconFilter2Painter extends MconPainter {
  _MconFilter2Painter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(633.0), y(-520.0), x(656.5), y(-543.5));
    ...
    path.quadraticBezierTo(x(487.0), y(-600.0), x(463.5), y(-576.5));
