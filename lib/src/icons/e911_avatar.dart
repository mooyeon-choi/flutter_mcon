...
/// Animated e911_avatar icon from Google Material Icons
class MconE911Avatar extends MconBase {
  const MconE911Avatar({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconE911Avatar> createState() => _MconE911AvatarState();
}

class _MconE911AvatarState extends MconBaseState<MconE911Avatar> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconE911AvatarPainter(
      animation: animation,
...
class _MconE911AvatarPainter extends MconPainter {
  _MconE911AvatarPainter({
