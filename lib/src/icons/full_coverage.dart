...
/// Animated full_coverage icon from Google Material Icons
class MconFullCoverage extends MconBase {
  const MconFullCoverage({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconFullCoverage> createState() => _MconFullCoverageState();
}

class _MconFullCoverageState extends MconBaseState<MconFullCoverage> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFullCoveragePainter(
      animation: animation,
...
class _MconFullCoveragePainter extends MconPainter {
  _MconFullCoveragePainter({
