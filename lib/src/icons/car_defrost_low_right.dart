...
/// Animated car_defrost_low_right icon from Google Material Icons
class MconCarDefrostLowRight extends MconBase {
  const MconCarDefrostLowRight({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconCarDefrostLowRightPainter extends MconPainter {
  _MconCarDefrostLowRightPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(82.0), y(-442.0));
    path.lineTo(x(130.0), y(-395.0));
    path.lineTo(x(130.0), y(-520.0));
    path.lineTo(x(190.0), y(-520.0));
    path.lineTo(x(190.0), y(-395.0));
    path.lineTo(x(238.0), y(-442.0));
