...
/// Animated view_agenda icon from Google Material Icons
class MconViewAgenda extends MconBase {
  const MconViewAgenda({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconViewAgenda> createState() => _MconViewAgendaState();
}

class _MconViewAgendaState extends MconBaseState<MconViewAgenda> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconViewAgendaPainter(
      animation: animation,
...
class _MconViewAgendaPainter extends MconPainter {
  _MconViewAgendaPainter({
