...
/// Animated nest_display icon from Google Material Icons
class MconNestDisplay extends MconBase {
  const MconNestDisplay({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconNestDisplay> createState() => _MconNestDisplayState();
}

class _MconNestDisplayState extends MconBaseState<MconNestDisplay> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconNestDisplayPainter(
      animation: animation,
...
class _MconNestDisplayPainter extends MconPainter {
  _MconNestDisplayPainter({
