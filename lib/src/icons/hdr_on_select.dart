...
/// Animated hdr_on_select icon from Google Material Icons
class MconHdrOnSelect extends MconBase {
  const MconHdrOnSelect({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconHdrOnSelect> createState() => _MconHdrOnSelectState();
}

class _MconHdrOnSelectState extends MconBaseState<MconHdrOnSelect> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHdrOnSelectPainter(
      animation: animation,
...
class _MconHdrOnSelectPainter extends MconPainter {
  _MconHdrOnSelectPainter({
