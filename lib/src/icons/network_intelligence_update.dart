...
/// Animated network_intelligence_update icon from Google Material Icons
class MconNetworkIntelligenceUpdate extends MconBase {
  const MconNetworkIntelligenceUpdate({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconNetworkIntelligenceUpdate> createState() =>
      _MconNetworkIntelligenceUpdateState();
}

class _MconNetworkIntelligenceUpdateState
    extends MconBaseState<MconNetworkIntelligenceUpdate> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconNetworkIntelligenceUpdatePainter(
      animation: animation,
...
class _MconNetworkIntelligenceUpdatePainter extends MconPainter {
  _MconNetworkIntelligenceUpdatePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(812.0), y(-268.0));
    path.lineTo(x(740.0), y(-196.0));
    path.lineTo(x(740.0), y(-360.0));
    path.lineTo(x(700.0), y(-360.0));
    path.lineTo(x(700.0), y(-196.0));
