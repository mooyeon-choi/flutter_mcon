...
/// Animated analytics icon from Google Material Icons
class MconAnalytics extends MconBase {
  const MconAnalytics({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconAnalytics> createState() => _MconAnalyticsState();
}

class _MconAnalyticsState extends MconBaseState<MconAnalytics> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAnalyticsPainter(
      animation: animation,
...
class _MconAnalyticsPainter extends MconPainter {
  _MconAnalyticsPainter({
