...
/// Animated tab_group icon from Google Material Icons
class MconTabGroup extends MconBase {
  const MconTabGroup({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconTabGroup> createState() => _MconTabGroupState();
}

class _MconTabGroupState extends MconBaseState<MconTabGroup> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTabGroupPainter(
      animation: animation,
...
class _MconTabGroupPainter extends MconPainter {
  _MconTabGroupPainter({
