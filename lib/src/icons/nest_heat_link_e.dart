...
/// Animated nest_heat_link_e icon from Google Material Icons
class MconNestHeatLinkE extends MconBase {
  const MconNestHeatLinkE({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconNestHeatLinkE> createState() => _MconNestHeatLinkEState();
}

class _MconNestHeatLinkEState extends MconBaseState<MconNestHeatLinkE> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconNestHeatLinkEPainter(
      animation: animation,
...
class _MconNestHeatLinkEPainter extends MconPainter {
  _MconNestHeatLinkEPainter({
