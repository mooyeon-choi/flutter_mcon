...
/// Animated mobile_sensor_hi icon from Google Material Icons
class MconMobileSensorHi extends MconBase {
  const MconMobileSensorHi({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMobileSensorHi> createState() => _MconMobileSensorHiState();
}

class _MconMobileSensorHiState extends MconBaseState<MconMobileSensorHi> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMobileSensorHiPainter(
      animation: animation,
...
class _MconMobileSensorHiPainter extends MconPainter {
  _MconMobileSensorHiPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.close();
    path.moveTo(x(0.0), y(-280.0));
    path.lineTo(x(0.0), y(-560.0));
    ...
    path.close();
    path.moveTo(x(880.0), y(-400.0));
    path.lineTo(x(880.0), y(-680.0));
    path.lineTo(x(960.0), y(-680.0));
    path.lineTo(x(960.0), y(-400.0));
