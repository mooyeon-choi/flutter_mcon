...
/// Animated ink_selection icon from Google Material Icons
class MconInkSelection extends MconBase {
  const MconInkSelection({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconInkSelection> createState() => _MconInkSelectionState();
}

class _MconInkSelectionState extends MconBaseState<MconInkSelection> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconInkSelectionPainter(
      animation: animation,
...
class _MconInkSelectionPainter extends MconPainter {
  _MconInkSelectionPainter({
