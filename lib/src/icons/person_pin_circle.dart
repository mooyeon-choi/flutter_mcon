...
/// Animated person_pin_circle icon from Google Material Icons
class MconPersonPinCircle extends MconBase {
  const MconPersonPinCircle({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPersonPinCircle> createState() =>
      _MconPersonPinCircleState();
}

class _MconPersonPinCircleState extends MconBaseState<MconPersonPinCircle> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPersonPinCirclePainter(
      animation: animation,
...
class _MconPersonPinCirclePainter extends MconPainter {
  _MconPersonPinCirclePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(536.0), y(-360.0), x(581.0), y(-387.5));
    path.quadraticBezierTo(x(626.0), y(-415.0), x(652.0), y(-460.0));
    path.quadraticBezierTo(x(617.0), y(-489.0), x(573.0), y(-504.5));
    path.quadraticBezierTo(x(529.0), y(-520.0), x(480.0), y(-520.0));
    path.quadraticBezierTo(x(431.0), y(-520.0), x(387.0), y(-504.5));
    path.quadraticBezierTo(x(343.0), y(-489.0), x(308.0), y(-460.0));
    path.quadraticBezierTo(x(334.0), y(-415.0), x(379.0), y(-387.5));
    path.quadraticBezierTo(x(424.0), y(-360.0), x(480.0), y(-360.0));
    path.close();
