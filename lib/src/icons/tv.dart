...
/// Animated tv icon from Google Material Icons
class MconTv extends MconBase {
  const MconTv({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconTv> createState() => _MconTvState();
}

class _MconTvState extends MconBaseState<MconTv> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTvPainter(
      animation: animation,
...
class _MconTvPainter extends MconPainter {
  _MconTvPainter({
