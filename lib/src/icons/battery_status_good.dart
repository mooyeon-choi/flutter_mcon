...
/// Animated battery_status_good icon from Google Material Icons
class MconBatteryStatusGood extends MconBase {
  const MconBatteryStatusGood({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconBatteryStatusGoodState extends MconBaseState<MconBatteryStatusGood> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryStatusGoodPainter(
      animation: animation,
...
class _MconBatteryStatusGoodPainter extends MconPainter {
  _MconBatteryStatusGoodPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.moveTo(x(638.0), y(-113.0));
    path.lineTo(x(524.0), y(-226.0));
    path.lineTo(x(581.0), y(-282.0));
    path.lineTo(x(638.0), y(-226.0));
    path.lineTo(x(779.0), y(-367.0));
    path.lineTo(x(836.0), y(-311.0));
    path.lineTo(x(638.0), y(-113.0));
    path.close();
