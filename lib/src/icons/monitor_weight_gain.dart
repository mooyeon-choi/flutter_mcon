...
/// Animated monitor_weight_gain icon from Google Material Icons
class MconMonitorWeightGain extends MconBase {
  const MconMonitorWeightGain({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMonitorWeightGain> createState() =>
      _MconMonitorWeightGainState();
}

class _MconMonitorWeightGainState extends MconBaseState<MconMonitorWeightGain> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMonitorWeightGainPainter(
      animation: animation,
...
class _MconMonitorWeightGainPainter extends MconPainter {
  _MconMonitorWeightGainPainter({
