...
/// Animated autopause icon from Google Material Icons
class MconAutopause extends MconBase {
  const MconAutopause({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconAutopause> createState() => _MconAutopauseState();
}

class _MconAutopauseState extends MconBaseState<MconAutopause> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAutopausePainter(
      animation: animation,
...
class _MconAutopausePainter extends MconPainter {
  _MconAutopausePainter({
