...
/// Animated 50mp icon from Google Material Icons
class Mcon50mp extends MconBase {
  const Mcon50mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon50mp> createState() => _Mcon50mpState();
}

class _Mcon50mpState extends MconBaseState<Mcon50mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon50mpPainter(
      animation: animation,
...
class _Mcon50mpPainter extends MconPainter {
  _Mcon50mpPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(657.0), y(-500.0), x(668.5), y(-511.5));
    path.quadraticBezierTo(x(680.0), y(-523.0), x(680.0), y(-540.0));
    path.lineTo(x(680.0), y(-700.0));
    path.quadraticBezierTo(x(680.0), y(-717.0), x(668.5), y(-728.5));
    path.quadraticBezierTo(x(657.0), y(-740.0), x(640.0), y(-740.0));
    path.lineTo(x(540.0), y(-740.0));
    path.quadraticBezierTo(x(523.0), y(-740.0), x(511.5), y(-728.5));
    path.quadraticBezierTo(x(500.0), y(-717.0), x(500.0), y(-700.0));
    path.lineTo(x(500.0), y(-540.0));
    path.quadraticBezierTo(x(500.0), y(-523.0), x(511.5), y(-511.5));
    path.quadraticBezierTo(x(523.0), y(-500.0), x(540.0), y(-500.0));
    path.close();
    ...
    path.quadraticBezierTo(x(417.0), y(-500.0), x(428.5), y(-511.5));
    path.quadraticBezierTo(x(440.0), y(-523.0), x(440.0), y(-540.0));
    path.lineTo(x(440.0), y(-600.0));
    path.quadraticBezierTo(x(440.0), y(-617.0), x(428.5), y(-628.5));
    path.quadraticBezierTo(x(417.0), y(-640.0), x(400.0), y(-640.0));
