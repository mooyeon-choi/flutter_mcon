...
/// Animated extension_off icon from Google Material Icons
class MconExtensionOff extends MconBase {
  const MconExtensionOff({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconExtensionOff> createState() => _MconExtensionOffState();
}

class _MconExtensionOffState extends MconBaseState<MconExtensionOff> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconExtensionOffPainter(
      animation: animation,
...
class _MconExtensionOffPainter extends MconPainter {
  _MconExtensionOffPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(120.0), y(-737.0), x(126.0), y(-751.5));
    path.quadraticBezierTo(x(132.0), y(-766.0), x(143.0), y(-777.0));
    ...
    path.lineTo(x(288.0), y(-200.0));
    path.quadraticBezierTo(x(309.0), y(-254.0), x(356.0), y(-287.0));
    path.quadraticBezierTo(x(403.0), y(-320.0), x(460.0), y(-320.0));
    path.quadraticBezierTo(x(517.0), y(-320.0), x(564.0), y(-287.0));
    path.quadraticBezierTo(x(611.0), y(-254.0), x(632.0), y(-200.0));
    path.lineTo(x(720.0), y(-200.0));
    path.lineTo(x(777.0), y(-143.0));
    path.quadraticBezierTo(x(766.0), y(-132.0), x(751.5), y(-126.0));
    path.quadraticBezierTo(x(737.0), y(-120.0), x(720.0), y(-120.0));
    path.lineTo(x(568.0), y(-120.0));
    path.quadraticBezierTo(x(568.0), y(-168.0), x(537.5), y(-204.0));
    path.quadraticBezierTo(x(507.0), y(-240.0), x(460.0), y(-240.0));
    path.quadraticBezierTo(x(413.0), y(-240.0), x(382.5), y(-204.0));
    path.quadraticBezierTo(x(352.0), y(-168.0), x(352.0), y(-120.0));
