...
/// Animated identity_aware_proxy icon from Google Material Icons
class MconIdentityAwareProxy extends MconBase {
  const MconIdentityAwareProxy({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconIdentityAwareProxy> createState() =>
      _MconIdentityAwareProxyState();
}

class _MconIdentityAwareProxyState
    extends MconBaseState<MconIdentityAwareProxy> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconIdentityAwareProxyPainter(
      animation: animation,
...
class _MconIdentityAwareProxyPainter extends MconPainter {
  _MconIdentityAwareProxyPainter({
