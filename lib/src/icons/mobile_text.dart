...
/// Animated mobile_text icon from Google Material Icons
class MconMobileText extends MconBase {
  const MconMobileText({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMobileText> createState() => _MconMobileTextState();
}

class _MconMobileTextState extends MconBaseState<MconMobileText> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMobileTextPainter(
      animation: animation,
...
class _MconMobileTextPainter extends MconPainter {
  _MconMobileTextPainter({
