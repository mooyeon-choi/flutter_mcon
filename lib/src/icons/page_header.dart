...
/// Animated page_header icon from Google Material Icons
class MconPageHeader extends MconBase {
  const MconPageHeader({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconPageHeader> createState() => _MconPageHeaderState();
}

class _MconPageHeaderState extends MconBaseState<MconPageHeader> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconPageHeaderPainter(
      animation: animation,
...
class _MconPageHeaderPainter extends MconPainter {
  _MconPageHeaderPainter({
