...
/// Animated swipe_down icon from Google Material Icons
class MconSwipeDown extends MconBase {
  const MconSwipeDown({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconSwipeDown> createState() => _MconSwipeDownState();
}

class _MconSwipeDownState extends MconBaseState<MconSwipeDown> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSwipeDownPainter(
      animation: animation,
...
class _MconSwipeDownPainter extends MconPainter {
  _MconSwipeDownPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(40.0), y(-500.0));
    path.lineTo(x(82.0), y(-542.0));
    path.lineTo(x(152.0), y(-472.0));
    path.quadraticBezierTo(x(146.0), y(-499.0), x(143.0), y(-526.0));
    path.quadraticBezierTo(x(140.0), y(-553.0), x(140.0), y(-580.0));
    path.quadraticBezierTo(x(140.0), y(-662.0), x(167.0), y(-739.0));
    path.quadraticBezierTo(x(194.0), y(-816.0), x(245.0), y(-880.0));
    path.lineTo(x(288.0), y(-837.0));
    path.quadraticBezierTo(x(245.0), y(-781.0), x(222.5), y(-715.5));
    path.quadraticBezierTo(x(200.0), y(-650.0), x(200.0), y(-580.0));
    path.quadraticBezierTo(x(200.0), y(-554.0), x(203.0), y(-528.5));
    path.quadraticBezierTo(x(206.0), y(-503.0), x(213.0), y(-478.0));
    path.lineTo(x(278.0), y(-542.0));
