...
/// Animated battery_android_alert icon from Google Material Icons
class MconBatteryAndroidAlert extends MconBase {
  const MconBatteryAndroidAlert({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconBatteryAndroidAlertPainter extends MconPainter {
  _MconBatteryAndroidAlertPainter({
