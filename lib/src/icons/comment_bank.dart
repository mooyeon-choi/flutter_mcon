...
/// Animated comment_bank icon from Google Material Icons
class MconCommentBank extends MconBase {
  const MconCommentBank({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconCommentBank> createState() => _MconCommentBankState();
}

class _MconCommentBankState extends MconBaseState<MconCommentBank> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCommentBankPainter(
      animation: animation,
...
class _MconCommentBankPainter extends MconPainter {
  _MconCommentBankPainter({
