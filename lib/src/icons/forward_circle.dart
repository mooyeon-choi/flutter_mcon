...
/// Animated forward_circle icon from Google Material Icons
class MconForwardCircle extends MconBase {
  const MconForwardCircle({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconForwardCircle> createState() => _MconForwardCircleState();
}

class _MconForwardCircleState extends MconBaseState<MconForwardCircle> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconForwardCirclePainter(
      animation: animation,
...
class _MconForwardCirclePainter extends MconPainter {
  _MconForwardCirclePainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(483.0), y(-620.0));
    path.lineTo(x(434.0), y(-570.0));
    path.lineTo(x(476.0), y(-527.0));
    path.lineTo(x(596.0), y(-647.0));
    path.lineTo(x(476.0), y(-767.0));
    path.lineTo(x(433.0), y(-724.0));
    path.lineTo(x(477.0), y(-680.0));
    path.quadraticBezierTo(x(395.0), y(-678.0), x(337.5), y(-620.0));
    path.quadraticBezierTo(x(280.0), y(-562.0), x(280.0), y(-480.0));
