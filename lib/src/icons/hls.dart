...
/// Animated hls icon from Google Material Icons
class MconHls extends MconBase {
  const MconHls({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconHls> createState() => _MconHlsState();
}

class _MconHlsState extends MconBaseState<MconHls> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHlsPainter(
      animation: animation,
...
class _MconHlsPainter extends MconPainter {
  _MconHlsPainter({
