...
/// Animated border_clear icon from Google Material Icons
class MconBorderClear extends MconBase {
  const MconBorderClear({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBorderClear> createState() => _MconBorderClearState();
}

class _MconBorderClearState extends MconBaseState<MconBorderClear> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBorderClearPainter(
      animation: animation,
...
class _MconBorderClearPainter extends MconPainter {
  _MconBorderClearPainter({
