...
/// Animated move_selection_left icon from Google Material Icons
class MconMoveSelectionLeft extends MconBase {
  const MconMoveSelectionLeft({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMoveSelectionLeft> createState() =>
      _MconMoveSelectionLeftState();
}

class _MconMoveSelectionLeftState extends MconBaseState<MconMoveSelectionLeft> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMoveSelectionLeftPainter(
      animation: animation,
...
class _MconMoveSelectionLeftPainter extends MconPainter {
  _MconMoveSelectionLeftPainter({
