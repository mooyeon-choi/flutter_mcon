...
/// Animated request_quote icon from Google Material Icons
class MconRequestQuote extends MconBase {
  const MconRequestQuote({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconRequestQuote> createState() => _MconRequestQuoteState();
}

class _MconRequestQuoteState extends MconBaseState<MconRequestQuote> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconRequestQuotePainter(
      animation: animation,
...
class _MconRequestQuotePainter extends MconPainter {
  _MconRequestQuotePainter({
