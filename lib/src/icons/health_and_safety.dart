...
/// Animated health_and_safety icon from Google Material Icons
class MconHealthAndSafety extends MconBase {
  const MconHealthAndSafety({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconHealthAndSafety> createState() =>
      _MconHealthAndSafetyState();
}

class _MconHealthAndSafetyState extends MconBaseState<MconHealthAndSafety> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHealthAndSafetyPainter(
      animation: animation,
...
class _MconHealthAndSafetyPainter extends MconPainter {
  _MconHealthAndSafetyPainter({
