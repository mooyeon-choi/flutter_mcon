...
/// Animated work_history icon from Google Material Icons
class MconWorkHistory extends MconBase {
  const MconWorkHistory({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconWorkHistory> createState() => _MconWorkHistoryState();
}

class _MconWorkHistoryState extends MconBaseState<MconWorkHistory> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWorkHistoryPainter(
      animation: animation,
...
class _MconWorkHistoryPainter extends MconPainter {
  _MconWorkHistoryPainter({
