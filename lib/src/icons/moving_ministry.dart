...
/// Animated moving_ministry icon from Google Material Icons
class MconMovingMinistry extends MconBase {
  const MconMovingMinistry({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconMovingMinistry> createState() => _MconMovingMinistryState();
}

class _MconMovingMinistryState extends MconBaseState<MconMovingMinistry> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMovingMinistryPainter(
      animation: animation,
...
class _MconMovingMinistryPainter extends MconPainter {
  _MconMovingMinistryPainter({
