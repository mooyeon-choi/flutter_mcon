...
/// Animated work_update icon from Google Material Icons
class MconWorkUpdate extends MconBase {
  const MconWorkUpdate({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconWorkUpdate> createState() => _MconWorkUpdateState();
}

class _MconWorkUpdateState extends MconBaseState<MconWorkUpdate> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconWorkUpdatePainter(
      animation: animation,
...
class _MconWorkUpdatePainter extends MconPainter {
  _MconWorkUpdatePainter({
