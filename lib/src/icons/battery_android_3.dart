...
/// Animated battery_android_3 icon from Google Material Icons
class MconBatteryAndroid3 extends MconBase {
  const MconBatteryAndroid3({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconBatteryAndroid3State extends MconBaseState<MconBatteryAndroid3> {
  ...
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBatteryAndroid3Painter(
      animation: animation,
...
class _MconBatteryAndroid3Painter extends MconPainter {
  _MconBatteryAndroid3Painter({
