...
/// Animated exposure icon from Google Material Icons
class MconExposure extends MconBase {
  const MconExposure({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconExposure> createState() => _MconExposureState();
}

class _MconExposureState extends MconBaseState<MconExposure> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconExposurePainter(
      animation: animation,
...
class _MconExposurePainter extends MconPainter {
  _MconExposurePainter({
