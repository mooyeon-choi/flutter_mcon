...
/// Animated draft icon from Google Material Icons
class MconDraft extends MconBase {
  const MconDraft({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconDraft> createState() => _MconDraftState();
}

class _MconDraftState extends MconBaseState<MconDraft> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconDraftPainter(
      animation: animation,
...
class _MconDraftPainter extends MconPainter {
  _MconDraftPainter({
