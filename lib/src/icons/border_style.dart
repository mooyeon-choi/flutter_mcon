...
/// Animated border_style icon from Google Material Icons
class MconBorderStyle extends MconBase {
  const MconBorderStyle({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBorderStyle> createState() => _MconBorderStyleState();
}

class _MconBorderStyleState extends MconBaseState<MconBorderStyle> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBorderStylePainter(
      animation: animation,
...
class _MconBorderStylePainter extends MconPainter {
  _MconBorderStylePainter({
