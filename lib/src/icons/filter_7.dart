...
/// Animated filter_7 icon from Google Material Icons
class MconFilter7 extends MconBase {
  const MconFilter7({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconFilter7> createState() => _MconFilter7State();
}

class _MconFilter7State extends MconBaseState<MconFilter7> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFilter7Painter(
      animation: animation,
...
class _MconFilter7Painter extends MconPainter {
  _MconFilter7Painter({
