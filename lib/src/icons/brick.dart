...
/// Animated brick icon from Google Material Icons
class MconBrick extends MconBase {
  const MconBrick({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconBrick> createState() => _MconBrickState();
}

class _MconBrickState extends MconBaseState<MconBrick> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBrickPainter(
      animation: animation,
...
class _MconBrickPainter extends MconPainter {
  _MconBrickPainter({
