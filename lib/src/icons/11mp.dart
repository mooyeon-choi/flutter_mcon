...
/// Animated 11mp icon from Google Material Icons
class Mcon11mp extends MconBase {
  const Mcon11mp({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<Mcon11mp> createState() => _Mcon11mpState();
}

class _Mcon11mpState extends MconBaseState<Mcon11mp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _Mcon11mpPainter(
      animation: animation,
...
class _Mcon11mpPainter extends MconPainter {
  _Mcon11mpPainter({
