...
/// Animated new_label icon from Google Material Icons
class MconNewLabel extends MconBase {
  const MconNewLabel({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconNewLabel> createState() => _MconNewLabelState();
}

class _MconNewLabelState extends MconBaseState<MconNewLabel> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconNewLabelPainter(
      animation: animation,
...
class _MconNewLabelPainter extends MconPainter {
  _MconNewLabelPainter({
