...
/// Animated battery_charging_full icon from Google Material Icons
class MconBatteryChargingFull extends MconBase {
  const MconBatteryChargingFull({
    super.key,
    super.size,
    super.color,
    super.duration,
...
class _MconBatteryChargingFullPainter extends MconPainter {
  _MconBatteryChargingFullPainter({
