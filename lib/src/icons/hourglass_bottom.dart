...
/// Animated hourglass_bottom icon from Google Material Icons
class MconHourglassBottom extends MconBase {
  const MconHourglassBottom({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconHourglassBottom> createState() =>
      _MconHourglassBottomState();
}

class _MconHourglassBottomState extends MconBaseState<MconHourglassBottom> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconHourglassBottomPainter(
      animation: animation,
...
class _MconHourglassBottomPainter extends MconPainter {
  _MconHourglassBottomPainter({
