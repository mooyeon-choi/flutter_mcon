...
/// Animated trackpad_input icon from Google Material Icons
class MconTrackpadInput extends MconBase {
  const MconTrackpadInput({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconTrackpadInput> createState() => _MconTrackpadInputState();
}

class _MconTrackpadInputState extends MconBaseState<MconTrackpadInput> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconTrackpadInputPainter(
      animation: animation,
...
class _MconTrackpadInputPainter extends MconPainter {
  _MconTrackpadInputPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(600.0), y(-537.0), x(611.5), y(-548.5));
    path.quadraticBezierTo(x(623.0), y(-560.0), x(640.0), y(-560.0));
    path.quadraticBezierTo(x(657.0), y(-560.0), x(668.5), y(-548.5));
    path.quadraticBezierTo(x(680.0), y(-537.0), x(680.0), y(-520.0));
