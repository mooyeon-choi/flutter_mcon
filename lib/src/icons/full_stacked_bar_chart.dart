...
/// Animated full_stacked_bar_chart icon from Google Material Icons
class MconFullStackedBarChart extends MconBase {
  const MconFullStackedBarChart({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconFullStackedBarChart> createState() =>
      _MconFullStackedBarChartState();
}

class _MconFullStackedBarChartState
    extends MconBaseState<MconFullStackedBarChart> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconFullStackedBarChartPainter(
      animation: animation,
...
class _MconFullStackedBarChartPainter extends MconPainter {
  _MconFullStackedBarChartPainter({
