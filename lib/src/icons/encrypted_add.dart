...
/// Animated encrypted_add icon from Google Material Icons
class MconEncryptedAdd extends MconBase {
  const MconEncryptedAdd({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconEncryptedAdd> createState() => _MconEncryptedAddState();
}

class _MconEncryptedAddState extends MconBaseState<MconEncryptedAdd> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconEncryptedAddPainter(
      animation: animation,
...
class _MconEncryptedAddPainter extends MconPainter {
  _MconEncryptedAddPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.lineTo(x(800.0), y(-498.0));
    path.quadraticBezierTo(x(800.0), y(-489.0), x(799.0), y(-479.0));
    path.lineTo(x(718.0), y(-479.0));
    path.quadraticBezierTo(x(719.0), y(-489.0), x(719.5), y(-498.0));
    path.quadraticBezierTo(x(720.0), y(-507.0), x(720.0), y(-516.0));
