...
/// Animated add_comment icon from Google Material Icons
class MconAddComment extends MconBase {
  const MconAddComment({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconAddComment> createState() => _MconAddCommentState();
}

class _MconAddCommentState extends MconBaseState<MconAddComment> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconAddCommentPainter(
      animation: animation,
...
class _MconAddCommentPainter extends MconPainter {
  _MconAddCommentPainter({
