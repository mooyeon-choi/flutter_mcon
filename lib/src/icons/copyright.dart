...
/// Animated copyright icon from Google Material Icons
class MconCopyright extends MconBase {
  const MconCopyright({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconCopyright> createState() => _MconCopyrightState();
}

class _MconCopyrightState extends MconBaseState<MconCopyright> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconCopyrightPainter(
      animation: animation,
...
class _MconCopyrightPainter extends MconPainter {
  _MconCopyrightPainter({
