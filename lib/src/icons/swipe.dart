...
/// Animated swipe icon from Google Material Icons
class MconSwipe extends MconBase {
  const MconSwipe({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconSwipe> createState() => _MconSwipeState();
}

class _MconSwipeState extends MconBaseState<MconSwipe> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconSwipePainter(
      animation: animation,
...
class _MconSwipePainter extends MconPainter {
  _MconSwipePainter({
