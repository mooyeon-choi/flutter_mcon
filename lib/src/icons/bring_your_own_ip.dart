...
/// Animated bring_your_own_ip icon from Google Material Icons
class MconBringYourOwnIp extends MconBase {
  const MconBringYourOwnIp({
    super.key,
    super.size,
    super.color,
    super.duration,
  ...
  @override
  MconBaseState<MconBringYourOwnIp> createState() => _MconBringYourOwnIpState();
}

class _MconBringYourOwnIpState extends MconBaseState<MconBringYourOwnIp> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconBringYourOwnIpPainter(
      animation: animation,
...
class _MconBringYourOwnIpPainter extends MconPainter {
  _MconBringYourOwnIpPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(x(500.0), y(-880.0), x(520.0), y(-877.5));
    path.quadraticBezierTo(x(540.0), y(-875.0), x(560.0), y(-873.0));
    path.lineTo(x(560.0), y(-791.0));
    path.quadraticBezierTo(x(540.0), y(-793.0), x(520.0), y(-795.5));
    path.quadraticBezierTo(x(500.0), y(-798.0), x(480.0), y(-798.0));
    ...
    path.lineTo(x(872.0), y(-560.0));
    path.quadraticBezierTo(x(876.0), y(-540.0), x(878.0), y(-520.0));
    path.quadraticBezierTo(x(880.0), y(-500.0), x(880.0), y(-480.0));
    ...
    path.quadraticBezierTo(x(506.0), y(-198.0), x(525.0), y(-237.5));
    path.quadraticBezierTo(x(544.0), y(-277.0), x(556.0), y(-320.0));
    ...
    path.quadraticBezierTo(x(639.0), y(-196.0), x(683.0), y(-232.5));
    path.quadraticBezierTo(x(727.0), y(-269.0), x(756.0), y(-320.0));
    path.lineTo(x(638.0), y(-320.0));
    path.quadraticBezierTo(x(629.0), y(-283.0), x(615.5), y(-247.5));
    path.quadraticBezierTo(x(602.0), y(-212.0), x(584.0), y(-178.0));
    path.close();
