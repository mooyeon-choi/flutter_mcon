...
/// Animated memory icon from Google Material Icons
class MconMemory extends MconBase {
  const MconMemory({
    super.key,
    super.size,
    super.color,
  ...
  @override
  MconBaseState<MconMemory> createState() => _MconMemoryState();
}

class _MconMemoryState extends MconBaseState<MconMemory> {
  @override
  CustomPainter createPainter(Animation<double> animation) {
    return _MconMemoryPainter(
      animation: animation,
...
class _MconMemoryPainter extends MconPainter {
  _MconMemoryPainter({
